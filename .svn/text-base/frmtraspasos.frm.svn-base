   ...
   Begin MSComctlLib.ImageList ImageList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtraspasos.frx":0A4E
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtraspasos.frx":1328
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtraspasos.frx":1C02
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtraspasos.frx":219E
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtraspasos.frx":2A7A
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtraspasos.frx":3354
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtraspasos.frx":3C2E
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtraspasos.frx":3D40
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtraspasos.frx":3E52
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtraspasos.frx":3F64
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtraspasos.frx":4076
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtraspasos.frx":4188
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Private Sub cmd_imprimir_Click()
   ...
   If var_numero_folio > 0 Then
      ...
      Else
         ...
         If var_empresa = "18" Or (var_empresa = "31" And var_almacen_origen = "PTVH") Then
         ...
         If var_posible_Cantidad = 1 Then
            ...
            If var_empresa = "31" Then
               var_almacen_traspaso_cantia = Me.txt_almacen_destino
            ...
            If var_acepta_traspaso = 1 Then
               ...
               If var_si = 1 Then
                  ...
                  If Me.txt_almacen_origen = "ATC" Then
                     rs.Open "select * from tb_temporal_salidas with (nolock) where vcha_alm_almacen_id = '" + var_almacen_origen + "' and  VCHA_MOV_MOVIMIENTO_ID = '" + var_clave_movimiento + "' and inte_sal_numero = " + Str(var_numero_folio) + " and vcha_emp_empresa_id = '" + var_empresa + "' and vcha_uor_unidad_id = '" + var_unidad_organizacional + "'", cnn, adOpenDynamic, adLockOptimistic
                     var_cadena_faltantes = ""
                     While Not rs.EOF
                           rsaux.Open "select * from tb_existencias where vcha_alm_almacen_id = 'ATC' and vcha_Art_articulo_id = '" + rs!VCHA_ART_ARTICULO_ID + "'", cnn, adOpenDynamic, adLockOptimistic
                           If Not rsaux.EOF Then
                              var_cantidad_Existencias = IIf(IsNull(rsaux!floa_Exi_Cantidad), 0, rsaux!floa_Exi_Cantidad)
                              If var_cantidad_Existencias < IIf(IsNull(rs!floa_Sal_Cantidad), 0, rs!floa_Sal_Cantidad) Then
                                 var_posible_traspaso = 1
                                 ...
                                 If Not rsaux1.EOF Then
                                    If var_cadena_faltantes = "" Then
                                       var_cadena_faltantes = "Los siguientes artículos exceden la existencia en el almacén " + rs!VCHA_ART_ARTICULO_ID + " " + IIf(IsNull(rsaux1!vcha_Art_nombre_español), "", rsaux1!vcha_Art_nombre_español) + "  [" + CStr(rs!floa_Sal_Cantidad) + "] Contra [" + CStr(var_cantidad_Existencias) + "]"
                                    Else
                                       var_cadena_faltantes = var_cadena_faltantes + ", " + rs!VCHA_ART_ARTICULO_ID + " " + IIf(IsNull(rsaux1!vcha_Art_nombre_español), "", rsaux1!vcha_Art_nombre_español) + "  [" + CStr(rs!floa_Sal_Cantidad) + "] Contra [" + CStr(var_cantidad_Existencias) + "]"
                                    End If
                                 End If
                                 rsaux1.Close
                              End If
                           Else
                              If rs!floa_Sal_Cantidad > 0 Then
                                 rsaux1.Open "select * from tb_articulos where vcha_Art_articulo_id = '" + rs!VCHA_ART_ARTICULO_ID + "'", cnn, adOpenDynamic, adLockOptimistic
                                 If Not rsaux1.EOF Then
                                    If var_cadena_faltantes = "" Then
                                       var_cadena_faltantes = "Los siguientes artículos exceden la existencia en el almacén " + rs!VCHA_ART_ARTICULO_ID + " " + IIf(IsNull(rsaux1!vcha_Art_nombre_español), "", rsaux1!vcha_Art_nombre_español) + "  [" + CStr(rs!floa_Sal_Cantidad) + "] Contra [" + CStr(0) + "]"
                                    Else
                                       var_cadena_faltantes = var_cadena_faltantes + ", " + rs!VCHA_ART_ARTICULO_ID + " " + IIf(IsNull(rsaux1!vcha_Art_nombre_español), "", rsaux1!vcha_Art_nombre_español) + "  [" + CStr(rs!floa_Sal_Cantidad) + "] Contra [" + CStr(0) + "]"
                                    End If
                                 End If
                                 rsaux1.Close
                                 var_posible_traspaso = 1
                     ...
                     While Not rs.EOF
                           ...
                           While var_suma_cantidad < var_cantidad_llegar
                                 ...
                                 If var_almacen_origen = "AG" Then
                                    rsaux4.Open "insert into tb_entradas (vcha_emp_empresa_id, vcha_uor_unidad_id, vcha_alm_almacen_id, vcha_mov_movimiento_id, inte_ent_numero, vcha_art_articulo_id, floa_ent_cantidad, floa_ent_costo, floa_ent_precio, INTE_ENT_AÑO, VCHA_ENT_ALMACEN_ORIGEN) values ('" + var_empresa + "', '" + var_unidad_organizacional + "', '" + var_almacen_Destino + "', '" + rs!VCHA_MOV_MOVIMIENTO_ID + "', " + CStr(rs!INTE_SAL_NUMERO) + ", '" + rs!VCHA_ART_ARTICULO_ID + "', " + CStr(var_cantidad) + ", 0 , " + CStr(rs!floa_Sal_precio) + ", " + CStr(var_año) + ", '" + var_almacen_origen + "')", cnn, adOpenDynamic, adLockOptimistic
                                 Else
                                    rsaux4.Open "insert into tb_entradas (vcha_emp_empresa_id, vcha_uor_unidad_id, vcha_alm_almacen_id, vcha_mov_movimiento_id, inte_ent_numero, vcha_art_articulo_id, floa_ent_cantidad, floa_ent_costo, floa_ent_precio, INTE_ENT_AÑO, VCHA_ENT_ALMACEN_ORIGEN) values ('" + var_empresa + "', '" + var_unidad_organizacional + "', '" + var_almacen_Destino + "', '" + rs!VCHA_MOV_MOVIMIENTO_ID + "', " + CStr(rs!INTE_SAL_NUMERO) + ", '" + rs!VCHA_ART_ARTICULO_ID + "', " + CStr(var_cantidad) + ", " + CStr(var_costo) + " , " + CStr(rs!floa_Sal_precio) + ", " + CStr(var_año) + ", '" + var_almacen_origen + "')", cnn, adOpenDynamic, adLockOptimistic
                                 End If
                            Wend
                            rs.MoveNext
                     Wend
...
Private Sub Command2_Click()
   ...
   If rsaux8.State = 1 Then
      rsaux8.Close
   End If
   rsaux8.Open "SELECT * from traspaso_2", cnn, adOpenDynamic, adLockOptimistic
   While Not rsaux8.EOF
         txt_codigo = rsaux8!codigo
         var_cantidad_leida = rsaux8!Cantidad
         'rsaux1.Open "select * from tb_existencias where vcha_alm_almacen_id = '" + Me.txt_almacen_origen + "' and vcha_Art_articulo_id = '" + rsaux8!codigo + "'", cnn, adOpenDynamic, adLockOptimistic
         'If Not rsaux1.EOF Then
         '   var_costo = IIf(IsNull(rsaux1!floa_exi_costo), 0, rsaux1!floa_exi_costo)
         'Else
         '   rsaux2.Open "select * from tb_articulos where vcha_Art_articulo_id = '" + rsaux8!codigo + "'", cnn, adOpenDynamic, adLockOptimistic
         '   If Not rsaux2.EOF Then
         ...
         'End If
         'rsaux1.Close
         'var_costo = rsaux8!Costo
         rsaux.Open "select * from tb_Articulos where vcha_Art_Articulo_id = '" + rsaux8!codigo + "'", cnn, adOpenDynamic, adLockOptimistic
         var_precio = rsaux!mone_Art_precio_base
...
Private Sub txt_almacen_destino_LostFocus()
   ...
   If Trim(txt_almacen_destino) <> "" Then
      ...
      Else
         rs.Open "select * from vw_movimientos_almacenes where vcha_Alm_almacen_id = '" + txt_almacen_destino + "' AND VCHA_MOV_MOVIMIENTO_ID = '" + var_clave_movimiento + "'", cnn, adOpenDynamic, adLockBatchOptimistic
      End If
      If Not rs.EOF Then
...
Private Sub txt_almacen_origen_LostFocus()
   ...
   If Trim(txt_almacen_origen) <> "" Then
      If var_tipo_permiso = 1 Then
         rs.Open "select * from vw_almacen_permiso_2 where vcha_usu_usuario_id = '" + var_clave_usuario_global + "' and vcha_mov_movimiento_id = '" + var_clave_movimiento + "' and vcha_alm_almacen_id = '" + txt_almacen_origen + "'", cnn, adOpenDynamic, adLockBatchOptimistic
      Else
         rs.Open "select * from vw_movimientos_almacenes  where vcha_alm_almacen_id = '" + txt_almacen_origen + "' and vcha_mov_movimiento_id = '" + var_clave_movimiento + "'", cnn, adOpenDynamic, adLockBatchOptimistic
      End If
      If Not rs.EOF Then
   ...
   If KeyAscii = 13 Then
      If Trim(txt_busqueda_folio) <> "" Then
         ...
         If var_numero_folio = CDbl(txt_busqueda_folio) Then
            rsaux2.Open "UPDATE TB_encabezado_MOVIMIENTOS SET INTE_EMO_BLOQUEADO = 0 where inte_emo_numero = " + txt_busqueda_folio + " and vcha_mov_movimiento_id = '" + var_clave_movimiento + "' and vcha_emp_empresa_id = '" + var_empresa + "' and vcha_uor_unidad_id = '" + var_unidad_organizacional + "'", cnn, adOpenDynamic, adLockOptimistic
         End If
         ...
         If Not rs.EOF Then
            If var_numero_folio > 0 Then
               rsaux2.Open "UPDATE TB_encabezado_MOVIMIENTOS SET INTE_EMO_BLOQUEADO = 0 where inte_emo_numero = " + CStr(var_numero_folio) + " and vcha_mov_movimiento_id = '" + var_clave_movimiento + "' and vcha_emp_empresa_id = '" + var_empresa + "'  and vcha_uor_unidad_id = '" + var_unidad_organizacional + "'", cnn, adOpenDynamic, adLockOptimistic
            End If
            ...
            If var_movimiento_bloqueado = 0 Then
               ...
               If var_posible = 1 Then
                  ...
                  rsaux.Close
                  rsaux2.Open "UPDATE TB_encabezado_MOVIMIENTOS SET INTE_EMO_BLOQUEADO = 1 where inte_emo_numero = " + CStr(var_numero_folio) + " and vcha_mov_movimiento_id = '" + var_clave_movimiento + "' and vcha_emp_empresa_id = '" + var_empresa + "' and vcha_uor_unidad_id = '" + var_unidad_organizacional + "'", cnn, adOpenDynamic, adLockOptimistic
                  ...
                  If Not rsaux.EOF Then
                     While Not rsaux.EOF
                        ...
                        If Not rsaux.EOF Then
                           ...
                           Me.lbl_cantidad_total = Format(CDbl(Me.lbl_cantidad_total) + IIf(IsNull(rsaux!floa_Sal_Cantidad), 0, rsaux!floa_Sal_Cantidad), "###,###,##0.00")
                           rsaux2.Close
                           rsaux.MoveNext:
                        End If
                     Wend
   ...
   If KeyAscii = 13 Then
      If IsNumeric(txt_cantidad_eliminar) Then
         If CDbl(txt_cantidad_eliminar) <= lv_traspasossalidas.selectedItem.SubItems(2) * 1 Then
            ...
            rs.Open Cadena, cnn, adOpenDynamic, adLockOptimistic
            var_inserta = False
            var_inserta = TB_TEMPORAL_SALIDAS_MODIFICA.Anadir(var_empresa, var_unidad_organizacional, var_almacen_origen, var_clave_movimiento, var_numero_folio, lv_traspasossalidas.selectedItem, 0 - CDbl(txt_cantidad_eliminar))
            var_inserta = False
            var_inserta = TB_TEMPORAL_ENTRADAS_MODIFICA.Anadir(var_empresa, var_unidad_organizacional, var_almacen_Destino, var_clave_movimiento, var_numero_folio, lv_traspasossalidas.selectedItem, 0 - CDbl(txt_cantidad_eliminar), var_año)
            Me.lbl_cantidad_total = Format(CDbl(Me.lbl_cantidad_total) - CDbl(txt_cantidad_eliminar), "###,###,##0.00")
            rs.Close
            lv_traspasossalidas.selectedItem.SubItems(2) = lv_traspasossalidas.selectedItem.SubItems(2) - CDbl(txt_cantidad_eliminar)
            var_renglon = lv_traspasossalidas.selectedItem.Index
            Call ilumina_grid
            var_ventana = 0
            frm_eliminar.Visible = False
      ...
      If var_verificador = True Then
         ...
         If Trim(txt_codigo) <> "" Then
            ...
            If Not rs.EOF Then
               ...
               End If
               If Me.txt_almacen_origen <> "ATC" Then
                  If Me.txt_almacen_origen <> "AC" Then
                     var_recontable = 1
                  End If
               End If
               If var_empresa = "31" Then
                  If UCase(Mid(Me.txt_codigo, 1, 1)) = "A" Or UCase(Mid(Me.txt_codigo, 1, 1)) = "T" Then
                     If var_clave_usuario_global = "U0000000145" Or var_clave_usuario_global = "U0000000150" Or var_clave_usuario_global = "U0000000189" Or var_clave_usuario_global = "U0000000153" Then
                        var_recontable = 1
                     Else
                        var_recontable = 0
                     End If
                  Else
                     var_recontable = 0
                  End If
                  If Me.txt_almacen_destino = "BIA" Or Me.txt_almacen_destino = "ANCAN" Then
                     If Me.txt_almacen_origen = "PTVH" Then
                        var_recontable = 1
                     End If
                  End If
               End If
