...
Begin VB.Form frmtraspasosentradas 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Entradas para traspasos"
   ClientHeight    =   7425
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8625
   Icon            =   "frmtraspasosentradas.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.CommandButton Command1 
      ...
      Height          =   315
      Left            =   8100
      Picture         =   "frmtraspasosentradas.frx":08CA
      Style           =   1  'Graphical
      TabIndex        =   38
      ToolTipText     =   "Salir"
      Top             =   720
   ...
   Begin VB.CommandButton cmd_imprimir 
      ...
      Height          =   315
      Left            =   780
      Picture         =   "frmtraspasosentradas.frx":0F04
      Style           =   1  'Graphical
      TabIndex        =   37
   ...
   Begin VB.CommandButton cmd_buscar 
      ...
      Height          =   315
      Left            =   450
      Picture         =   "frmtraspasosentradas.frx":1006
      Style           =   1  'Graphical
      TabIndex        =   36
   ...
   Begin VB.CommandButton cmd_nuevo 
      ...
      Height          =   315
      Left            =   120
      Picture         =   "frmtraspasosentradas.frx":1108
      Style           =   1  'Graphical
      TabIndex        =   35
   ...
   Begin VB.CommandButton cmd_cancelar 
      ...
      Height          =   315
      Left            =   1110
      Picture         =   "frmtraspasosentradas.frx":120A
      Style           =   1  'Graphical
      TabIndex        =   34
   ...
   Begin MSComctlLib.ImageList ImageList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtraspasosentradas.frx":130C
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtraspasosentradas.frx":1BE6
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtraspasosentradas.frx":24C0
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtraspasosentradas.frx":2A5C
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtraspasosentradas.frx":3338
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtraspasosentradas.frx":3C12
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtraspasosentradas.frx":44EC
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtraspasosentradas.frx":45FE
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtraspasosentradas.frx":4710
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtraspasosentradas.frx":4822
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtraspasosentradas.frx":4934
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtraspasosentradas.frx":4A46
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmtraspasosentradas"
      ...
      If Trim(txt_codigo) <> "" Then
         ...
         If Not rs.EOF Then
            ...
            If var_costo = 0 Then
               ...
               Else
                  rsaux9.Open "select * from tb_articulos where vcha_art_articulo_id = '" + Me.txt_codigo + "'", cnn, adOpenDynamic, adLockOptimistic
...
Private Sub txt_foco_GotFocus()
   ...
   If Trim(txt_codigo.Text) <> "" Then
      ...
      While var_suma_cantidad < var_cantidad_leida_llegar
            ...
            While (var_i <= var_n)
                 ...
                 If txt_codigo = valor Then
                    var_posible = True
                    var_año = lv_traspasosentradas.selectedItem.SubItems(6)
                    If var_año = 2004 Then
                       If Not Me.lv_traspasosentradas.selectedItem.SubItems(2) = Me.lv_traspasosentradas.selectedItem.SubItems(3) Then
                          If (lv_traspasosentradas.selectedItem.SubItems(2) * 1) - (lv_traspasosentradas.selectedItem.SubItems(3) * 1) >= var_cantidad_leida_llegar Then
                             var_i = var_n
                             var_cantidad_leida = var_cantidad_leida_llegar
                             var_suma_cantidad = var_cantidad_leida_llegar
                          Else
                             var_i = var_n
                             var_suma_cantidad = (lv_traspasosentradas.selectedItem.SubItems(2) * 1) - (lv_traspasosentradas.selectedItem.SubItems(3) * 1)
                             var_cantidad_leida = (lv_traspasosentradas.selectedItem.SubItems(2) * 1) - (lv_traspasosentradas.selectedItem.SubItems(3) * 1)
                          End If
                       End If
                    Else
                       var_i = var_n
...
Private Sub txt_movimiento_LostFocus()
   ...
   If Trim(txt_movimiento) <> "" Then
      rs.Open "select * from tb_movimientos  where char_mov_afectacion = 'TS'  and vcha_mov_movimiento_id = '" + txt_movimiento + "' order by VCHA_mov_NOMBRE", cnn, adOpenDynamic, adLockBatchOptimistic
      If Not rs.EOF Then
         txt_nombre_movimiento = rs!vcha_mov_nombre
         txt_movimiento.Enabled = False
         txt_numero_traspaso = ""
         var_movimiento_salida = rs!VCHA_MOV_MOVIMIENTO_ID
      Else
         ...
         Else
            ...
            If Not rs.EOF Then
               ...
               If var_posible = 1 Then
                  ...
                  rsaux.Open "select * from tb_TRASPASOS where vcha_emp_empresa_id = '" + var_empresa + "' and inte_TRA_numero = " + txt_numero_traspaso + " and vcha_mov_movimiento_id = '" + var_movimiento_salida + "' and floa_TRa_cantidad > 0order by vcha_art_articulo_id, inte_tra_año", cnn, adOpenDynamic, adLockOptimistic
                  If Not rsaux.EOF Then
                     While Not rsaux.EOF
                        rsaux2.Open "select * from tb_articulos where vcha_art_articulo_id = '" + rsaux!vcha_Art_Articulo_id + "'", cnn, adOpenDynamic, adLockOptimistic
                        If Not rsaux.EOF Then
