VERSION 5.00
Begin VB.Form frmreporte_facturacion_estampados 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Reporte facturación"
   ClientHeight    =   1410
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   4455
   ...
   Begin VB.CommandButton cmd_salir 
      ...
      Height          =   315
      Left            =   4020
      Picture         =   "frmreporte_facturacion_estampados.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   7
      ToolTipText     =   "Salir"
      Top             =   0
   ...
   Begin VB.CommandButton cmd_imprimir 
      ...
      Height          =   315
      Left            =   30
      Picture         =   "frmreporte_facturacion_estampados.frx":063A
      Style           =   1  'Graphical
      TabIndex        =   6
   ...
   End
End
Attribute VB_Name = "frmreporte_facturacion_estampados"
