VERSION 5.00
Begin VB.Form frmcancelacion_facturacion_tiendas_eliminacion 
   ...
   Begin VB.CommandButton Command1 
      ...
      Height          =   300
      Left            =   60
      Picture         =   "frmcancelacion_facturacion_tiendas_eliminacion.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   6
   ...
   Begin VB.CommandButton Command2 
      ...
      Height          =   315
      Left            =   5295
      Picture         =   "frmcancelacion_facturacion_tiendas_eliminacion.frx":014A
      Style           =   1  'Graphical
      TabIndex        =   7
      ToolTipText     =   "Cancelar Factura"
      Top             =   15
   ...
   End
End
Attribute VB_Name = "frmcancelacion_facturacion_tiendas_eliminacion"
               ...
               If var_si = 6 Then
                  ...
                  If Not rsaux8.EOF Then
                     While Not rsaux8.EOF
                           ...
                           If Not rs.EOF Then
                              rsaux2.Open "update tb_Saldos set floa_sal_importe =  1000000  where vcha_emp_empresa_id = '" + var_empresa + "' and vcha_Car_documento =  'FA' and inte_car_numero = " + CStr(rsaux8!INTE_CAR_NUMERO) + " and vcha_Ser_serie_id = '" + rsaux8!VCHA_SER_SERIE_ID + "'", cnn, adOpenDynamic, adLockOptimistic
