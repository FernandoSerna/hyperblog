...
Begin VB.Form frmsalidas_proveedor_orden_compra 
   ...
   Begin VB.CommandButton cmd_salir 
      ...
      Height          =   315
      Left            =   7260
      Picture         =   "frmsalidas_proveedor_orden_compra.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   14
      ToolTipText     =   "Salir"
      Top             =   645
   ...
   Begin VB.CommandButton cmd_cancelar 
      ...
      Height          =   315
      Left            =   1155
      Picture         =   "frmsalidas_proveedor_orden_compra.frx":063A
      Style           =   1  'Graphical
      TabIndex        =   13
   ...
   Begin VB.CommandButton cmd_imprimir 
      ...
      Height          =   315
      Left            =   825
      Picture         =   "frmsalidas_proveedor_orden_compra.frx":073C
      Style           =   1  'Graphical
      TabIndex        =   12
   ...
   Begin VB.CommandButton cmd_buscar 
      ...
      Height          =   315
      Left            =   495
      Picture         =   "frmsalidas_proveedor_orden_compra.frx":083E
      Style           =   1  'Graphical
      TabIndex        =   11
   ...
   Begin VB.CommandButton cmd_nuevo 
      ...
      Height          =   315
      Left            =   165
      Picture         =   "frmsalidas_proveedor_orden_compra.frx":0940
      Style           =   1  'Graphical
      TabIndex        =   10
   ...
   Begin MSComctlLib.ImageList ImageList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_proveedor_orden_compra.frx":0A42
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_proveedor_orden_compra.frx":131C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_proveedor_orden_compra.frx":1BF6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_proveedor_orden_compra.frx":2192
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_proveedor_orden_compra.frx":2A6E
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_proveedor_orden_compra.frx":3348
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_proveedor_orden_compra.frx":3C22
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_proveedor_orden_compra.frx":3D34
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_proveedor_orden_compra.frx":3E46
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_proveedor_orden_compra.frx":3F58
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_proveedor_orden_compra.frx":406A
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_proveedor_orden_compra.frx":417C
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmsalidas_proveedor_orden_compra"
...
Private Sub cmd_imprimir_Click()
   ...
   If var_numero_folio > 0 Then
      If var_estatus_movimiento = "C" Or var_estatus_movimiento = "I" Then
         Set reporte = appl.OpenReport(App.Path + "\rep_MOVIMIENTOS_SALIDA_Proveedores.rpt")
         ...
         If var_posible_Cantidad = 1 Then
            ...
            If var_si = 1 Then
               ...
               If var_posible_cerrar_KANBAN = True Then
                  ...
                  var_si_Cantidad_proveedor = 1
                  var_cadena_articulos_proveedor = ""
                  While Not rs.EOF
                        var_cadena = "SELECT SUM(dbo.TB_ENTRADAS.FLOA_ENT_CANTIDAD - ISNULL(dbo.TB_ENTRADAS.FLOA_ENT_CANTIDAD_DEVUELTA, 0)) AS CANTIDAD_DISPONIBLE, dbo.TB_ENTRADAS.VCHA_ART_ARTICULO_ID , dbo.TB_ENCABEZADO_MOVIMIENTOS.VCHA_PRO_PROVEEDOR_ID FROM dbo.TB_ENTRADAS INNER JOIN dbo.TB_ENCABEZADO_MOVIMIENTOS ON dbo.TB_ENTRADAS.VCHA_EMP_EMPRESA_ID = dbo.TB_ENCABEZADO_MOVIMIENTOS.VCHA_EMP_EMPRESA_ID AND dbo.TB_ENTRADAS.VCHA_UOR_UNIDAD_ID = dbo.TB_ENCABEZADO_MOVIMIENTOS.VCHA_UOR_UNIDAD_ID AND dbo.TB_ENTRADAS.VCHA_ALM_ALMACEN_ID = dbo.TB_ENCABEZADO_MOVIMIENTOS.VCHA_ALM_ALMACEN_ID AND dbo.TB_ENTRADAS.VCHA_MOV_MOVIMIENTO_ID = dbo.TB_ENCABEZADO_MOVIMIENTOS.VCHA_MOV_MOVIMIENTO_ID AND dbo.TB_ENTRADAS.INTE_ENT_NUMERO = dbo.TB_ENCABEZADO_MOVIMIENTOS.INTE_EMO_NUMERO WHERE (dbo.TB_ENTRADAS.VCHA_EMP_EMPRESA_ID = '" + var_empresa + "') AND (dbo.TB_ENTRADAS.VCHA_UOR_UNIDAD_ID = '" + var_unidad_organizacional + "') AND "
                        var_cadena = var_cadena + "(dbo.TB_ENTRADAS.VCHA_MOV_MOVIMIENTO_ID = 'EC') AND (dbo.TB_ENCABEZADO_MOVIMIENTOS.VCHA_PRO_PROVEEDOR_ID = '" + Me.txt_proveedor + "') AND (dbo.TB_ENTRADAS.VCHA_ART_ARTICULO_ID = '" + rs!vcha_Art_Articulo_id + "') GROUP BY dbo.TB_ENTRADAS.VCHA_ART_ARTICULO_ID, dbo.TB_ENCABEZADO_MOVIMIENTOS.VCHA_PRO_PROVEEDOR_ID "
                        rsaux.Open var_cadena, cnn, adOpenDynamic, adLockOptimistic
                        If Not rsaux.EOF Then
                           var_cantidad_disponible = IIf(IsNull(rsaux!CANTIDAD_DISPONIBLE), 0, rsaux!CANTIDAD_DISPONIBLE)
                        Else
                           var_cantidad_disponible = 0
                        End If
                        If var_cantidad_disponible < rs!floa_Sal_Cantidad Then
                           ...
                           If var_cadena_articulos_proveedor = "" Then
                              var_cadena_articulos_proveedor = rs!vcha_Art_Articulo_id + " " + IIf(IsNull(rsaux1!vcha_Art_nombre_español), "", rsaux1!vcha_Art_nombre_español)
                           Else
                              var_cadena_articulos_proveedor = var_cadena_articulos_proveedor + ", " + rs!vcha_Art_Articulo_id + " " + IIf(IsNull(rsaux1!vcha_Art_nombre_español), "", rsaux1!vcha_Art_nombre_español)
                           End If
                           rsaux1.Close
                           var_si_Cantidad_proveedor = 0
                        End If
                        rs.MoveNext
                  Wend
                  rs.Close
                  If var_si_Cantidad_proveedor = 1 Then
                  Cadena = "select * from tb_temporal_salidas with (nolock) where vcha_alm_almacen_id = '" + var_almacen_Destino + "' and  VCHA_MOV_MOVIMIENTO_ID = '" + var_clave_movimiento + "' and inte_sal_numero = " + Str(var_numero_folio)
                  rs.Open Cadena, cnn, adOpenDynamic, adLockOptimistic
                  While Not rs.EOF
                        var_cantidad_total = rs!floa_Sal_Cantidad
                        var_cadena = "SELECT inte_emo_numero_origen, vcha_emo_factura, inte_ent_numero, dtim_ent_fecha,dbo.TB_ENTRADAS.FLOA_ENT_CANTIDAD - ISNULL(dbo.TB_ENTRADAS.FLOA_ENT_CANTIDAD_DEVUELTA,0) AS CANTIDAD_DISPONIBLE, dbo.TB_ENTRADAS.VCHA_ART_ARTICULO_ID , dbo.TB_ENCABEZADO_MOVIMIENTOS.VCHA_PRO_PROVEEDOR_ID FROM dbo.TB_ENTRADAS INNER JOIN dbo.TB_ENCABEZADO_MOVIMIENTOS ON dbo.TB_ENTRADAS.VCHA_EMP_EMPRESA_ID = dbo.TB_ENCABEZADO_MOVIMIENTOS.VCHA_EMP_EMPRESA_ID AND dbo.TB_ENTRADAS.VCHA_UOR_UNIDAD_ID = dbo.TB_ENCABEZADO_MOVIMIENTOS.VCHA_UOR_UNIDAD_ID AND dbo.TB_ENTRADAS.VCHA_ALM_ALMACEN_ID = dbo.TB_ENCABEZADO_MOVIMIENTOS.VCHA_ALM_ALMACEN_ID AND dbo.TB_ENTRADAS.VCHA_MOV_MOVIMIENTO_ID = dbo.TB_ENCABEZADO_MOVIMIENTOS.VCHA_MOV_MOVIMIENTO_ID AND dbo.TB_ENTRADAS.INTE_ENT_NUMERO = dbo.TB_ENCABEZADO_MOVIMIENTOS.INTE_EMO_NUMERO WHERE (dbo.TB_ENTRADAS.VCHA_EMP_EMPRESA_ID = '" + var_empresa + "') AND (dbo.TB_ENTRADAS.VCHA_UOR_UNIDAD_ID = '" + var_unidad_organizacional + "') AND "
                        var_cadena = var_cadena + " (dbo.TB_ENTRADAS.VCHA_MOV_MOVIMIENTO_ID = 'EC') AND (dbo.TB_ENCABEZADO_MOVIMIENTOS.VCHA_PRO_PROVEEDOR_ID = '" + Me.txt_proveedor + "') and vcha_art_articulo_id = '" + rs!vcha_Art_Articulo_id + "' order by dtim_ent_fecha desc"
                        If rsaux1.State = 1 Then
                           rsaux1.Close
                        End If
                        rsaux1.Open var_cadena, cnn, adOpenDynamic, adLockOptimistic
                        While Not rsaux1.EOF Or var_cantidad_total > 0
                              If var_cantidad_total <= rsaux1!CANTIDAD_DISPONIBLE Then
                                 If var_cantidad_total > 0 Then
                                    rsaux2.Open "update tb_Entradas set FLOA_ENT_CANTIDAD_DEVUELTA = isnull(FLOA_ENT_CANTIDAD_DEVUELTA,0) + " + CStr(var_cantidad_total) + " where vcha_Emp_empresa_id = '" + var_empresa + "' and vcha_uor_unidad_id = '" + var_unidad_organizacional + "' and vcha_mov_movimiento_id = 'EC' and inte_ent_numero = " + CStr(rsaux1!inte_ent_numero), cnn, adOpenDynamic, adLockOptimistic
                                    rsaux3.Open "insert into tb_salidas (vcha_emp_empresa_id, vcha_uor_unidad_id, vcha_alm_almacen_id, vcha_mov_movimiento_id, inte_sal_numero, vcha_art_articulo_id, floa_sal_cantidad, floa_sal_costo, floa_sal_precio, inte_sal_año, INTE_SAL_ORDEN_COMPRA, VCHA_SAL_FACTURA) values ('" + rs!VCHA_EMP_EMPRESA_ID + "', '" + rs!VCHA_UOR_UNIDAD_ID + "', '" + rs!VCHA_ALM_ALMACEN_ID + "', '" + rs!VCHA_MOV_MOVIMIENTO_ID + "', " + CStr(rs!INTE_SAL_NUMERO) + ", '" + rs!vcha_Art_Articulo_id + "', " + CStr(var_cantidad_total) + ", " + CStr(rs!floa_Sal_costo) + " , " + CStr(rs!floa_Sal_precio) + ", 2005, " + CStr(rsaux1!inte_emo_numero_origen) + ", '" + IIf(IsNull(rsaux1!vcha_emo_factura), "", rsaux1!vcha_emo_factura) + "')", cnn, adOpenDynamic, adLockOptimistic
                                    var_cantidad_total = 0
                                 End If
                              Else
                                 If rsaux1!CANTIDAD_DISPONIBLE > 0 Then
                                    var_cantidad_total = var_cantidad_total - rsaux1!CANTIDAD_DISPONIBLE
                                    rsaux2.Open "update tb_Entradas set FLOA_ENT_CANTIDAD_DEVUELTA = isnull(FLOA_ENT_CANTIDAD_DEVUELTA,0) + " + CStr(rsaux1!CANTIDAD_DISPONIBLE) + " where vcha_Emp_empresa_id = '" + var_empresa + "' and vcha_uor_unidad_id = '" + var_unidad_organizacional + "' and vcha_mov_movimiento_id = 'EC' and inte_ent_numero = " + CStr(rsaux1!inte_ent_numero), cnn, adOpenDynamic, adLockOptimistic
                                    rsaux3.Open "insert into tb_salidas (vcha_emp_empresa_id, vcha_uor_unidad_id, vcha_alm_almacen_id, vcha_mov_movimiento_id, inte_sal_numero, vcha_art_articulo_id, floa_sal_cantidad, floa_sal_costo, floa_sal_precio, inte_sal_año, INTE_SAL_ORDEN_COMPRA, VCHA_SAL_FACTURA) values ('" + rs!VCHA_EMP_EMPRESA_ID + "', '" + rs!VCHA_UOR_UNIDAD_ID + "', '" + rs!VCHA_ALM_ALMACEN_ID + "', '" + rs!VCHA_MOV_MOVIMIENTO_ID + "', " + CStr(rs!INTE_SAL_NUMERO) + ", '" + rs!vcha_Art_Articulo_id + "', " + CStr(rsaux1!CANTIDAD_DISPONIBLE) + ", " + CStr(rs!floa_Sal_costo) + " , " + CStr(rs!floa_Sal_precio) + ", 2005 ," + CStr(rsaux1!inte_emo_numero_origen) + ", '" + IIf(IsNull(rsaux1!vcha_emo_factura), "", rsaux1!vcha_emo_factura) + "')", cnn, adOpenDynamic, adLockOptimistic
                                 End If
                              End If
                              rsaux1.MoveNext
                        Wend
                  ...
                  Else
                     MsgBox "Los siguientes artículos exceden la cantidad disponible para devolver al proveedor: " + var_cadena_articulos_proveedor, vbYesNo, "ATENCION"
                  End If
               Else
         ...
         If Not rs.EOF Then
            ...
            If var_movimiento_bloqueado = 0 Then
               ...
               If var_posible = 1 Then
                  ...
                  rsaux.Open "SELECT * FROM TB_PROVEEDORES WHERE VCHA_PRO_PROVEEDOR_ID = '" + txt_proveedor + "'", cnn, adOpenDynamic, adLockOptimistic
                  If Not rsaux.EOF Then
...
Private Sub txt_factura_KeyDown(KeyCode As Integer, Shift As Integer)
   If Me.txt_factura.Enabled = True Then
      If KeyCode = 116 Then
         rsaux11.Open "select vcha_com_Referencia, max(dtim_com_fecha) as fecha from tb_archivo_comparacion where vcha_Art_Articulo_id = '" + Me.txt_codigo + "' and VCHA_COM_PROVEEDOR = '" + Me.txt_proveedor + "' and vcha_emp_empresa_id = '" + var_empresa + "' and vcha_mov_movimiento_id = 'EC' group by vcha_Com_referencia", cnn, adOpenDynamic, adLockOptimistic
...
Private Sub txt_foco_GotFocus()
   ...
   If Trim(txt_codigo.Text) <> "" Then
      ...
      If var_pase_existencias = 1 Then
         ...
         End If
         var_cadena = "SELECT SUM(dbo.TB_ENTRADAS.FLOA_ENT_CANTIDAD - ISNULL(dbo.TB_ENTRADAS.FLOA_ENT_CANTIDAD_DEVUELTA, 0)) AS CANTIDAD_DISPONIBLE, dbo.TB_ENTRADAS.VCHA_ART_ARTICULO_ID , dbo.TB_ENCABEZADO_MOVIMIENTOS.VCHA_PRO_PROVEEDOR_ID FROM dbo.TB_ENTRADAS INNER JOIN dbo.TB_ENCABEZADO_MOVIMIENTOS ON dbo.TB_ENTRADAS.VCHA_EMP_EMPRESA_ID = dbo.TB_ENCABEZADO_MOVIMIENTOS.VCHA_EMP_EMPRESA_ID AND dbo.TB_ENTRADAS.VCHA_UOR_UNIDAD_ID = dbo.TB_ENCABEZADO_MOVIMIENTOS.VCHA_UOR_UNIDAD_ID AND dbo.TB_ENTRADAS.VCHA_ALM_ALMACEN_ID = dbo.TB_ENCABEZADO_MOVIMIENTOS.VCHA_ALM_ALMACEN_ID AND dbo.TB_ENTRADAS.VCHA_MOV_MOVIMIENTO_ID = dbo.TB_ENCABEZADO_MOVIMIENTOS.VCHA_MOV_MOVIMIENTO_ID AND dbo.TB_ENTRADAS.INTE_ENT_NUMERO = dbo.TB_ENCABEZADO_MOVIMIENTOS.INTE_EMO_NUMERO WHERE (dbo.TB_ENTRADAS.VCHA_EMP_EMPRESA_ID = '" + var_empresa + "') AND (dbo.TB_ENTRADAS.VCHA_UOR_UNIDAD_ID = '" + var_unidad_organizacional + "') AND "
         var_cadena = var_cadena + "(dbo.TB_ENTRADAS.VCHA_MOV_MOVIMIENTO_ID = 'EC') AND (dbo.TB_ENCABEZADO_MOVIMIENTOS.VCHA_PRO_PROVEEDOR_ID = '" + Me.txt_proveedor + "') AND (dbo.TB_ENTRADAS.VCHA_ART_ARTICULO_ID = '" + Me.txt_codigo + "') GROUP BY dbo.TB_ENTRADAS.VCHA_ART_ARTICULO_ID, dbo.TB_ENCABEZADO_MOVIMIENTOS.VCHA_PRO_PROVEEDOR_ID "
         If rsaux10.State = 1 Then
            rsaux10.Close
         End If
         rsaux10.Open var_cadena, cnn, adOpenDynamic, adLockOptimistic
         var_cantidad_disponible = IIf(IsNull(rsaux10!CANTIDAD_DISPONIBLE), 0, rsaux10!CANTIDAD_DISPONIBLE)
         rsaux10.Close
         If var_cantidad_disponible >= var_cantidad_temporal + var_cantidad_leida Then
         ...
         Else
            Me.txt_codigo = ""
            frmmensaje.lbl_mensaje = "La cantidad excede a la disponible en las entradas por compra del proveedor"
            frmmensaje.Show 1
         End If
      Else
         Me.txt_codigo = ""
...
Private Sub txt_nombre_proveedor_KeyDown(KeyCode As Integer, Shift As Integer)
   If txt_proveedor.Enabled = True Then
      If KeyCode = 116 Then
         var_ventana = 2
         rs.Open "SELECT DISTINCT TOP 100 PERCENT dbo.TB_ARCHIVO_COMPARACION.VCHA_COM_PROVEEDOR, dbo.TB_PROVEEDORES.VCHA_PRO_NOMBRE FROM dbo.TB_ARCHIVO_COMPARACION INNER JOIN dbo.TB_PROVEEDORES ON dbo.TB_ARCHIVO_COMPARACION.VCHA_COM_PROVEEDOR = dbo.TB_PROVEEDORES.VCHA_PRO_PROVEEDOR_ID WHERE (dbo.TB_ARCHIVO_COMPARACION.VCHA_MOV_MOVIMIENTO_ID = 'EC') AND (dbo.TB_ARCHIVO_COMPARACION.VCHA_EMP_EMPRESA_ID = '" + var_empresa + "') ORDER BY dbo.TB_ARCHIVO_COMPARACION.VCHA_COM_PROVEEDOR)", cnn, adOpenDynamic, adLockOptimistic
         lv_lista.ListItems.Clear
         While Not rs.EOF
...
Private Sub txt_proveedor_KeyDown(KeyCode As Integer, Shift As Integer)
   If txt_proveedor.Enabled = True Then
      If KeyCode = 116 Then
         var_ventana = 2
         'MsgBox "SELECT DISTINCT TOP 100 PERCENT dbo.TB_ARCHIVO_COMPARACION.VCHA_COM_PROVEEDOR, dbo.TB_PROVEEDORES.VCHA_PRO_NOMBRE FROM dbo.TB_ARCHIVO_COMPARACION INNER JOIN dbo.TB_PROVEEDORES ON dbo.TB_ARCHIVO_COMPARACION.VCHA_COM_PROVEEDOR = dbo.TB_PROVEEDORES.VCHA_PRO_PROVEEDOR_ID WHERE (dbo.TB_ARCHIVO_COMPARACION.VCHA_MOV_MOVIMIENTO_ID = 'EC') AND (dbo.TB_ARCHIVO_COMPARACION.VCHA_EMP_EMPRESA_ID = '" + var_empresa + "') ORDER BY dbo.TB_ARCHIVO_COMPARACION.VCHA_COM_PROVEEDOR)"
         rs.Open "SELECT DISTINCT TOP 100 PERCENT dbo.TB_ARCHIVO_COMPARACION.VCHA_COM_PROVEEDOR, dbo.TB_PROVEEDORES.VCHA_PRO_NOMBRE FROM dbo.TB_ARCHIVO_COMPARACION INNER JOIN dbo.TB_PROVEEDORES ON dbo.TB_ARCHIVO_COMPARACION.VCHA_COM_PROVEEDOR = dbo.TB_PROVEEDORES.VCHA_PRO_PROVEEDOR_ID WHERE (dbo.TB_ARCHIVO_COMPARACION.VCHA_MOV_MOVIMIENTO_ID = 'EC') AND (dbo.TB_ARCHIVO_COMPARACION.VCHA_EMP_EMPRESA_ID = '" + var_empresa + "') ORDER BY dbo.TB_ARCHIVO_COMPARACION.VCHA_COM_PROVEEDOR", cnn, adOpenDynamic, adLockOptimistic
         lv_lista.ListItems.Clear
         While Not rs.EOF
               Set list_item = lv_lista.ListItems.Add(, , rs!VCHA_COM_PROVEEDOR)
...
Private Sub txt_proveedor_KeyPress(KeyAscii As Integer)
   ...
   If KeyAscii = 13 Then
      If Len(Trim(txt_proveedor)) > 0 Then
         ...
         rs.Open "SELECT DISTINCT TOP 100 PERCENT dbo.TB_ARCHIVO_COMPARACION.VCHA_COM_PROVEEDOR, dbo.TB_PROVEEDORES.VCHA_PRO_NOMBRE FROM dbo.TB_ARCHIVO_COMPARACION INNER JOIN dbo.TB_PROVEEDORES ON dbo.TB_ARCHIVO_COMPARACION.VCHA_COM_PROVEEDOR = dbo.TB_PROVEEDORES.VCHA_PRO_PROVEEDOR_ID WHERE (dbo.TB_ARCHIVO_COMPARACION.VCHA_MOV_MOVIMIENTO_ID = 'EC') AND (dbo.TB_ARCHIVO_COMPARACION.VCHA_EMP_EMPRESA_ID = '" + var_empresa + "') AND dbo.TB_ARCHIVO_COMPARACION.VCHA_COM_PROVEEDOR = '" + Me.txt_proveedor + "' ORDER BY dbo.TB_ARCHIVO_COMPARACION.VCHA_COM_PROVEEDOR", cnn, adOpenDynamic, adLockOptimistic
         If Not rs.EOF Then
