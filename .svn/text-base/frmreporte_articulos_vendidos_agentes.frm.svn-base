...
Begin VB.Form frmreporte_articulos_vendidos_agentes 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton cmd_seleccion 
         ...
         Height          =   315
         Left            =   1440
         Picture         =   "frmreporte_articulos_vendidos_agentes.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton cmd_marcar 
         ...
         Height          =   315
         Left            =   780
         Picture         =   "frmreporte_articulos_vendidos_agentes.frx":0216
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton cmd_invertir 
         ...
         Height          =   315
         Left            =   1110
         Picture         =   "frmreporte_articulos_vendidos_agentes.frx":0460
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton cmd_ninguno 
         Height          =   315
         Left            =   120
         Picture         =   "frmreporte_articulos_vendidos_agentes.frx":0532
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton cmd_todos 
         ...
         Height          =   315
         Left            =   450
         Picture         =   "frmreporte_articulos_vendidos_agentes.frx":0634
         Style           =   1  'Graphical
         TabIndex        =   4
   ...
   End
End
Attribute VB_Name = "frmreporte_articulos_vendidos_agentes"
...
Private Sub cmd_ejecutar_Click()
   If IsDate(Me.txt_inicio) Then
      If IsDate(Me.txt_fin) Then
         var_contador = 0
         For var_i = 1 To Me.lv_agentes.ListItems.Count
         ...
         If var_contador > 0 Then
            ...
            For var_i = 1 To lv_agentes.ListItems.Count
                ...
                If lv_agentes.selectedItem.SubItems(2) = "*" Then
                   rs.Open "INSERT INTO TB_TEMP_REPORTE_ARTICULOS_VENDIDOS_AGENTES (INTE_TEM_CONSECUTIVO, VCHA_AGE_AGENTE_ID) VALUES (" + CStr(var_consecutivo) + ",'" + lv_agentes.selectedItem + "')", cnn, adOpenDynamic, adLockOptimistic
                End If
            Next var_i
...
Private Sub cmd_filtro_Click()
   ...
   For var_i = 1 To lv_agentes.ListItems.Count
       ...
       If lv_agentes.selectedItem.SubItems(2) = "*" Then
          If Trim(var_cadena_reporte_articulos) = "" Then
             var_cadena_reporte_articulos = " vcha_age_agente_id = '" + lv_agentes.selectedItem + "'"
          Else
             var_cadena_reporte_articulos = var_cadena_reporte_articulos + " or vcha_age_agente_id = '" + lv_agentes.selectedItem + "'"
          End If
       End If
   Next var_i
   ...
   Else
      frmreporte_articulos_vendidos_articulos.txt_tipo_reporte = "Agentes"
...
Private Sub Form_Load()
   ...
   txt_fin = Date
   'opt_linea = True
   rs.Open "select distinct vcha_age_agente_id, vcha_age_nombre from vw_clientes where  (" + var_cadena_reporte_articulos + ")  order by vcha_AGE_nombre ", cnn, adOpenDynamic, adLockOptimistic
   numero_items_ALMACENES = 0
   While Not rs.EOF
      If IsNull(rs!VCHA_AGE_AGENTE_ID) Then
      Else
   ...
   Wend
   rs.Close
   If lv_agentes.ListItems.Count > 8 Then
      lv_agentes.ColumnHeaders(2).Width = 4220
   Else
      lv_agentes.ColumnHeaders(2).Width = 4400.71
   End If
End Sub
...
Private Sub txt_busqueda_KeyPress(KeyAscii As Integer)
   If KeyAscii = 13 Then
      ...
      If Not rs.EOF Then
         Call pro_busca_registro(lv_agentes, rs!vcha_can_nombre, False)
      Else
