...
Begin VB.Form frmEtiquetasPreciosCantia 
   ...
   Begin VB.CommandButton cmd_ConfiguraEtiquetas 
      ...
      Style           =   1  'Graphical
      TabIndex        =   21
      ToolTipText     =   "Configura y Agrega Tamaño Etiqueta"
      Top             =   15
      Width           =   330
   End
...
Private Sub cmd_ConfiguraEtiquetas_Click()
    frmConfiguracionTamaños.Show 1
...
Private Sub cmd_imprimir_Click()
    ...
    If lv_articulos.ListItems.Count > 0 Then
        If cbo_TiposEtiquetas.Text <> "" Then
                ...
                If MsgBox("El Tamaño de papel que debe ir en la impresora es: " & cbo_TiposEtiquetas.Text & vbCrLf & "¿Es correcto?", vbYesNo, "SID") = vbYes Then
                        ...
                        If Conectar_BDCompucaja(conCompucaja, "compucaja", "srvtdaCantia") Then
                            ...
                            If rsConfiguracion.RecordCount > 0 Then
                                ...
                                lv_articulos.ListItems.Clear
                            Else
                                MsgBox "No se encontró la configuracion de la etiqueta " & cbo_TiposEtiquetas.Text, vbCritical, "SID"
                            End If
        ...
        Else
            MsgBox "Favor de Seleccionar el Tamaño de la Etiqueta", vbCritical, "SID"
        End If
    Else
...
Private Sub cmd_nuevo_Click()
    If lv_articulos.ListItems.Count > 0 Then
        If MsgBox("¿Esta seguro de comenzar?, esta operacion borrará lo capturado", vbYesNo, "SIP") = vbYes Then
            Call pro_Nuevo
        End If
    Else
        Call pro_Nuevo
    ...
    If KeyCode = 13 Then
        If Conectar_BDCompucaja(conCompucaja, "compucaja", "srvtdacantia") Then
            ...
            If txt_descripcion.Text <> "" Then
                ...
                txt_cantidad.SetFocus
            Else
                MsgBox "No se encontró el articulo", vbCritical, "SID"
            End If
            conCompucaja.Close
        Else
            MsgBox "Error al conectar al servidor de Compucaja", vbCritical, "SID"
...
On Error GoTo ErrorBusca:
    ...
    If rsEtiquetas.RecordCount > 0 Then
        If Not IsNull(rsEtiquetas("categoria").Value) Then
            ...
            Else
                MsgBox "Falta El diseño", vbCritical, "SID"
            End If
        Else
...
On Error Resume Next
    ...
    Dim numbTamaño As Integer
    Dim numbTamañoAgregado As Integer
    ...
    numbTamañoAgregado = -1
    
    numbEntraTitulos = Len(strCategoria)
    If numbTamañoAgregado = -1 Then
        numbTamañoAgregado = 0
    End If
    While NumCaracteres >= Len(nomArticulo) And numbEntraTitulos > 0
        ...
        If InStr(strCategoria, " ") > 0 Then
            numbTamaño = Len(Trim(nomArticulo & Mid(strCategoria, 1, InStr(Trim(strCategoria), " "))))
        Else
            numbTamaño = Len(nomArticulo & strCategoria)
        End If
        If numbTamaño <= NumCaracteres Then
            If InStr(strCategoria, " ") > 0 Then
                numbTamañoAgregado = Len(nomArticulo)
            End If
        Else
    ...
    While NumCaracteres >= Len(nomArticulo) And numbEntraTitulos > 0
        ...
        If InStr(strDiseno, " ") > 0 Then
            numbTamaño = Len(Trim(nomArticulo & Mid(strDiseno, 1, InStr(Trim(strDiseno), " "))))
        Else
            numbTamaño = Len(nomArticulo & strDiseno)
        End If
        If numbTamaño <= NumCaracteres Then
            If InStr(strDiseno, " ") > 0 Then
                numbTamañoAgregado = Len(nomArticulo)
    ...
    If rsConfiguracion("bint_eti_posi_x_ubicacion").Value >= 0 Then
        If strPos = "1" Then
            Print #1, "A" & rsConfiguracion("bint_eti_posi_x_ubicacion").Value + rsConfiguracion("int_eti_TamLineaUbicacion").Value & ",23," & strPos & ",i,1,1,N, " & var_comillas & "Encuéntralo en: " & var_comillas; ""
        Else
            Print #1, "A23," & rsConfiguracion("bint_eti_posi_y_ubicacion").Value + rsConfiguracion("int_eti_TamLineaUbicacion").Value & "," & strPos & ",i,1,1,N, " & var_comillas & "Encuéntralo en: " & var_comillas; ""
        End If
