...
Begin VB.Form frmsalidas_empaques_trazabilidad 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Empaque de mercancia"
   ClientHeight    =   7320
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   11640
   ...
   Begin VB.Frame frm_codigo_trazabilidad 
      Height          =   840
      Left            =   7065
      TabIndex        =   71
      Top             =   4725
      Width           =   2910
      Begin VB.TextBox txt_codigo_trazabilidad 
         Height          =   330
         Left            =   75
         TabIndex        =   72
         Top             =   375
   ...
   Begin VB.CommandButton Command1 
      ...
      Height          =   315
      Left            =   11235
      Picture         =   "frmsalidas_empaques_trazabilidad.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   1
      ToolTipText     =   "Salir"
      Top             =   570
   ...
   Begin VB.CommandButton cmd_nuevo 
      ...
      Height          =   315
      Left            =   60
      Picture         =   "frmsalidas_empaques_trazabilidad.frx":063A
      Style           =   1  'Graphical
      TabIndex        =   4
   ...
   Begin VB.CommandButton cmd_buscar 
      ...
      Height          =   315
      Left            =   390
      Picture         =   "frmsalidas_empaques_trazabilidad.frx":073C
      Style           =   1  'Graphical
      TabIndex        =   3
   ...
   Begin VB.CommandButton cmd_imprimir 
      ...
      Height          =   315
      Left            =   720
      Picture         =   "frmsalidas_empaques_trazabilidad.frx":083E
      Style           =   1  'Graphical
      TabIndex        =   2
   ...
   Begin VB.CommandButton cmd_cerrar 
      ...
      Height          =   315
      Left            =   1050
      Picture         =   "frmsalidas_empaques_trazabilidad.frx":0940
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   Begin MSComctlLib.ImageList ImageList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_empaques_trazabilidad.frx":0A42
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_empaques_trazabilidad.frx":131C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_empaques_trazabilidad.frx":1BF6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_empaques_trazabilidad.frx":2192
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_empaques_trazabilidad.frx":2A6E
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_empaques_trazabilidad.frx":3348
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_empaques_trazabilidad.frx":3C22
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_empaques_trazabilidad.frx":3D34
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_empaques_trazabilidad.frx":3E46
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_empaques_trazabilidad.frx":3F58
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_empaques_trazabilidad.frx":406A
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_empaques_trazabilidad.frx":417C
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_empaques_trazabilidad.frx":428E
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_empaques_trazabilidad.frx":4430
            Key             =   ""
         EndProperty
         BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_empaques_trazabilidad.frx":5282
            Key             =   ""
         EndProperty
         BeginProperty ListImage16 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_empaques_trazabilidad.frx":5458
            Key             =   ""
         EndProperty
         BeginProperty ListImage17 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_empaques_trazabilidad.frx":556A
            Key             =   ""
         EndProperty
         BeginProperty ListImage18 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_empaques_trazabilidad.frx":67EC
            Key             =   ""
         EndProperty
         BeginProperty ListImage19 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_empaques_trazabilidad.frx":68FE
            Key             =   ""
         EndProperty
         BeginProperty ListImage20 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_empaques_trazabilidad.frx":7B80
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame frm_refacturacion 
         ...
         Begin VB.CommandButton cmd_refacturacion 
            Height          =   345
            Left            =   60
            Picture         =   "frmsalidas_empaques_trazabilidad.frx":8E02
            Style           =   1  'Graphical
            TabIndex        =   55
            Top             =   120
            Width           =   345
   ...
   End
End
Attribute VB_Name = "frmsalidas_empaques_trazabilidad"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim var_cantidad_trazabilidad As Double
...
Private Sub Form_Load()
   ...
   Me.frm_codigo_trazabilidad.Visible = False
   var_si_exporta = 0
   var_si_trazabilidad = 0
   lbl_estatus = ""
...
Private Sub lv_salidas_KeyDown(KeyCode As Integer, Shift As Integer)
   If KeyCode = 114 Then
      var_cantidad_trazabilidad = 0
      If var_estatus_movimiento = "C" Or var_estatus_movimiento = "I" Then
         MsgBox "Imposible modificar el movimiento", vbOKOnly, "ATENCION"
      Else
         rsaux10.Open "select * from tb_trazabilidad_codigos where vcha_emp_empresa_id = '" + var_empresa + "' and inte_emb_embarque = " + Me.txt_embarque + " and inte_ors_orden_surtido = " + Me.txt_archivo + " and inte_paq_caja = " + Me.txt_caja + " and vcha_Art_articulo_id = '" + Me.lv_salidas.selectedItem + "' and floa_Tra_cantidad > 0", cnn, adOpenDynamic, adLockOptimistic
         If Not rsaux10.EOF Then
            var_cantidad_trazabilidad = IIf(IsNull(rsaux10!floa_tra_Cantidad), 0, rsaux10!floa_tra_Cantidad)
            Me.frm_codigo_trazabilidad.Visible = True
            Me.txt_codigo_trazabilidad = ""
            Me.txt_codigo_trazabilidad.SetFocus
         Else
...
Private Sub txt_cantidad_eliminar_KeyPress(KeyAscii As Integer)
   ...
   If KeyAscii = 13 Then
      ...
      If var_cantidad_eliminar_arch >= var_cantidad_eliminar Then
         ...
         'var_actualiza = TB_DET_ORDEN_SURTIDO_M.Anadir(var_empresa, var_unidad_organizacional, var_almacen_origen, var_orden_surtido, lv_salidas.selectedItem, 0, 0 - var_cantidad_eliminar, var_precio, var_tipo_pedido)
   ...
   If KeyAscii = 13 Then
      ...
      If var_si_trazabilidad = 1 Then
         If Mid(Me.txt_codigo, 1, 1) = "<" Then
            ...
            rs.Close
         Else
            '' en caso de que si sea trazabilidad pero el codigo sea viejo
            ...
            '' fin de que si sea trazabilidad pero el codigo sea viejo
         End If
         ...
         If var_si_exporta = 0 Then
            ...
            End If
         End If
''' aqui termina si es con trazabilidad
      Else
         var_verificador = True
         If Len(Trim(txt_codigo)) = 12 Then
            Call calcula_verificador(Trim(txt_codigo))
...
Private Sub txt_codigo_trazabilidad_GotFocus()
   Me.txt_codigo_trazabilidad = ""
End Sub

Private Sub txt_codigo_trazabilidad_KeyPress(KeyAscii As Integer)
   If KeyAscii = 13 Then
      If var_cantidad_trazabilidad > 0 Then
         If Trim(Me.txt_codigo_trazabilidad) <> "" Then
            If Mid(Me.txt_codigo_trazabilidad, 1, 1) = "<" Then
               rsaux11.Open "select * from tb_trazabilidad_codigos where vcha_emp_empresa_id = '" + var_empresa + "' and inte_emb_embarque = " + Me.txt_embarque + " and inte_ors_orden_surtido = " + Me.txt_archivo + " and inte_paq_caja = " + Me.txt_caja + " and vcha_tra_codigo = '" + Me.txt_codigo_trazabilidad + "' and floa_Tra_cantidad>0", cnn, adOpenDynamic, adLockOptimistic
               If Not rsaux11.EOF Then
                  ...
                  If var_cantidad_eliminar_arch >= var_cantidad_eliminar Then
                     ...
                     If rsaux2.State = 1 Then
                        rsaux2.Close
                     End If
                     rsaux5.Open "UPDATE TB_TRAZABILIDAD_CODIGOS SET FLOA_TRA_CANTIDAD = ISNULL(FLOA_TRA_CANTIDAD,0) - 1 WHERE  VCHA_EMP_EMPRESA_ID = '" + var_empresa + "' AND inte_emb_embarque = " + Me.txt_embarque + " and inte_ors_orden_surtido = " + Me.txt_archivo + " and vcha_tra_codigo = '" + Me.txt_codigo_trazabilidad + "' AND INTE_PAQ_CAJA = " + CStr(var_numero_caja), cnn, adOpenDynamic, adLockOptimistic
                     txt_codigo.SetFocus
                     Me.frm_codigo_trazabilidad.Visible = False
                  Else
                     MsgBox "No esposible eliminar esta cantidad", vbOKOnly, "ATENCION"
               ...
               Else
                  Me.txt_codigo_trazabilidad = ""
                  frmmensaje.lbl_mensaje = "El código de trazabilidad no existe en la caja"
                  frmmensaje.Show 1
               End If
               rsaux11.Close
            Else
               Me.txt_codigo_trazabilidad = ""
               frmmensaje.lbl_mensaje = "Debe de indicar el codigo de trazabilidad"
               frmmensaje.Show 1
            End If
         Else
            Me.txt_codigo_trazabilidad = ""
...
Private Sub txt_codigo_trazabilidad_LostFocus()
   Me.frm_codigo_trazabilidad.Visible = False
End Sub
      ...
      If Not rs.EOF Then
         If var_clave_movimiento = rs!VCHA_MOV_MOVIMIENTO_ID Then
            If var_agente_embarque = rs!VCHA_AGE_AGENTE_ID Then
               ...
               rsaux9.Open "select isnull(inte_cli_trazabilidad,0) from tb_clientes where vcha_cli_clave_id = '" + var_cliente_embarque + "'", cnn, adOpenDynamic, adLockOptimistic
               If Not rsaux9.EOF Then
                  var_si_trazabilidad = IIf(IsNull(rsaux9(0).Value), 0, rsaux9(0).Value)
               Else
                  var_si_trazabilidad = 0
               End If
               rsaux9.Close
               ...
               If var_empresa = "03" Then
                  rsaux9.Open "SELECT isnull(min(INTE_ORS_ORDEN_SURTIDO),0) FROM TB_DETALLE_CAJAS WHERE INTE_EMB_EMBARQUE = " + Me.txt_embarque + " AND VCHA_EMP_EMPRESA_ID = '03'", cnn, adOpenDynamic, adLockOptimistic
