   ...
   If var_numero_folio > 0 Then
            ...
            If var_clave_movimiento = "SACJ" Then
               If IsNumeric(Me.txt_folio) Then
                  ...
                  If Not rs.EOF Then
                     VAR_FALTANTES = ""
                     While Not rs.EOF
                           rsaux.Open "select isnull(vcha_Art_articulo_id,''), VCHA_aRT_NOMBRE_ESPAÑOL from TB_aRTICULOS where vcha_Art_articulo_id = '" + rs!vcha_Art_Articulo_id + "'", cnn, adOpenDynamic, adLockOptimistic
                           If rsaux(0).Value = "" Then
                              If VAR_FALTANTES = "" Then
                                 VAR_FALTANTES = rs!vcha_Art_Articulo_id + " " + rsaux!VCHA_ART_NOMBRE_ESPAÑOL
                                 VAR_FALTANTES = rs!vcha_Art_Articulo_id + " " + rsaux!vcha_Art_nombre_español
                              Else
                                 VAR_FALTANTES = VAR_FALTANTES + ", " + rs!vcha_Art_Articulo_id + " " + rsaux!vcha_Art_nombre_español
                              End If
                           End If
                           rsaux.Close
                     ...
                     If VAR_FALTANTES = "" Then
                        ...
                        End If
                     Else
                        MsgBox "Los siguientes códigos no tienen equivalencia " + VAR_FALTANTES, vbOKOnly, "ATENCION"
                     End If
                  End If
                  rs.Close
               End If
      ...
      Else
         ...
         If var_posible_Cantidad = 1 Then
            ...
            End If
         Else
            MsgBox "El movimiento no se puede imprimir ya que las existencias de los siguientes artículos exceden a la cantidad disponible en el almacén " + var_cadena_articulos
         End If
      End If
   Else
   ...
   If Trim(txt_codigo.Text) <> "" Then
      ...
      If var_pase_existencias = 1 Then
         ...
         If var_pase = 0 Then
            ...
            End If
         Else
            MsgBox "El artículo esta bloqueado para su venta", vbOKOnly, "ATENCION"
         End If
      Else
         Me.txt_codigo = ""
         frmmensaje.lbl_mensaje = "La cantidad excede a la cantidad en existencias"
