...
Begin VB.Form frmprecios_paqueteria 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "frmprecios_paqueteria"
   ClientHeight    =   7350
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5865
   ...
   Begin VB.CommandButton cmd_salir 
      ...
      Height          =   315
      Left            =   5415
      Picture         =   "frmprecios_paqueteria.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   3
      ToolTipText     =   "Salir"
      Top             =   0
   ...
   Begin VB.CommandButton cmd_guardar 
      ...
      Height          =   315
      Left            =   435
      Picture         =   "frmprecios_paqueteria.frx":063A
      Style           =   1  'Graphical
      TabIndex        =   2
   ...
   Begin VB.CommandButton cmd_nuevo 
      ...
      Height          =   315
      Left            =   105
      Picture         =   "frmprecios_paqueteria.frx":073C
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin MSComctlLib.ImageList icono_encabezado 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmprecios_paqueteria.frx":083E
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmprecios_paqueteria.frx":1118
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList ImageList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   11
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmprecios_paqueteria.frx":19F2
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmprecios_paqueteria.frx":22CC
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmprecios_paqueteria.frx":2BA6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmprecios_paqueteria.frx":3142
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmprecios_paqueteria.frx":3A1E
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmprecios_paqueteria.frx":42F8
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmprecios_paqueteria.frx":4BD2
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmprecios_paqueteria.frx":4CE4
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmprecios_paqueteria.frx":4DF6
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmprecios_paqueteria.frx":4F08
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmprecios_paqueteria.frx":501A
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmprecios_paqueteria"
...
Private Sub cmd_guardar_Click()
   ...
   Else
      ...
      If IsNumeric(Me.txt_costo) Then
         ...
         Else
            MsgBox "Falta indicar el precio", vbOKOnly, "ATENCION"
         End If
      Else
         MsgBox "Falta indicar el costo", vbOKOnly, "ATENCION"
      End If
   End If
End Sub
...
Private Sub lv_paqueterias_GotFocus()
   If Me.lv_paqueterias.ListItems.Count > 0 Then
      Me.txt_clave.Enabled = False
      Me.txt_caja.Enabled = False
      Me.txt_caja = Me.lv_paqueterias.selectedItem
      Me.txt_nombre_caja = Me.lv_paqueterias.selectedItem.SubItems(1)
