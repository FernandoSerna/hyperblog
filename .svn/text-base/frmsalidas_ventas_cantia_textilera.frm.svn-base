...
Begin VB.Form frmsalidas_ventas_cantia_textilera 
   ...
   Begin VB.CommandButton cmd_cancelar 
      ...
      Height          =   315
      Left            =   1140
      Picture         =   "frmsalidas_ventas_cantia_textilera.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   3
   ...
   Begin VB.CommandButton cmd_nuevo 
      ...
      Height          =   315
      Left            =   150
      Picture         =   "frmsalidas_ventas_cantia_textilera.frx":0102
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   Begin VB.CommandButton cmd_buscar 
      ...
      Height          =   315
      Left            =   480
      Picture         =   "frmsalidas_ventas_cantia_textilera.frx":0204
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin VB.CommandButton cmd_imprimir 
      ...
      Height          =   315
      Left            =   810
      Picture         =   "frmsalidas_ventas_cantia_textilera.frx":0306
      Style           =   1  'Graphical
      TabIndex        =   2
   ...
   Begin VB.CommandButton Command1 
      ...
      Height          =   315
      Left            =   7200
      Picture         =   "frmsalidas_ventas_cantia_textilera.frx":0408
      Style           =   1  'Graphical
      TabIndex        =   4
      ToolTipText     =   "Salir"
      Top             =   630
   ...
   Begin MSComctlLib.ImageList ImageList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_ventas_cantia_textilera.frx":0A42
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_ventas_cantia_textilera.frx":131C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_ventas_cantia_textilera.frx":1BF6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_ventas_cantia_textilera.frx":2192
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_ventas_cantia_textilera.frx":2A6E
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_ventas_cantia_textilera.frx":3348
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_ventas_cantia_textilera.frx":3C22
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_ventas_cantia_textilera.frx":3D34
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_ventas_cantia_textilera.frx":3E46
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_ventas_cantia_textilera.frx":3F58
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_ventas_cantia_textilera.frx":406A
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_ventas_cantia_textilera.frx":417C
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmsalidas_ventas_cantia_textilera"
            ...
            If var_posible_tipo_cambio = True Then
               ...
               If var_si = 1 Then
                  ...
                  If var_posible_cerrar_KANBAN = True Then
                     ...
                     If var_empresa = "06" Or var_empresa = "15" Or var_empresa = "31" Then
...
Private Sub txt_busqueda_folio_KeyPress(KeyAscii As Integer)
   ...
   If KeyAscii = 13 Then
      If Trim(txt_busqueda_folio) <> "" Then
         ...
         End If
         cnn.CommandTimeout = 360
         rs.Open "select * from tb_encabezado_movimientos where inte_emo_numero = " + txt_busqueda_folio + " and vcha_mov_movimiento_id = '" + var_clave_movimiento + "' and vcha_emp_empresa_id = '" + var_empresa + "'", cnn, adOpenDynamic, adLockOptimistic
         If Not rs.EOF Then
            If var_numero_folio > 0 Then
               rsaux2.Open "UPDATE TB_encabezado_MOVIMIENTOS SET INTE_EMO_BLOQUEADO = 0 where inte_emo_numero = " + CStr(var_numero_folio) + " and vcha_mov_movimiento_id = '" + var_clave_movimiento + "'", cnn, adOpenDynamic, adLockOptimistic
            End If
   ...
   If KeyAscii = 13 Then
      If Trim(Me.txt_codigo) <> "" Then
         ...
         If Not rs.EOF Then
            ...
            rsaux1.Open "select * from TB_FACTURAS_CANTIA_TEXTILERA where vcha_emp_Empresa_id = '18' and vcha_car_documento = 'FA' and inte_Car_numero = " + Me.txt_referencia + " and vcha_art_articulo_id = '" + Me.txt_codigo + "'", cnn, adOpenDynamic, adLockOptimistic
            If Not rsaux1.EOF Then
               var_precio = rsaux1!floa_Sal_precio
               rsaux.Open "select * from tb_existencias where vcha_alm_almacen_id = '" + Me.txt_almacen_origen + "' and vcha_Art_articulo_id = '" + Me.txt_codigo + "'", cnn, adOpenDynamic, adLockOptimistic
               If Not rsaux.EOF Then
               ...
               rsaux.Close
               Me.txt_cantidad = ""
               Me.txt_precio = Format(var_precio, "###,###,##0.00")
            ...
            Else
               txt_codigo = ""
               Me.lbl_precio = ""
               frmmensaje.lbl_mensaje = "El artículo no viene en la factura "
               frmmensaje.Show 1
            End If
            rsaux1.Close
         Else
            ...
            If Not rsaux.EOF Then
               ...
               If Not rsaux1.EOF Then
                  ...
                  rsaux2.Open "select * from TB_FACTURAS_CANTIA_TEXTILERA where vcha_emp_Empresa_id = '18' and vcha_car_documento = 'FA' and inte_Car_numero = " + Me.txt_referencia + " and vcha_art_articulo_id = '" + Me.txt_codigo + "'", cnn, adOpenDynamic, adLockOptimistic
                  If Not rsaux2.EOF Then
                     var_precio = rsaux2!floa_Sal_precio
                     rsaux3.Open "select * from tb_existencias where vcha_alm_almacen_id = '" + Me.txt_almacen_origen + "' and vcha_Art_articulo_id = '" + Me.txt_codigo + "'", cnn, adOpenDynamic, adLockOptimistic
                     If Not rsaux3.EOF Then
                        var_costo = IIf(IsNull(rsaux3!FLOA_eXI_COSTO), 0, rsaux3!FLOA_eXI_COSTO)
                     Else
                        var_costo = IIf(IsNull(rsaux1!mone_Art_costo_estandar), 0, rsaux1!mone_Art_costo_estandar)
                     End If
                     rsaux3.Close
                     Me.txt_cantidad = ""
                     Me.txt_precio = Format(var_precio, "###,###,##0.00")
...
Private Sub txt_establecimiento_KeyDown(KeyCode As Integer, Shift As Integer)
   ...
   Else
      If KeyCode = "116" Then
         If parametros(0) = "DISTRIBUCION" Then
            lv_lista.ListItems.Clear
            rs.Open "SELECT * FROM vw_establecimientos WHERE vcha_Cli_clave_id = '" + Me.txt_almacen_destino + "'", cnn, adOpenDynamic, adLockOptimistic
            While Not rs.EOF
                  Set list_item = lv_lista.ListItems.Add(, , rs!vcha_ESB_ESTABLECIMIENTO_id)
            ...
            If var_posible_disponible = True Then
               ...
               'If var_cantidad_disponible >= var_cantidad_leida Then
                  ...
                  If var_posible_leido = 1 Then
                     ...
                     rsaux4.Open "select * from TB_FACTURAS_CANTIA_TEXTILERA where vcha_Art_Articulo_id = '" + txt_codigo + "' and inte_car_numero  = '" + Me.txt_referencia + "'", cnn, adOpenDynamic, adLockOptimistic
                     If Not rsaux4.EOF Then
                        ...
                        End If
                        If var_clave_movimiento = "VDIL" Or var_clave_movimiento = "VDIPM" Then
...
Private Sub txt_nombre_almacen_origen_KeyPress(KeyAscii As Integer)
   If KeyAscii = 13 Then
      If Me.txt_referencia.Enabled = True Then
...
Private Sub txt_referencia_KeyPress(KeyAscii As Integer)
   If KeyAscii = 13 Then
      If IsNumeric(Me.txt_referencia) Then
         rsaux.Open "SELECT * FROM TB_FACTURAS_CANTIA_TEXTILERA WHERE VCHA_EMP_EMPRESA_ID = '18' AND VCHA_CAR_DOCUMENTO = 'FA' AND VCHA_SER_SERIE_ID = 'AA' AND INTE_CAR_NUMERO = " + Me.txt_referencia, cnn, adOpenDynamic, adLockOptimistic
         If Not rsaux.EOF Then
            rsaux1.Open "SELECT * from vw_CLIENTES WHERE VCHA_CLI_CLAVE_ID = '" + rsaux!vcha_cli_clave_id + "'", cnn, adOpenDynamic, adLockOptimistic
            If Not rsaux1.EOF Then
               Me.txt_almacen_destino = rsaux1!vcha_cli_clave_id
               Me.txt_nombre_almacen_destino = IIf(IsNull(rsaux1!VCHA_CLI_NOMBRE), "", rsaux1!VCHA_CLI_NOMBRE)
               Me.txt_descuento = IIf(IsNull(rsaux1!floa_gac_Descuento_1), 0, rsaux1!floa_gac_Descuento_1)
               Me.txt_referencia.Enabled = False
               Me.txt_establecimiento.Enabled = True
               Me.txt_establecimiento.SetFocus
            Else
            ...
            rsaux1.Close
         Else
            var_cadena = "SELECT dbo.TB_ENCABEZADO_PEDIDOS.VCHA_PED_CLIENTE_CANTIA, dbo.TB_ENCABEZADO_PEDIDOS.INTE_PED_PEDIDO_CANTIA, dbo.TB_SALIDAS.VCHA_ART_ARTICULO_ID , dbo.TB_SALIDAS.FLOA_SAL_PRECIO FROM dbo.TB_ENCABEZADO_CARTERA INNER JOIN dbo.TB_ENCABEZADO_MOVIMIENTOS ON dbo.TB_ENCABEZADO_CARTERA.VCHA_EMP_EMPRESA_ID = dbo.TB_ENCABEZADO_MOVIMIENTOS.VCHA_EMP_EMPRESA_ID AND dbo.TB_ENCABEZADO_CARTERA.VCHA_UOR_UNIDAD_ID = dbo.TB_ENCABEZADO_MOVIMIENTOS.VCHA_UOR_UNIDAD_ID AND dbo.TB_ENCABEZADO_CARTERA.VCHA_MOV_MOVIMIENTO_ID = dbo.TB_ENCABEZADO_MOVIMIENTOS.VCHA_MOV_MOVIMIENTO_ID AND dbo.TB_ENCABEZADO_CARTERA.INTE_EMO_NUMERO = dbo.TB_ENCABEZADO_MOVIMIENTOS.INTE_EMO_NUMERO INNER JOIN dbo.TB_ENC_ORDEN_SURTIDO ON "
            If parametros(0) = "DBPRUEBAS" Then
               var_cadena = var_cadena + " dbo.TB_ENCABEZADO_MOVIMIENTOS.INTE_EMO_NUMERO_ORIGEN = dbo.TB_ENC_ORDEN_SURTIDO.INTE_ORS_ORDEN_SURTIDO INNER JOIN dbo.TB_ENCABEZADO_PEDIDOS ON dbo.TB_ENC_ORDEN_SURTIDO.INTE_PED_NUMERO = dbo.TB_ENCABEZADO_PEDIDOS.INTE_PED_NUMERO INNER JOIN dbo.TB_SALIDAS ON dbo.TB_ENCABEZADO_CARTERA.VCHA_EMP_EMPRESA_ID = dbo.TB_SALIDAS.VCHA_EMP_EMPRESA_ID AND dbo.TB_ENCABEZADO_CARTERA.VCHA_SER_SERIE_ID = dbo.TB_SALIDAS.VCHA_SER_SERIE_ID AND dbo.TB_ENCABEZADO_CARTERA.VCHA_CAR_DOCUMENTO = dbo.TB_SALIDAS.VCHA_CAR_DOCUMENTO AND dbo.TB_ENCABEZADO_CARTERA.INTE_CAR_NUMERO = dbo.TB_SALIDAS.INTE_CAR_NUMERO WHERE (dbo.TB_ENCABEZADO_CARTERA.VCHA_EMP_EMPRESA_ID = '18') AND (dbo.TB_ENCABEZADO_CARTERA.VCHA_SER_SERIE_ID = 'AAA') AND (dbo.TB_ENCABEZADO_CARTERA.VCHA_CAR_DOCUMENTO = 'FA') AND (dbo.TB_ENCABEZADO_CARTERA.INTE_CAR_NUMERO = " + Me.txt_referencia + ") AND (dbo.TB_ENCABEZADO_PEDIDOS.INTE_PED_PEDIDO_CANTIA = 1) "
            Else
               var_cadena = var_cadena + " dbo.TB_ENCABEZADO_MOVIMIENTOS.INTE_EMO_NUMERO_ORIGEN = dbo.TB_ENC_ORDEN_SURTIDO.INTE_ORS_ORDEN_SURTIDO INNER JOIN dbo.TB_ENCABEZADO_PEDIDOS ON dbo.TB_ENC_ORDEN_SURTIDO.INTE_PED_NUMERO = dbo.TB_ENCABEZADO_PEDIDOS.INTE_PED_NUMERO INNER JOIN dbo.TB_SALIDAS ON dbo.TB_ENCABEZADO_CARTERA.VCHA_EMP_EMPRESA_ID = dbo.TB_SALIDAS.VCHA_EMP_EMPRESA_ID AND dbo.TB_ENCABEZADO_CARTERA.VCHA_SER_SERIE_ID = dbo.TB_SALIDAS.VCHA_SER_SERIE_ID AND dbo.TB_ENCABEZADO_CARTERA.VCHA_CAR_DOCUMENTO = dbo.TB_SALIDAS.VCHA_CAR_DOCUMENTO AND dbo.TB_ENCABEZADO_CARTERA.INTE_CAR_NUMERO = dbo.TB_SALIDAS.INTE_CAR_NUMERO WHERE (dbo.TB_ENCABEZADO_CARTERA.VCHA_EMP_EMPRESA_ID = '18') AND (dbo.TB_ENCABEZADO_CARTERA.VCHA_SER_SERIE_ID = 'AA') AND (dbo.TB_ENCABEZADO_CARTERA.VCHA_CAR_DOCUMENTO = 'FA') AND (dbo.TB_ENCABEZADO_CARTERA.INTE_CAR_NUMERO = " + Me.txt_referencia + ") AND (dbo.TB_ENCABEZADO_PEDIDOS.INTE_PED_PEDIDO_CANTIA = 1) "
            End If
            rs.Open var_cadena, cnn_pedido_cantia_textilera, adOpenDynamic, adLockOptimistic
            If Not rs.EOF Then
               While Not rs.EOF
                     var_cadena = "INSERT INTO TB_FACTURAS_CANTIA_TEXTILERA (VCHA_EMP_EMPRESA_ID, VCHA_CAR_DOCUMENTO, VCHA_SER_SERIE_ID, INTE_CAR_NUMERO, VCHA_CLI_CLAVE_ID, VCHA_ART_ARTICULO_ID, FLOA_SAL_PRECIO) "
                     var_cadena = var_cadena + " VALUES ('18','FA','AA'," + Me.txt_referencia + ",'" + rs!VCHA_PED_CLIENTE_CANTIA + "', '" + rs!vcha_Art_articulo_id + "', " + CStr(rs!floa_Sal_precio) + ")"
                     rsaux1.Open var_cadena, cnn, adOpenDynamic, adLockOptimistic
                     rs.MoveNext
               Wend
               rs.MoveFirst
               rsaux1.Open "SELECT * from vw_CLIENTES WHERE VCHA_CLI_CLAVE_ID = '" + rs!VCHA_PED_CLIENTE_CANTIA + "'", cnn, adOpenDynamic, adLockOptimistic
               If Not rsaux1.EOF Then
                  Me.txt_almacen_destino = rsaux1!vcha_cli_clave_id
                  Me.txt_nombre_almacen_destino = IIf(IsNull(rsaux1!VCHA_CLI_NOMBRE), "", rsaux1!VCHA_CLI_NOMBRE)
                  Me.txt_descuento = IIf(IsNull(rsaux1!floa_gac_Descuento_1), 0, rsaux1!floa_gac_Descuento_1)
