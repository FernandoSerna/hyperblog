...
Begin VB.Form frmreporte_movimientos 
   ...
   Begin VB.Frame cmb_filtro 
      ...
      Begin VB.ComboBox cmb_filtrar_por 
         Height          =   315
         ItemData        =   "frmreporte_movimientos.frx":0000
         Left            =   945
         List            =   "frmreporte_movimientos.frx":0040
         Sorted          =   -1  'True
         TabIndex        =   46
         Top             =   2115
         Width           =   4725
      ...
      Begin VB.CommandButton Command15 
         ...
         Height          =   315
         Left            =   60
         Picture         =   "frmreporte_movimientos.frx":0155
         Style           =   1  'Graphical
         TabIndex        =   42
         ToolTipText     =   "Aceptar"
         Top             =   405
      ...
      Begin VB.CommandButton Command14 
         ...
         Height          =   315
         Left            =   390
         Picture         =   "frmreporte_movimientos.frx":0687
         Style           =   1  'Graphical
         TabIndex        =   41
   ...
   Begin VB.CommandButton cmd_salir 
      ...
      Height          =   315
      Left            =   11220
      Picture         =   "frmreporte_movimientos.frx":0BB9
      Style           =   1  'Graphical
      TabIndex        =   31
      ToolTipText     =   "Salir"
      Top             =   15
   ...
   Begin VB.CommandButton cmd_imprimir 
      ...
      Height          =   315
      Left            =   450
      Picture         =   "frmreporte_movimientos.frx":11F3
      Style           =   1  'Graphical
      TabIndex        =   30
   ...
   Begin VB.CommandButton cmd_nuevo 
      ...
      Height          =   315
      Left            =   120
      Picture         =   "frmreporte_movimientos.frx":12F5
      Style           =   1  'Graphical
      TabIndex        =   29
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton Command12 
         ...
         Height          =   315
         Left            =   5115
         Picture         =   "frmreporte_movimientos.frx":13F7
         Style           =   1  'Graphical
         TabIndex        =   36
      ...
      Begin VB.CommandButton Command11 
         ...
         Height          =   315
         Left            =   2355
         Picture         =   "frmreporte_movimientos.frx":2669
         Style           =   1  'Graphical
         TabIndex        =   35
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton Command13 
         ...
         Height          =   315
         Left            =   1785
         Picture         =   "frmreporte_movimientos.frx":38DB
         Style           =   1  'Graphical
         TabIndex        =   37
      ...
      Begin VB.CommandButton Command10 
         ...
         Height          =   315
         Left            =   465
         Picture         =   "frmreporte_movimientos.frx":39D5
         Style           =   1  'Graphical
         TabIndex        =   20
      ...
      Begin VB.CommandButton Command9 
         Height          =   315
         Left            =   135
         Picture         =   "frmreporte_movimientos.frx":3BEB
         Style           =   1  'Graphical
         TabIndex        =   19
      ...
      Begin VB.CommandButton Command8 
         ...
         Height          =   315
         Left            =   1125
         Picture         =   "frmreporte_movimientos.frx":3CED
         Style           =   1  'Graphical
         TabIndex        =   18
         ToolTipText     =   "Invertir Selección Alt + V"
         Top             =   225
      ...
      Begin VB.CommandButton Command7 
         ...
         Height          =   315
         Left            =   795
         Picture         =   "frmreporte_movimientos.frx":3DBF
         Style           =   1  'Graphical
         TabIndex        =   17
      ...
      Begin VB.CommandButton Command6 
         ...
         Height          =   315
         Left            =   1455
         Picture         =   "frmreporte_movimientos.frx":4009
         Style           =   1  'Graphical
         TabIndex        =   16
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Command5 
         ...
         Height          =   315
         Left            =   435
         Picture         =   "frmreporte_movimientos.frx":421F
         Style           =   1  'Graphical
         TabIndex        =   15
         ToolTipText     =   "Marcar Todos Alt + T"
         Top             =   210
      ...
      Begin VB.CommandButton Command4 
         Height          =   315
         Left            =   105
         Picture         =   "frmreporte_movimientos.frx":4435
         Style           =   1  'Graphical
         TabIndex        =   14
         ToolTipText     =   "Desmarcar Todos Alt + D"
         Top             =   210
      ...
      Begin VB.CommandButton Command3 
         ...
         Height          =   315
         Left            =   1110
         Picture         =   "frmreporte_movimientos.frx":4537
         Style           =   1  'Graphical
         TabIndex        =   13
         ToolTipText     =   "Invertir Selección Alt + V"
         Top             =   210
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   315
         Left            =   765
         Picture         =   "frmreporte_movimientos.frx":4609
         Style           =   1  'Graphical
         TabIndex        =   12
         ToolTipText     =   "Marcar (Enter)"
         Top             =   210
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   315
         Left            =   1425
         Picture         =   "frmreporte_movimientos.frx":4853
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "Marcar Rango Alt + R"
         Top             =   210
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmd_todos 
         ...
         Height          =   315
         Left            =   450
         Picture         =   "frmreporte_movimientos.frx":4A69
         Style           =   1  'Graphical
         TabIndex        =   10
         ToolTipText     =   "Marcar Todos Alt + T"
         Top             =   225
      ...
      Begin VB.CommandButton cmd_ninguno 
         Height          =   315
         Left            =   120
         Picture         =   "frmreporte_movimientos.frx":4C7F
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Desmarcar Todos Alt + D"
         Top             =   225
      ...
      Begin VB.CommandButton cmd_invertir 
         ...
         Height          =   315
         Left            =   1125
         Picture         =   "frmreporte_movimientos.frx":4D81
         Style           =   1  'Graphical
         TabIndex        =   8
         ToolTipText     =   "Invertir Selección Alt + V"
         Top             =   225
      ...
      Begin VB.CommandButton cmd_marcar 
         ...
         Height          =   315
         Left            =   795
         Picture         =   "frmreporte_movimientos.frx":4E53
         Style           =   1  'Graphical
         TabIndex        =   7
         ToolTipText     =   "Marcar (Enter)"
         Top             =   225
      ...
      Begin VB.CommandButton cmd_seleccion 
         ...
         Height          =   315
         Left            =   1440
         Picture         =   "frmreporte_movimientos.frx":509D
         Style           =   1  'Graphical
         TabIndex        =   6
         ToolTipText     =   "Marcar Rango Alt + R"
         Top             =   225
   ...
   End
End
Attribute VB_Name = "frmreporte_movimientos"
   ...
   If var_contador_almacenes > 0 Then
      If var_contador_movimientos > 0 Then
         If lv_articulos.ListItems.Count > 0 Or Me.opt_todos = True Then
            ...
            Set reporte = appl.OpenReport(App.Path + "\rep_reporte_movimientos.rpt")
            reporte.RecordSelectionFormula = "{VW_REPORTE_MOVIMIENTOS.VCHA_RMO_MAQUINA} = '" + fun_NombrePc + "' AND {VW_REPORTE_MOVIMIENTOS.VCHA_RMO_USUARIO} = '" + var_clave_usuario_global + "' AND {VW_REPORTE_MOVIMIENTOS.INTE_RMO_NUMERO} = " + Str(var_consecutivo)
            ...
            If var_si = 6 Then
               Set reporte = appl.OpenReport(App.Path + "\rep_reporte_movimientos_2.rpt")
               reporte.RecordSelectionFormula = "{VW_REPORTE_MOVIMIENTOS.VCHA_RMO_MAQUINA} = '" + fun_NombrePc + "' AND {VW_REPORTE_MOVIMIENTOS.VCHA_RMO_USUARIO} = '" + var_clave_usuario_global + "' AND {VW_REPORTE_MOVIMIENTOS.INTE_RMO_NUMERO} = " + Str(var_consecutivo)
               For ntablas = 1 To reporte.Database.Tables.Count
                   reporte.Database.Tables(ntablas).SetLogOnInfo parametros(6), var_bd_reportes, parametros(4), parametros(5)
               Next ntablas
...
Private Sub Form_Unload(Cancel As Integer)
   ...
   rs.Open "delete from tb_temp_rep_mov_articulos where inte_rmo_numero = " + Str(numero_control) + " and vcha_rmo_maquina = '" + fun_NombrePc + "' and vcha_rmo_usuario = '" + var_clave_usuario_global + "'", cnn, adOpenDynamic, adLockOptimistic
   Call activa_forma(var_activa_forma_reporte_movimientos)
End Sub
