...
Begin VB.Form frmreporte_antiguedad_saldos_historico_filtro 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Antigüedad de saldos historico con filtro"
   ClientHeight    =   4800
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5805
   ...
   Begin VB.CommandButton cmd_salir 
      ...
      Height          =   315
      Left            =   5355
      Picture         =   "frmreporte_antiguedad_saldos_historico_filtro.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   13
      ToolTipText     =   "Salir"
      Top             =   15
   ...
   Begin VB.CommandButton cmd_imprimir 
      ...
      Height          =   315
      Left            =   90
      Picture         =   "frmreporte_antiguedad_saldos_historico_filtro.frx":063A
      Style           =   1  'Graphical
      TabIndex        =   12
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton cmd_todos 
         ...
         Height          =   315
         Left            =   450
         Picture         =   "frmreporte_antiguedad_saldos_historico_filtro.frx":073C
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton cmd_ninguno 
         Height          =   315
         Left            =   120
         Picture         =   "frmreporte_antiguedad_saldos_historico_filtro.frx":0952
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton cmd_invertir 
         ...
         Height          =   315
         Left            =   1110
         Picture         =   "frmreporte_antiguedad_saldos_historico_filtro.frx":0A54
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton cmd_marcar 
         ...
         Height          =   315
         Left            =   780
         Picture         =   "frmreporte_antiguedad_saldos_historico_filtro.frx":0B26
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton cmd_seleccion 
         ...
         Height          =   315
         Left            =   1440
         Picture         =   "frmreporte_antiguedad_saldos_historico_filtro.frx":0D70
         Style           =   1  'Graphical
         TabIndex        =   4
   ...
   End
End
Attribute VB_Name = "frmreporte_antiguedad_saldos_historico_filtro"
...
Private Sub cmd_imprimir_Click()
   ...
   If IsDate(Me.txt_fecha) Then
      If IsNumeric(Me.txt_dias) Then
         var_Dias_filtro = " and {VW_ANTIGUEDAD_SALDOS_historico.inte_tem_diferencia} >= " + Me.txt_dias
      Else
         var_Dias_filtro = ""
      End If
      var_contador = 0
      ...
      If IsNumeric(Me.txt_porcentaje) Then
         var_POrcentaje_filtro = " and {@porcentaje} >= " + Me.txt_porcentaje
      Else
         var_POrcentaje_filtro = ""
      End If
      
      'MsgBox "{VW_ANTIGUEDAD_SALDOS_historico.inte_tem_consecutivo}= " + CStr(var_consecutivo) + " and {VW_ANTIGUEDAD_SALDOS_HISTORICO.VCHA_EMP_EMPRESA_ID} = '" + var_empresa + "' and  " + var_cadena + var_Dias_filtro + var_POrcentaje_filtro
   ...
   'se crea
      ...
      'MsgBox "{VW_ANTIGUEDAD_SALDOS_historico.inte_tem_consecutivo}= " + CStr(var_consecutivo) + "' and {VW_ANTIGUEDAD_SALDOS_HISTORICO.VCHA_EMP_EMPRESA_ID} = '" + var_empresa + "' and  " + var_cadena + var_Dias_filtro + var_POrcentaje_filtro + ")"
      reporte.RecordSelectionFormula = "{VW_ANTIGUEDAD_SALDOS_historico.inte_tem_consecutivo}= " + CStr(var_consecutivo) + " and {VW_ANTIGUEDAD_SALDOS_HISTORICO.VCHA_EMP_EMPRESA_ID} = '" + var_empresa + "' and  " + var_cadena + ")" + var_Dias_filtro + var_POrcentaje_filtro
      'reporte.RecordSelectionFormula = "{VW_ANTIGUEDAD_SALDOS_historico.inte_tem_consecutivo}= '" + CStr(var_consecutivo) + "' and {VW_ANTIGUEDAD_SALDOS_HISTORICO.VCHA_EMP_EMPRESA_ID} = '" + var_empresa + "' and  " + var_cadena + var_Dias_filtro + ")"
      'reporte.RecordSelectionFormula = "{VW_ANTIGUEDAD_SALDOS_historico.inte_tem_consecutivo}= '" + CStr(var_consecutivo) + "' and {VW_ANTIGUEDAD_SALDOS_historico.VCHA_EMP_EMPRESA_ID} = '" + var_empresa + "'" + var_Dias_filtro
         ...
         If var_si = 6 Then
            For var_i = 1 To lv_agentes.ListItems.Count
                ...
                If lv_agentes.selectedItem.SubItems(2) = "*" Then
                   ...
                   dl = SQLConfigDataSource(vbAPINull, ODBC_ADD_SYS_DSN, sDriver, sAttributes)
                   Set reporte = appl.OpenReport(App.Path + "\rep_antiguedad_saldos_historico.rpt")
                   reporte.RecordSelectionFormula = "{VW_ANTIGUEDAD_SALDOS_historico.inte_tem_consecutivo}=" + CStr(var_consecutivo) + " and {VW_ANTIGUEDAD_SALDOS_historico.VCHA_EMP_EMPRESA_ID} = '" + var_empresa + "' and  {VW_ANTIGUEDAD_SALDOS_historico.VCHA_AGE_AGENTE_ID} = '" + Me.lv_agentes.selectedItem + "' and  " + var_cadena + ")" + var_Dias_filtro + var_POrcentaje_filtro
                   For ntablas = 1 To reporte.Database.Tables.Count
                      reporte.Database.Tables(ntablas).SetLogOnInfo parametros(6), var_bd_reportes, parametros(4), parametros(5)
                   Next ntablas
   ...
   'se crea
      ...
      x = 0
      If x = 1 Then
      var_si = MsgBox("¿Desea generar el resumen de antigüedad de saldos?", vbYesNo, "ATENCION")
      If var_si = 6 Then
