...
Begin VB.Form frmsalidas_kanban 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Salidas Requiere Kanban"
   ClientHeight    =   7365
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   11640
   ...
   Begin VB.CommandButton cmd_resumen 
      ...
      Height          =   315
      Left            =   1350
      Picture         =   "frmsalidas_kanban.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   37
   ...
   Begin VB.CommandButton Command1 
      ...
      Height          =   315
      Left            =   11130
      Picture         =   "frmsalidas_kanban.frx":0102
      Style           =   1  'Graphical
      TabIndex        =   27
      ToolTipText     =   "Salir"
      Top             =   630
   ...
   Begin VB.CommandButton cmd_imprimir 
      ...
      Height          =   315
      Left            =   705
      Picture         =   "frmsalidas_kanban.frx":073C
      Style           =   1  'Graphical
      TabIndex        =   26
   ...
   Begin VB.CommandButton cmd_buscar 
      ...
      Height          =   315
      Left            =   360
      Picture         =   "frmsalidas_kanban.frx":083E
      Style           =   1  'Graphical
      TabIndex        =   25
   ...
   Begin VB.CommandButton cmd_nuevo 
      ...
      Height          =   315
      Left            =   30
      Picture         =   "frmsalidas_kanban.frx":0940
      Style           =   1  'Graphical
      TabIndex        =   24
   ...
   Begin VB.CommandButton cmd_cerrar_embarque 
      ...
      Height          =   315
      Left            =   690
      Picture         =   "frmsalidas_kanban.frx":0A42
      Style           =   1  'Graphical
      TabIndex        =   23
   ...
   Begin VB.CommandButton cmd_cancelar 
      ...
      Height          =   315
      Left            =   1020
      Picture         =   "frmsalidas_kanban.frx":0B44
      Style           =   1  'Graphical
      TabIndex        =   22
   ...
   Begin VB.Frame frm_sellos 
      ...
      Begin VB.CommandButton cmd_cancelar_sello 
         ...
         Height          =   315
         Left            =   375
         Picture         =   "frmsalidas_kanban.frx":0C46
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      Begin VB.CommandButton cmd_aceptar_sello 
         ...
         Height          =   315
         Left            =   45
         Picture         =   "frmsalidas_kanban.frx":0D90
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      Begin VB.CommandButton cmd_cerrar 
         ...
         Height          =   315
         Left            =   705
         Picture         =   "frmsalidas_kanban.frx":0EDA
         Style           =   1  'Graphical
         TabIndex        =   7
   ...
   Begin MSComctlLib.ImageList ImageList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_kanban.frx":0FDC
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_kanban.frx":18B6
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_kanban.frx":2190
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_kanban.frx":272C
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_kanban.frx":3008
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_kanban.frx":38E2
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_kanban.frx":41BC
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_kanban.frx":42CE
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_kanban.frx":43E0
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_kanban.frx":44F2
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_kanban.frx":4604
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_kanban.frx":4716
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_kanban.frx":4828
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_kanban.frx":49CA
            Key             =   ""
         EndProperty
         BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_kanban.frx":581C
            Key             =   ""
         EndProperty
         BeginProperty ListImage16 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_kanban.frx":59F2
            Key             =   ""
         EndProperty
         BeginProperty ListImage17 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_kanban.frx":5B04
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton cmd_pasar_movimiento 
         Height          =   330
         Left            =   8880
         Picture         =   "frmsalidas_kanban.frx":5C16
         Style           =   1  'Graphical
         TabIndex        =   77
         Top             =   540
         Visible         =   0   'False
   ...
   End
End
Attribute VB_Name = "frmsalidas_kanban"
   ...
   If Not rsaux4.EOF Then
      ...
      If Trim(txt_folio) <> "" Then
         ...
         If var_posible = True Then
            rs.Open "select * from tb_detalle_cajas where vcha_emp_empresa_id = '" + var_empresa + "' and vcha_uor_unidad_id = '" + var_unidad_organizacional + "' and vcha_paq_movimiento_destino = '" + var_clave_movimiento + "' and inte_paq_numero_destino = " + txt_busqueda_folio, cnn, adOpenDynamic, adLockOptimistic
            If Not rs.EOF Then
               var_cajas = True
            Else
               var_cajas = False
...
'''' nuevo metodo
                        ...
                        If var_estatus_movimiento = "I" Then
                           ...
                           For var_i = 1 To lv_salidas.ListItems.Count
                              ...
                              End If
                           Next var_i
                           rsaux.Open "select * from tb_temporal_salidas where vcha_emp_empresa_id = '" + var_empresa + "' and vcha_uor_unidad_id ='" + var_unidad_organizacional + "' and vcha_alm_almacen_id = '" + var_almacen_origen + "' and vcha_mov_movimiento_id = '" + var_clave_movimiento + "' and inte_sal_numero = " + Str(var_numero_folio), cnn, adOpenDynamic, adLockOptimistic
                           While Not rsaux.EOF
         ...
         If Trim(txt_cantidad_eliminar) <> "" Then
            ...
            If var_es_caja = True Then
               ...
               If var_posible_caja = True Then
                  ...
                  rsaux3.Open "select * from tb_detalle_cajas where vcha_emp_empresa_id = '" + var_empresa + "' and vcha_uor_unidad_id = '" + var_unidad_organizacional + "' and INTE_EMB_EMBARQUE = " + CStr(var_numero_embarque) + " and inte_paq_caja = " + Str(var_embarque_caja), cnn, adOpenDynamic, adLockOptimistic
...
Private Sub txt_codigo_KeyPress(KeyAscii As Integer)
   ...
   Dim var_posible_kanban As Boolean
   ...
   If KeyAscii = 13 Then
      ...
      If Len(Trim(txt_codigo)) = 12 Then
         If Mid(Me.txt_codigo, 1, 1) = "K" Then
            rsaux.Open "SELECT * FROM TB_TARJETAS_KANBAN WHERE VCHA_KAN_KANBAN_ID = '" + Me.txt_codigo + "'", cnn, adOpenDynamic, adLockOptimistic
            If Not rsaux.EOF Then
               var_posible_kanban = True
               var_tarjeta_kanban = Me.txt_codigo
               Me.txt_codigo = rsaux!VCHA_aRT_ARTICULO_ID
            Else
               var_posible_kanban = False
               var_tarjeta_kanban = ""
            End If
            rsaux.Close
         Else
      ...
      If var_verificador = True Then
         If var_posible_kanban = True Then
            var_es_caja = False
            If Trim(txt_codigo) <> "" Then
               ...
               Else
                  ...
                  If Not rs.EOF Then
                     ...
                     End If
                     rs.Close
                     var_requiere_kanban = IIf(IsNull(rs!inte_art_requiere_kanban), 0, rs!inte_art_requiere_kanban)
                     If var_requiere_kanban = 1 Then
                        var_recontable = 0
                     End If
...
Sub ejecuta()
   ...
   If Not rs.EOF Then
      ...
      rs.Open "select * from tb_detalle_cajas where inte_ors_orden_surtido = " + txt_archivo + " and vcha_emp_empresa_id = '" + var_empresa + "' and vcha_uor_unidad_id = '" + var_unidad_organizacional + "' and char_paq_estatus <> 'S'", cnn, adOpenDynamic, adLockOptimistic
      If Not rs.EOF Then
