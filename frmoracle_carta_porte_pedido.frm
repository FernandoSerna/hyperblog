...
Begin VB.Form frmoracle_carta_porte_pedido 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Carta porte pedido"
   ClientHeight    =   6675
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   10590
   ...
   Begin VB.CommandButton cmd_nuevo 
      ...
      Height          =   315
      Left            =   120
      Picture         =   "frmoracle_carta_porte_pedido.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   51
   ...
   Begin VB.CommandButton cmd_imprimir 
      ...
      Height          =   315
      Left            =   840
      Picture         =   "frmoracle_carta_porte_pedido.frx":0102
      Style           =   1  'Graphical
      TabIndex        =   6
   ...
   Begin VB.CommandButton cmd_salir 
      ...
      Height          =   315
      Left            =   10080
      Picture         =   "frmoracle_carta_porte_pedido.frx":0204
      Style           =   1  'Graphical
      TabIndex        =   2
      ToolTipText     =   "Salir"
      Top             =   0
   ...
   Begin VB.CommandButton com_guardar 
      ...
      Height          =   315
      Left            =   480
      Picture         =   "frmoracle_carta_porte_pedido.frx":083E
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   0
      Width           =   330
   ...
   End
End
Attribute VB_Name = "frmoracle_carta_porte_pedido"
      ...
      If IsNumeric(Me.txt_pedido) Then
         'If CDbl(Me.txt_de) <= CDbl(Me.txt_a) Then
            If Me.txt_embarque <> "" Then
               ...
               var_cadena = var_cadena + " AND oh.header_id = ol.header_id  AND oL.header_id = oLh.header_id(+) AND OL.LINE_ID = OLH.LINE_ID(+) and  NVL(ol.shipped_quantity,0) > 0"
               ...
               If var_posible_embarque = 1 Then
                  ...
                  Else
                     var_tipo = 4
                  End If
                  var_cadena = "CALL XXVIA_SP_TIMBRAR_TRASPASOS_10(?,?,?,?)"
                  With comandoORA
                  ...
                  var_cadena = "select customer_trx_id, cadena  as cadena, numero from xxvia_tb_control_doc_fiscales where serie = 'CPPV2" + Me.txt_embarque + "' and numero = " + CStr(Me.txt_pedido)
                  rsaux1.Open "select customer_trx_id, cadena  as cadena, numero from xxvia_tb_control_doc_fiscales where serie = 'CPPV2" + Me.txt_embarque + "_' and numero = " + CStr(Me.txt_pedido), cnnoracle_4, adOpenDynamic, adLockOptimistic
                  var_cadena = Replace(Replace(rsaux1!Cadena, "T23:", "T00:"), "AUTORIZADO  ", "AUTORIZADO ")
                  var_cadena_rfc = Mid(var_cadena, 34, 12)
                  VAR_CADENA_STR = ""
                  Open ("C:\SISTEMAS\CPPV2" + Trim(Me.txt_embarque) + "_" + Trim(Str(Me.txt_pedido)) + ".FAC") For Output As #1
                  ...
                  var_archivo = "C:\SISTEMAS\sube_fact_" + Trim("CPPV2" + Me.txt_embarque) + "_" + Trim(Str(txt_pedido)) + ".bat"
                  ...
                  x = Shell("c:\sistemas\facturar " + """" + "facturar|C:\SISTEMAS\|C:\SISTEMAS\CPPV2" + Trim(Me.txt_embarque) + "_" + Me.txt_pedido + ".FAC" + "|https://facturas2.vianney.mx/cgi-bin/cfds/timbrarGR33|cfdsvianney|9y3jv^TI;4g#|1" + """", vbHide)
               Else
   ...
   If KeyAscii = 13 Then
      If IsNumeric(Me.txt_pedido) Then
         If Me.txt_embarque <> "" Then
            ...
            Set parametro = Nothing
            If Not rs.EOF Then
               If CDbl(Me.txt_embarque) = CDbl(Me.txt_embarque) Then
