...
Begin VB.Form frmcarta_porte_MTY 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Carta porte Monterrey"
   ClientHeight    =   6765
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   10590
   ...
   Begin VB.CommandButton cmd_imprimir 
      ...
      Height          =   315
      Left            =   480
      Picture         =   "frmcarta_porte_MTY.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   6
   ...
   Begin VB.CommandButton cmd_salir 
      ...
      Height          =   315
      Left            =   10080
      Picture         =   "frmcarta_porte_MTY.frx":0102
      Style           =   1  'Graphical
      TabIndex        =   2
      ToolTipText     =   "Salir"
      Top             =   0
   ...
   Begin VB.CommandButton com_guardar 
      ...
      Height          =   315
      Left            =   150
      Picture         =   "frmcarta_porte_MTY.frx":073C
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   0
      Width           =   330
   ...
   End
End
Attribute VB_Name = "frmcarta_porte_MTY"
      ...
      If IsNumeric(Me.txt_pedido) Then
         'If CDbl(Me.txt_de) <= CDbl(Me.txt_a) Then
            If Me.txt_embarque <> "" Then
               ...
               var_chofer = ""
               If Not rsaux.EOF Then
                  var_chofer = IIf(IsNull(rsaux!CHOFER_MTY), "", rsaux!CHOFER_MTY)
               Else
                  var_chofer = ""
               End If
               If var_chofer = "" Then
               ...
               var_transporte = ""
               If Not rsaux.EOF Then
                  var_transporte = IIf(IsNull(rsaux!transporte_MTY), "", rsaux!transporte_MTY)
               Else
                  var_transporte = ""
               End If
               ...
               If var_posible_embarque = 1 Then
                  ...
                  Else
                     var_tipo = 4
                  End If
                  var_cadena = "CALL XXVIA_SP_TIMBRAR_TRASPASOS_9P(?,?,?,?)"
                  With comandoORA
                  ...
                  var_cadena = "select customer_trx_id, cadena  as cadena, numero from xxvia_tb_control_doc_fiscales where serie = 'CPMTY" + Me.txt_embarque + "' and numero = " + CStr(Me.txt_pedido)
                  rsaux1.Open "select customer_trx_id, cadena  as cadena, numero from xxvia_tb_control_doc_fiscales where serie = 'CPMTY" + Me.txt_embarque + "_' and numero = " + CStr(Me.txt_pedido), cnnoracle_4, adOpenDynamic, adLockOptimistic
                  ...
                  x = Shell("c:\sistemas\facturar " + """" + "facturar|C:\SISTEMAS\|C:\SISTEMAS\CPCDMX" + Trim(Me.txt_embarque) + "_" + Me.txt_pedido + ".FAC" + "|https://facturas2.vianney.mx/cgi-bin/cfds/timbrarGR40|cfdsvianney|9y3jv^TI;4g#|1" + """", vbHide)
         ...
         If Me.txt_chofer <> "" Then
            If Me.txt_unidad <> "" Then
               If rsaux1.State = 1 Then
                  rsaux1.Close
               End If
               rsaux1.Open "UPDATE XXVIA_TB_ENCABEZADO_EMBARQUES SET CHOFER_MTY = '" + Me.txt_chofer + "', TRANSPORTE_MTY = '" + Me.txt_unidad + "' WHERE EMBARQUE = " + Me.txt_embarque, cnnoracle_4, adOpenDynamic, adLockOptimistic
            Else
...
Private Sub txt_embarque_KeyPress(KeyAscii As Integer)
   If KeyAscii = 13 Then
      If IsNumeric(Me.txt_embarque) Then
         rs.Open "select * from xxvia_Tb_encabezado_embarques where embarque = " + Me.txt_embarque, cnnoracle_4, adOpenDynamic, adLockOptimistic
         If Not rs.EOF Then
            var_chofer = IIf(IsNull(rs!CHOFER_MTY), "", rs!CHOFER_MTY)
            If var_chofer <> "" Then
               If rsaux.State = 1 Then
                  rsaux.Close
               End If
            ...
            End If
            var_transporte = IIf(IsNull(rs!transporte_MTY), "", rs!transporte_MTY)
            If var_transporte <> "" Then
