            ...
            If var_numero_folio > 0 Then
               ...
               Else
                  ...
                  If var_si = 1 Then
                     ...
                     var_si = MsgBox("¿El agente especifico a donde aplicar la nota de crédito?", vbYesNo, "ATENCION")
                     If var_si = 6 Then
                        Call Command3_Click
                     Else
            ...
            If var_si = 6 Then
                ...
                If var_si = 6 Then
                   ...
                   If Trim(txt_clase) <> "" Then
                      ...
                      var_cadena_fecha = CStr(var_año_str) + "-" + CStr(var_mes) + "-" + CStr(var_dia) + "T" + CStr(var_hora) + ":" + CStr(var_minuto) + ":" + CStr(var_segundo)
                      ...
                      MsgBox "Se a terminado el proceso, nota de crédito " + CStr(var_numero_nota), vbOKOnly, "ATENCION"
