...
Begin VB.Form frmsalidas_proveedor 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Salidas para proveedor"
   ClientHeight    =   7365
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7695
   ...
   Begin VB.CommandButton cmd_salir 
      ...
      Height          =   315
      Left            =   7170
      Picture         =   "frmsalidas_proveedor.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   12
      ToolTipText     =   "Salir"
      Top             =   735
   ...
   Begin VB.CommandButton cmd_cancelar 
      ...
      Height          =   315
      Left            =   1065
      Picture         =   "frmsalidas_proveedor.frx":063A
      Style           =   1  'Graphical
      TabIndex        =   11
   ...
   Begin VB.CommandButton cmd_imprimir 
      ...
      Height          =   315
      Left            =   735
      Picture         =   "frmsalidas_proveedor.frx":073C
      Style           =   1  'Graphical
      TabIndex        =   10
   ...
   Begin VB.CommandButton cmd_buscar 
      ...
      Height          =   315
      Left            =   405
      Picture         =   "frmsalidas_proveedor.frx":083E
      Style           =   1  'Graphical
      TabIndex        =   9
   ...
   Begin VB.CommandButton cmd_nuevo 
      ...
      Height          =   315
      Left            =   75
      Picture         =   "frmsalidas_proveedor.frx":0940
      Style           =   1  'Graphical
      TabIndex        =   8
   ...
   Begin MSComctlLib.ImageList ImageList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_proveedor.frx":0A42
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_proveedor.frx":131C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_proveedor.frx":1BF6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_proveedor.frx":2192
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_proveedor.frx":2A6E
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_proveedor.frx":3348
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_proveedor.frx":3C22
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_proveedor.frx":3D34
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_proveedor.frx":3E46
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_proveedor.frx":3F58
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_proveedor.frx":406A
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_proveedor.frx":417C
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmsalidas_proveedor"
   ...
   If KeyAscii = 13 Then
      If Len(Trim(txt_proveedor)) > 0 Then
         ...
         If Not rs.EOF Then
            ...
            txt_proveedor.Enabled = False
         Else
            MsgBox "Clave de proveedor incorrecto", vbOKOnly, "ATENCION"
         End If
         rs.Close
      Else
