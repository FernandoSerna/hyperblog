...
Begin VB.Form frmreporte_ventas_netas_cliente 
   Caption         =   "Reporte de ventas Netas por Cliente"
   ClientHeight    =   7305
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5850
   ...
   Begin VB.CommandButton cmd_salir 
      ...
      Height          =   315
      Left            =   5385
      Picture         =   "frmreporte_ventas_netas_cliente.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   15
      ToolTipText     =   "Salir"
      Top             =   15
   ...
   Begin VB.CommandButton cmd_imprimir 
      ...
      Height          =   315
      Left            =   120
      Picture         =   "frmreporte_ventas_netas_cliente.frx":063A
      Style           =   1  'Graphical
      TabIndex        =   14
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton cmd_todos 
         ...
         Height          =   315
         Left            =   450
         Picture         =   "frmreporte_ventas_netas_cliente.frx":094C
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      Begin VB.CommandButton cmd_ninguno 
         Height          =   315
         Left            =   120
         Picture         =   "frmreporte_ventas_netas_cliente.frx":0B62
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton cmd_invertir 
         ...
         Height          =   315
         Left            =   1110
         Picture         =   "frmreporte_ventas_netas_cliente.frx":0C64
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton cmd_marcar 
         ...
         Height          =   315
         Left            =   780
         Picture         =   "frmreporte_ventas_netas_cliente.frx":0D36
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton cmd_seleccion 
         ...
         Height          =   315
         Left            =   1440
         Picture         =   "frmreporte_ventas_netas_cliente.frx":0F80
         Style           =   1  'Graphical
         TabIndex        =   5
   ...
   End
End
Attribute VB_Name = "frmreporte_ventas_netas_cliente"
   ...
   If IsNumeric(txt_año) Then
      ...
      If Me.chk_comparativo = 1 Then
             ...
             lv_clientes.ListItems.Item(var_i).Selected = True
                If lv_clientes.selectedItem.SubItems(2) = "*" Then
                   ...
                   If Len(Trim(var_cadena)) = 0 Then
                      var_cadena = var_cadena + "{VW_REPORTE_VENTAS_NETAS_TITULAR.VCHA_TIT_TITULAR_ID} = '" + lv_clientes.selectedItem + "'"
                   Else
                      var_cadena = var_cadena + " or {VW_REPORTE_VENTAS_NETAS_TITULAR.VCHA_TIT_TITULAR_ID} = '" + lv_clientes.selectedItem + "'"
                   End If
                   If Len(Trim(var_cadena_2)) = 0 Then
                      var_cadena_2 = var_cadena_2 + " {VW_REPORTE_VENTAS_NETAS_TITULAR.VCHA_TIT_TITULAR_ID} = '" + lv_clientes.selectedItem + "'"
                   Else
                      var_cadena_2 = var_cadena_2 + " or {VW_REPORTE_VENTAS_NETAS_TITULAR.VCHA_TIT_TITULAR_ID} = '" + lv_clientes.selectedItem + "'"
                   End If
                End If
         Next var_i
         If var_contador > 0 Then
            ...
            var_n = Me.lv_clientes.ListItems.Count
            For var_i = 1 To var_n
                lv_clientes.ListItems.Item(var_i).Selected = True
                If lv_clientes.selectedItem.SubItems(2) = "*" Then
                   rs.Open "insert into TB_TEMP_REPORTE_VENTAS_NETAS_titulares (inte_tem_consecutivo, vcha_tit_titular_id) values (" + CStr(var_consecutivo) + ",'" + lv_clientes.selectedItem + "')", cnn, adOpenDynamic, adLockOptimistic
                End If
            Next var_i
...
'   numero_items_ALMACENES = 0
'   While Not rs.EOF
'      Set list_item = lv_clientes.ListItems.Add(, , rs!vcha_tit_titular_id)
'      list_item.SubItems(1) = IIf(IsNull(rs!VCHA_tit_NOMBRE), "", rs!VCHA_tit_NOMBRE)
'      list_item.SubItems(2) = ""
'      rs.MoveNext:
'   Wend
'   rs.Close
'   If lv_clientes.ListItems.Count > 7 Then
'      lv_clientes.ColumnHeaders(2).Width = 4220
'   Else
'      lv_clientes.ColumnHeaders(2).Width = 4499.71
'   End If
End Sub
...
Private Sub txt_busqueda_KeyPress(KeyAscii As Integer)
   If KeyAscii = 13 Then
      ...
      If Not rs.EOF Then
         Call pro_busca_registro(lv_clientes, rs!VCHA_TIT_NOMBRE, False)
      Else
