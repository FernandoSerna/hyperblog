...
Begin VB.Form frmentradas_devolucion_vistas 
   ...
   Begin VB.CommandButton Command1 
      ...
      Height          =   315
      Left            =   7215
      Picture         =   "frmentradas_devolucion_vistas.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   10
      ToolTipText     =   "Salir"
      Top             =   735
   ...
   Begin VB.CommandButton cmd_imprimir 
      ...
      Height          =   315
      Left            =   825
      Picture         =   "frmentradas_devolucion_vistas.frx":063A
      Style           =   1  'Graphical
      TabIndex        =   9
   ...
   Begin VB.CommandButton cmd_buscar 
      ...
      Height          =   315
      Left            =   495
      Picture         =   "frmentradas_devolucion_vistas.frx":073C
      Style           =   1  'Graphical
      TabIndex        =   8
   ...
   Begin VB.CommandButton cmd_nuevo 
      ...
      Height          =   315
      Left            =   165
      Picture         =   "frmentradas_devolucion_vistas.frx":083E
      Style           =   1  'Graphical
      TabIndex        =   7
   ...
   Begin VB.CommandButton cmd_cancelar 
      ...
      Height          =   315
      Left            =   1155
      Picture         =   "frmentradas_devolucion_vistas.frx":0940
      Style           =   1  'Graphical
      TabIndex        =   6
   ...
   Begin MSComctlLib.ImageList ImageList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmentradas_devolucion_vistas.frx":0A42
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmentradas_devolucion_vistas.frx":131C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmentradas_devolucion_vistas.frx":1BF6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmentradas_devolucion_vistas.frx":2192
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmentradas_devolucion_vistas.frx":2A6E
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmentradas_devolucion_vistas.frx":3348
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmentradas_devolucion_vistas.frx":3C22
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmentradas_devolucion_vistas.frx":3D34
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmentradas_devolucion_vistas.frx":3E46
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmentradas_devolucion_vistas.frx":3F58
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmentradas_devolucion_vistas.frx":406A
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmentradas_devolucion_vistas.frx":417C
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmentradas_devolucion_vistas"
         ...
         If var_si = 1 Then
            ...
            While Not rs.EOF
                  ...
                  While var_suma_cantidad < var_cantidad_llegar
                        ...
                        rsaux5.Open "update tb_existencias set floa_exi_cantidad_temporal_devuelta = isnull(floa_exi_cantidad_temporal_devuelta,0) - " + CStr(var_cantidad) + " where vcha_alm_almacen_id = '" + var_almacen_origen + "' and vcha_Art_articulo_id = '" + rs!vcha_Art_Articulo_id + "'", cnn, adOpenDynamic, adLockOptimistic
...
Private Sub Form_Load()
   ...
   If Not rs.EOF Then
      Me.txt_almacen_destino = IIf(IsNull(rs!vcha_mov_titulo_origen), "", rs!vcha_mov_titulo_origen)
      If Trim(Me.txt_almacen_destino) <> "" Then
         If rsaux.State = 1 Then
            rsaux.Close
         End If
         rsaux.Open "select * from tb_almacenes where vcha_alm_almacen_id = '" + Me.txt_almacen_destino + "'", cnn, adOpenDynamic, adLockOptimistic
         If Not rsaux.EOF Then
            Me.txt_nombre_almacen_destino = IIf(IsNull(rsaux!VCHA_ALM_NOMBRE), "", rsaux!VCHA_ALM_NOMBRE)
            var_almacen_Destino = Me.txt_almacen_destino
         Else
            MsgBox "Se debe de parametrizar el almacen destino"
...
Private Sub txt_almacen_origen_KeyDown(KeyCode As Integer, Shift As Integer)
   If KeyCode = 116 Then
      lv_lista.ListItems.Clear
      rs.Open "select * from tb_almacenes WHERE char_alm_tipo = 'G' and vcha_emp_empresa_id = '" + var_empresa + "' order by vcha_alm_nombre", cnn, adOpenDynamic, adLockBatchOptimistic
      While Not rs.EOF
            Set list_item = lv_lista.ListItems.Add(, , rs!VCHA_ALM_ALMACEN_ID)
            list_item.SubItems(1) = IIf(IsNull(rs!VCHA_ALM_NOMBRE), "", rs!VCHA_ALM_NOMBRE)
            rs.MoveNext
...
Private Sub txt_almacen_origen_KeyPress(KeyAscii As Integer)
   ...
   If KeyAscii = 13 Then
      ...
      If Trim(txt_almacen_origen) <> "" Then
         rs.Open "select * from tb_almacenes where vcha_alm_almacen_id = '" + Me.txt_almacen_origen + "' and char_alm_tipo = 'G' and vcha_emp_empresa_id = '" + var_empresa + "'", cnn, adOpenDynamic, adLockOptimistic
         If Not rs.EOF Then
                  ...
                  If Not rsaux.EOF Then
                     While Not rsaux.EOF
                        ...
                        If Not rsaux.EOF Then
                           ...
                           lbl_total = Format((CDbl(lbl_total) * 1) + IIf(IsNull(rsaux!floa_Sal_Cantidad), 0, rsaux!floa_Sal_Cantidad), "###,###,##0.00")
                           rsaux2.Close
                           rsaux.MoveNext:
                        End If
                     Wend
   ...
   If KeyAscii = 13 Then
      If IsNumeric(txt_cantidad_eliminar) Then
         If CDbl(txt_cantidad_eliminar) <= lv_traspasossalidas.selectedItem.SubItems(2) * 1 Then
            ...
            var_inserta = False
            rsaux4.Open "UPDATE TB_EXISTENCIAS SET FLOA_EXI_CANTIDAD_TEMPORAL_DEVUELTA = ISNULL(FLOA_EXI_CANTIDAD_TEMPORAL_DEVUELTA,0) - " + Me.txt_cantidad_eliminar + " WHERE VCHA_ALM_ALMACEN_ID = '" + var_almacen_origen + "' AND VCHA_ART_ARTICULO_ID = '" + lv_traspasossalidas.selectedItem + "'", cnn, adOpenDynamic, adLockOptimistic
            lbl_total = Format((CDbl(lbl_total) * 1) - CDbl(Me.txt_cantidad_eliminar), "###,###,##0.00")
...
Private Sub txt_foco_GotFocus()
   ...
   If Trim(txt_codigo.Text) <> "" Then
      bandera_suma = False
      rsaux5.Open "SELECT * FROM VW_EXISTENCIAS_VISTAS WHERE VCHA_ALM_ALMACEN_ID = '" + Me.txt_almacen_origen + "' AND VCHA_ART_ARTICULO_ID = '" + Me.txt_codigo + "' and cantidad_disponible >= " + CStr(var_cantidad_leida), cnn, adOpenDynamic, adLockOptimistic
      If Not rsaux5.EOF Then
         ...
         If Not rs.EOF Then
            ...
            rsaux4.Open "UPDATE TB_EXISTENCIAS SET FLOA_EXI_CANTIDAD_TEMPORAL_DEVUELTA = ISNULL(FLOA_EXI_CANTIDAD_TEMPORAL_DEVUELTA,0) + " + CStr(var_cantidad_leida) + " WHERE VCHA_ALM_ALMACEN_ID = '" + var_almacen_origen + "' AND VCHA_ART_ARTICULO_ID = '" + Me.txt_codigo + "'", cnn, adOpenDynamic, adLockOptimistic
            lbl_total = Format((CDbl(lbl_total) * 1) + var_cantidad_leida, "###,###,##0.00")
            rs.Close
         ...
         End If
      Else
         MsgBox "El artículo nunca fue sacado a vistas o la cantidad excede a la cantidad en las existencias del agente", vbOKOnly, "ATENCION"
      End If
      rsaux5.Close
      txt_codigo.SetFocus
   End If
