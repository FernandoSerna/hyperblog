...
Begin VB.Form frmreporte_comisiones_2 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton cmd_seleccion 
         ...
         Height          =   315
         Left            =   1440
         Picture         =   "frmreporte_comisiones_2.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   21
      ...
      Begin VB.CommandButton cmd_marcar 
         ...
         Height          =   315
         Left            =   780
         Picture         =   "frmreporte_comisiones_2.frx":0216
         Style           =   1  'Graphical
         TabIndex        =   19
      ...
      Begin VB.CommandButton cmd_invertir 
         ...
         Height          =   315
         Left            =   1110
         Picture         =   "frmreporte_comisiones_2.frx":0460
         Style           =   1  'Graphical
         TabIndex        =   20
      ...
      Begin VB.CommandButton cmd_ninguno 
         Height          =   315
         Left            =   120
         Picture         =   "frmreporte_comisiones_2.frx":0532
         Style           =   1  'Graphical
         TabIndex        =   17
      ...
      Begin VB.CommandButton cmd_todos 
         ...
         Height          =   315
         Left            =   450
         Picture         =   "frmreporte_comisiones_2.frx":0634
         Style           =   1  'Graphical
         TabIndex        =   18
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton Command12 
         ...
         Height          =   315
         Left            =   4830
         Picture         =   "frmreporte_comisiones_2.frx":084A
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton Command11 
         ...
         Height          =   315
         Left            =   2220
         Picture         =   "frmreporte_comisiones_2.frx":1ABC
         Style           =   1  'Graphical
         TabIndex        =   5
   ...
   Begin VB.CommandButton cmd_imprimir 
      ...
      Height          =   315
      Left            =   105
      Picture         =   "frmreporte_comisiones_2.frx":2D2E
      Style           =   1  'Graphical
      TabIndex        =   9
   ...
   Begin VB.CommandButton cmd_salir 
      ...
      Height          =   315
      Left            =   5370
      Picture         =   "frmreporte_comisiones_2.frx":2E30
      Style           =   1  'Graphical
      TabIndex        =   10
      ToolTipText     =   "Salir"
      Top             =   30
   ...
   End
End
Attribute VB_Name = "frmreporte_comisiones_2"
         ...
         If var_empresa = "02" Or var_empresa = "03" Then
            ...
            If var_contador > 0 Then
               ...
               If opt_general.Value = True Then
                  ...
                  'MsgBox "{VW_TEMP_REPORTE_COMISIONES_GENERAL.INTE_COM_CONSECUTIVO} = " + CStr(var_consecutivo) + " and(" + var_cadena_2 + ")"
         ...
         Else
            If var_empresa = "18" Then
               ...
               If var_contador > 0 Then
                  ...
                  'MsgBox cnn_sqlquezada2.ConnectionString
                  ...
                  var_cadena = var_cadena + " from sqlquezada2.sidtextilera.DBO.VW_DETALLE_FACTURACION_LINEAS a, tb_temp_agentes_comisiones b where a.vcha_age_agente_id = b.vcha_age_agente_id and b.inte_tem_consecutivo = " + CStr(var_consecutivo)
                  ...
                  If opt_linea.Value = True Then
                     Set reporte = appl.OpenReport(App.Path + "\rep_comisiones_linea_2.rpt")
                     'MsgBox "{VW_TEMP_REPORTE_COMISIONES.INTE_COM_CONSECUTIVO} = " + CStr(var_consecutivo) + " and (" + var_cadena + ")"
                     reporte.RecordSelectionFormula = "{VW_TEMP_REPORTE_COMISIONES.INTE_COM_CONSECUTIVO} = " + CStr(var_consecutivo) + " and (" + var_cadena + ")"
                     frmvistasprevias.cr.ReportSource = reporte
                     For ntablas = 1 To reporte.Database.Tables.Count
                         reporte.Database.Tables(ntablas).SetLogOnInfo parametros(6), var_bd_reportes, parametros(4), parametros(5)
