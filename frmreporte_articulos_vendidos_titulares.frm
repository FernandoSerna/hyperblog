...
Begin VB.Form frmreporte_articulos_vendidos_titulares 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton cmd_todos 
         ...
         Height          =   315
         Left            =   450
         Picture         =   "frmreporte_articulos_vendidos_titulares.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton cmd_ninguno 
         Height          =   315
         Left            =   120
         Picture         =   "frmreporte_articulos_vendidos_titulares.frx":0216
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton cmd_invertir 
         ...
         Height          =   315
         Left            =   1110
         Picture         =   "frmreporte_articulos_vendidos_titulares.frx":0318
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton cmd_marcar 
         ...
         Height          =   315
         Left            =   780
         Picture         =   "frmreporte_articulos_vendidos_titulares.frx":03EA
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton cmd_seleccion 
         ...
         Height          =   315
         Left            =   1440
         Picture         =   "frmreporte_articulos_vendidos_titulares.frx":0634
         Style           =   1  'Graphical
         TabIndex        =   2
   ...
   End
End
Attribute VB_Name = "frmreporte_articulos_vendidos_titulares"
...
Private Sub cmd_ejecutar_Click()
   If IsDate(Me.txt_inicio) Then
      If IsDate(Me.txt_fin) Then
         var_contador = 0
         For var_i = 1 To Me.lv_titulares.ListItems.Count
             lv_titulares.ListItems.Item(var_i).Selected = True
             If Me.lv_titulares.selectedItem.SubItems(2) = "*" Then
         ...
         If var_contador > 0 Then
            ...
            For var_i = 1 To lv_titulares.ListItems.Count
                ...
                If lv_titulares.selectedItem.SubItems(2) = "*" Then
                   rs.Open "INSERT INTO TB_TEMP_REPORTE_ARTICULOS_VENDIDOS_TITULARES (INTE_TEM_CONSECUTIVO, VCHA_TIT_TITULAR_ID) VALUES (" + CStr(var_consecutivo) + ",'" + lv_titulares.selectedItem + "')", cnn, adOpenDynamic, adLockOptimistic
                End If
            Next var_i
...
Private Sub cmd_filtro_Click()
   If IsDate(Me.txt_inicio) Then
      If IsDate(Me.txt_fin) Then
         ...
         For var_i = 1 To lv_titulares.ListItems.Count
             ...
             If lv_titulares.selectedItem.SubItems(2) = "*" Then
                If Trim(var_cadena_reporte_articulos) = "" Then
                   var_cadena_reporte_articulos = " vcha_tit_titular_id = '" + Me.lv_titulares.selectedItem + "'"
                Else
                   var_cadena_reporte_articulos = var_cadena_reporte_articulos + " or vcha_tit_titular_id = '" + Me.lv_titulares.selectedItem + "'"
                End If
             End If
         Next var_i
         If Trim(var_cadena_reporte_articulos) <> "" Then
            frmreporte_articulos_vendidos_articulos.txt_tipo_reporte = "Titulares"
         ...
         Else
            MsgBox "Debe de seleccionar algún titular", vbOKOnly, "ATENCION"
         End If
      Else
         MsgBox "Fecha final incorrecta", vbOKOnly, "ATENCION"
      End If
...
Private Sub cmd_siguiente_Click()
   ...
   For var_i = 1 To lv_titulares.ListItems.Count
       ...
       If lv_titulares.selectedItem.SubItems(2) = "*" Then
          If Trim(var_cadena_reporte_articulos) = "" Then
             var_cadena_reporte_articulos = " vcha_age_agente_id = '" + lv_titulares.selectedItem + "'"
          Else
             var_cadena_reporte_articulos = var_cadena_reporte_articulos + " or vcha_age_agente_id = '" + lv_titulares.selectedItem + "'"
          End If
       End If
   Next var_i
   If var_cadena_reporte_articulos = "" Then
      MsgBox "Debe de seleccionar un agente", vbOKOnly, "ATENCION"
   Else
      frmreporte_articulos_vendidos_rutas.Show
   End If
End Sub
...
Private Sub Form_Load()
   ...
   txt_fin = Date
   'opt_linea = True
   rs.Open "select distinct vcha_tit_titular_id, vcha_tit_nombre from vw_clientes where  (" + var_cadena_reporte_articulos + ")  order by vcha_tit_nombre ", cnn, adOpenDynamic, adLockOptimistic
   ...
   Wend
   rs.Close
   If lv_titulares.ListItems.Count > 8 Then
      lv_titulares.ColumnHeaders(2).Width = 4220
   Else
      lv_titulares.ColumnHeaders(2).Width = 4400.71
   End If
End Sub
...
Private Sub txt_busqueda_KeyPress(KeyAscii As Integer)
   If KeyAscii = 13 Then
      ...
      If Not rs.EOF Then
         Call pro_busca_registro(lv_titulares, rs!vcha_can_nombre, False)
      Else
