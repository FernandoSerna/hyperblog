...
Begin VB.Form frmreporte_articulos_vendidos_canales 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton cmd_todos 
         ...
         Height          =   315
         Left            =   450
         Picture         =   "frmreporte_articulos_vendidos_canales.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton cmd_ninguno 
         Height          =   315
         Left            =   120
         Picture         =   "frmreporte_articulos_vendidos_canales.frx":0216
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton cmd_invertir 
         ...
         Height          =   315
         Left            =   1110
         Picture         =   "frmreporte_articulos_vendidos_canales.frx":0318
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton cmd_marcar 
         ...
         Height          =   315
         Left            =   780
         Picture         =   "frmreporte_articulos_vendidos_canales.frx":03EA
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton cmd_seleccion 
         ...
         Height          =   315
         Left            =   1440
         Picture         =   "frmreporte_articulos_vendidos_canales.frx":0634
         Style           =   1  'Graphical
         TabIndex        =   3
   ...
   End
End
Attribute VB_Name = "frmreporte_articulos_vendidos_canales"
...
Private Sub Form_Load()
   ...
   txt_fin = Date
   'opt_linea = True
   rs.Open "select distinct vcha_Can_canal_venta_id, vcha_can_nombre from vw_clientes where  (" + var_cadena_reporte_articulos + ") AND INTE_CAN_REPORTE = 1 order by vcha_can_nombre ", cnn, adOpenDynamic, adLockOptimistic
   numero_items_ALMACENES = 0
   While Not rs.EOF
      If IsNull(rs!vcha_can_canal_venta_id) Then
      Else
   ...
   Else
      lv_canales.ColumnHeaders(2).Width = 4400.71
   End If
End Sub
