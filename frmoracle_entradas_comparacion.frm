...
Begin VB.Form frmoracle_entradas_comparacion 
   Caption         =   "Form1"
   ClientHeight    =   7275
   ClientLeft      =   60
   ClientTop       =   405
   ...
   Begin VB.CommandButton cmd_nuevo 
      ...
      Height          =   315
      Left            =   45
      Picture         =   "frmoracle_entradas_comparacion.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   34
   ...
   Begin VB.CommandButton cmd_buscar 
      ...
      Height          =   315
      Left            =   375
      Picture         =   "frmoracle_entradas_comparacion.frx":0102
      Style           =   1  'Graphical
      TabIndex        =   33
   ...
   Begin VB.CommandButton cmd_imprimir 
      ...
      Height          =   315
      Left            =   705
      Picture         =   "frmoracle_entradas_comparacion.frx":0204
      Style           =   1  'Graphical
      TabIndex        =   32
   ...
   Begin VB.CommandButton cmd_salir 
      ...
      Height          =   315
      Left            =   11130
      Picture         =   "frmoracle_entradas_comparacion.frx":0306
      Style           =   1  'Graphical
      TabIndex        =   31
      ToolTipText     =   "Salir"
      Top             =   720
   ...
   Begin VB.Frame frm_pasar_todo 
      ...
      Begin VB.CommandButton cmd_cancelar_pedidos 
         ...
         Height          =   315
         Left            =   390
         Picture         =   "frmoracle_entradas_comparacion.frx":0940
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton cmd_aceptar_pedidos 
         ...
         Height          =   315
         Left            =   60
         Picture         =   "frmoracle_entradas_comparacion.frx":0A8A
         Style           =   1  'Graphical
         TabIndex        =   5
   ...
   Begin MSComctlLib.ImageList ImageList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmoracle_entradas_comparacion.frx":0BD4
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmoracle_entradas_comparacion.frx":14AE
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmoracle_entradas_comparacion.frx":1D88
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmoracle_entradas_comparacion.frx":2324
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmoracle_entradas_comparacion.frx":2C00
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmoracle_entradas_comparacion.frx":34DA
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmoracle_entradas_comparacion.frx":3DB4
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmoracle_entradas_comparacion.frx":3EC6
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmoracle_entradas_comparacion.frx":3FD8
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmoracle_entradas_comparacion.frx":40EA
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmoracle_entradas_comparacion.frx":41FC
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmoracle_entradas_comparacion.frx":430E
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmoracle_entradas_comparacion"
...
Private Sub cmd_factura_Click()
   ...
   Dim var_factura As Integer
   Dim var_posible_cliente As Boolean
   'rsaux11.Open "select segment1, sum(floa_sal_cantidad_leida) cantidad from xxvia_tb_Salidas_Cajas where source_header_number = 412647 and segment1 not in ('00077420','00077419','00077418') group by segment1", cnnoracle_4, adOpenDynamic, adLockOptimistic
   If rsaux11.State = 1 Then
      rsaux11.Close
   End If
   rsaux11.Open "select CAST(CODIGO AS VARCHAR(50)) AS SEGMENT1, DIFERENCIA * -1 AS CANTIDAD from [p_433923] where diferencia < 0", cnn, adOpenDynamic, adLockOptimistic
   var_primera_vez = True
   While Not rsaux11.EOF
         Me.txt_codigo = rsaux11!SEGMENT1
      ...
      Else
         If var_clave_movimiento = "VDI" Then
            ...
            Else
               ...
               End If
               'var_tipo_pedido_ventas_directas = 1051
               'var_tipo_pedido_ventas_directas = 1048
               'var_tipo_pedido_ventas_directas = 1042}
               'var_tipo_pedido_ventas_directas = 1106
               rsaux7.Open "select name from qp_secu_list_headers_v where list_header_id = " + CStr(var_clave_lista_precios), cnnoracle_4, adOpenDynamic, adLockOptimistic
               var_lista_precios = rsaux7!Name
               rsaux7.Close
            ...
            If var_clave_movimiento = "SP" Or var_clave_movimiento = "EP" Then
               If var_estatus_movimiento <> "I" Then
                  ...
                  If var_clave_movimiento = "SP" Then
                     ...
                     Else
                        Set reporte = appl.OpenReport(App.Path + "\rep_oracle_entradas_privalia.rpt")
                     End If
                  ...
                  Else
                     ...
                     For var_j = 1 To Me.lv_entradas.ListItems.Count
                         Me.lv_entradas.ListItems.Item(var_j).Selected = True
                         rsaux1.Open "INSERT INTO TB_TEMP_ORACLE_SALIDAS_PRIVALIA (INTE_TEM_CONSECUTIVO, FECHA_INICIO, FECHA_FIN, CODIGO, DESCRIPCION, CANTIDAD, FOLIO, MOVIMIENTO, CANTIDAD_ENVIADA, PEDIDO) VALUES (" + CStr(var_consecutivo) + ",'" + CStr(IIf(IsNull(rsaux!FECHA_INiCIO), "", rsaux!FECHA_INiCIO)) + "','" + CStr(IIf(IsNull(rsaux!FECHA_FIN), "", rsaux!FECHA_FIN)) + "','" + Me.lv_entradas.selectedItem + "','" + Me.lv_entradas.selectedItem.SubItems(1) + "'," + Me.lv_entradas.selectedItem.SubItems(3) + "," + Me.txt_folio + ",'" + var_clave_movimiento + "'," + Me.lv_entradas.selectedItem.SubItems(2) + ",'" + Me.txt_pedido + "')", cnn, adOpenDynamic, adLockOptimistic
                     Next var_j
                     rsaux.Close
                  End If
                  Me.txt_codigo = ""
...
salir_factura:
   MsgBox "No se pudo generar el documento electrónico", vbOKOnly, "ATENCION"
      ...
      Exit Sub
no_job:
    MsgBox "Vueleva a ejecutar la impresión", vbOKOnly, "ATENCION"
...
Private Sub Form_Load()
   Me.Caption = Me.lblnombremovimiento
   Me.chk_factura = 0
   ...
   If KeyCode = 116 Then
      ...
      If var_unidad_organizacional = "90" Then
         ...
         Else
            ...
            Else
               If var_clave_usuario_global = "U0000000164" Then
               ...
               Else
                  rs.Open "select secondary_inventory_name as vcha_alm_almacen_id, description as vcha_alm_nombre from mtl_secondary_inventories where organization_id = " + var_unidad_organizacional + " AND secondary_inventory_name in ('CDISTEX_PT','TEXCALIDAD','TEX_ALM_PT','TEX_VB1','TEX_VB2','TEX_VB4')", cnnoracle_4, adOpenDynamic, adLockOptimistic
               End If
            End If
         End If
         While Not rs.EOF
...
Private Sub txt_busqueda_folio_KeyPress(KeyAscii As Integer)
   ...
   If KeyAscii = 13 Then
      ...
      If IsNumeric(Me.txt_busqueda_folio) Then
         ...
         If Not rs.EOF Then
            var_pedido = IIf(IsNull(rs!numero_referencia), 0, rs!numero_referencia)
            Me.txt_pedido = var_pedido
            ...
            If var_pedido > 0 Then
               Me.txt_pedido = var_pedido
               rsaux.Open "select a.segment1, b.description as descripcion, sum(floa_sal_Cantidad_leida) as cantidad  from xxvia_tb_salidas_cajas a, xxvia_system_items_b b where source_header_number = " + Me.txt_pedido + " and a.segment1 = b.segment1  and b.organization_id = 93 group by a.segment1, b.description", cnnoracle_4, adOpenDynamic, adLockOptimistic
               While Not rsaux.EOF
                     ...
                     list_item.SubItems(2) = IIf(IsNull(rsaux!Cantidad), "0", rsaux!Cantidad)
                     list_item.SubItems(3) = 0
                     list_item.SubItems(4) = IIf(IsNull(rsaux!Cantidad), "0", rsaux!Cantidad)
                     lbl_cantidad_enviada = CStr(CDbl(lbl_cantidad_enviada) + IIf(IsNull(rsaux!Cantidad), "0", rsaux!Cantidad))
                     rsaux.MoveNext
               Wend
               rsaux.Close
               ...
               While Not rs.EOF
                     ...
                     For var_j = 1 To Me.lv_entradas.ListItems.Count
                         Me.lv_entradas.ListItems.Item(var_j).Selected = True
                         If Me.lv_entradas.selectedItem = var_codigo Then
                            var_encontro = 1
                            Me.lv_entradas.selectedItem.SubItems(3) = CDbl(Me.lv_entradas.selectedItem.SubItems(3)) + rs!Cantidad
                            Me.lv_entradas.selectedItem.SubItems(4) = CDbl(Me.lv_entradas.selectedItem.SubItems(4)) - rs!Cantidad
                         End If
                     Next var_j
                     If var_encontro = 0 Then
                        ...
                        list_item.SubItems(4) = IIf(IsNull(rs!Cantidad), "0", rs!Cantidad) * -1
                     End If
                     lbl_total = CStr(CDbl(lbl_total) + IIf(IsNull(rs!Cantidad), "0", rs!Cantidad))
                     rs.MoveNext
               Wend
...
Private Sub txt_cantidad_eliminar_KeyPress(KeyAscii As Integer)
   ...
   If KeyAscii = 13 Then
      If IsNumeric(txt_cantidad_eliminar) Then
         ...
         If VAR_CANTIDAD_ELIMINAR >= 1 = True Then
            If rsaux8.State = 1 Then
               rsaux8.Close
            End If
            ...
            If Not rsaux8.EOF Then
               ...
               rs.Open "UPDATE xxvia_tb_devoluciones_clientes SET CANTIDAD = CANTIDAD -" + CStr(VAR_CANTIDAD_ELIMINAR) + " where numero = " + Str(var_numero_folio) + " and codigo = '" + Me.lv_entradas.selectedItem + "' and movimiento = '" + var_clave_movimiento + "'", cnnoracle_4, adOpenDynamic, adLockOptimistic
            On Error GoTo x:
               clnt.MSSoapInit var_webservice_texto
               'var_s = clnt.insertar_texto(CStr(var_dvr_texto_ip), CStr(var_puerto_texto), "MOVIMIENTO: " + var_clave_movimiento + Me.txt_folio + "   MAQUINA: " + fun_NombrePc + ", USUARIO: " + var_nombre_usuario_global + Chr(13) + "Código: " + Me.lv_entradas.selectedItem + " " + Me.lv_entradas.selectedItem.SubItems(1) + " Cantidad eliminada: " + CStr(VAR_CANTIDAD_ELIMINAR))
               var_s = clnt.insertar_texto(CStr(var_dvr_texto_ip), CStr(var_puerto_texto), "MOVIMIENTO: " + var_clave_movimiento + Me.txt_folio + "  MAQUINA: " + fun_NombrePc + Chr(13) + " USUARIO: " + var_nombre_usuario_global + Chr(13) + "FECHA Y HORA: " + VAR_FECHA_HORA + Chr(13) + "Código: " + Me.lv_entradas.selectedItem + " " + Me.lv_entradas.selectedItem.SubItems(1) + " Cantidad eliminada: " + CStr(VAR_CANTIDAD_ELIMINAR))
         ...
         If Not rs.EOF Then
            ...
            If Not rsaux8.EOF Then
               ...
               If var_estatus_caja = "A" Then
                  ...
                  strconsulta = "update xxvia_Tb_cajas_prod set vcha_caj_staus = 'E' where vcha_caj_Caja_id = ?"
                  With comandoORA
                       .ActiveConnection = cnnoracle_4
                       .CommandType = adCmdText
                       .CommandText = strconsulta
         ...
         If rs.EOF Then
            ...
            For var_j = 1 To Me.lv_entradas.ListItems.Count
                  ...
                  If Me.lv_entradas.selectedItem = Me.txt_codigo Then
                     ...
                     Me.lv_entradas.selectedItem.SubItems(4) = CDbl(Me.lv_entradas.selectedItem.SubItems(4)) - var_cantidad_leida
                     var_renglon = var_j
                     var_encontro = 1
                  End If
            Next var_j
            If var_encontro = 0 Then
               ...
               list_item.SubItems(4) = var_cantidad_leida * -1
               var_renglon = lv_entradas.ListItems.Count
            End If
            On Error GoTo x:
            clnt.MSSoapInit var_webservice_texto
            var_s = clnt.insertar_texto(CStr(var_dvr_texto_ip), CStr(var_puerto_texto), "MOVIMIENTO: " + var_clave_movimiento + Me.txt_folio + "  MAQUINA: " + fun_NombrePc + Chr(13) + " USUARIO: " + var_nombre_usuario_global + Chr(13) + "FECHA Y HORA: " + VAR_FECHA_HORA + Chr(13) + "Código: " + Me.txt_codigo + " " + var_descripcion_articulo + Chr(13) + " Cantidad: " + CStr(var_cantidad_leida))
            Set clnt = Nothing
x:
            Call ilumina_grid
            txt_codigo = ""
...
Private Sub txt_pedido_KeyPress(KeyAscii As Integer)
   ...
   If KeyAscii = 13 Then
      ...
      If Trim(Me.txt_pedido) <> "" Then
         rsaux10.Open "select * from xxvia_tb_devoluciones_clientes where numero_referencia = " + Me.txt_pedido + " AND MOVIMIENTO= 'EP'", cnnoracle_4, adOpenDynamic, adLockOptimistic
         If rsaux10.EOF Then
            var_cadena = "SELECT * FROM OE_ORDER_HEADERS_ALL WHERE ORDER_NUMBER = '" + Me.txt_pedido + "'"
            rs.Open var_cadena, cnnoracle_4, adOpenDynamic, adLockOptimistic
            If Not rs.EOF Then
               rsaux.Open "select a.segment1, b.description as descripcion, sum(floa_sal_Cantidad_leida) as cantidad  from xxvia_tb_salidas_cajas a, xxvia_system_items_b b where source_header_number = " + Me.txt_pedido + " and a.segment1 = b.segment1  and b.organization_id = 93 group by a.segment1, b.description", cnnoracle_4, adOpenDynamic, adLockOptimistic
               While Not rsaux.EOF
               ...
               Wend
               rsaux.Close
               rsaux.Open "SELECT * FROM XXVIA_tB_DEVOLUCIONES_CLIENTES WHERE NUMERO_REFERENCIA = " + Me.txt_pedido + " and cantidad > 0", cnnoracle_4, adOpenDynamic, adLockOptimistic
               lbl_total = 0
               While Not rsaux.EOF
                     var_encontro = 0
                     For var_j = 1 To Me.lv_entradas.ListItems.Count
                         Me.lv_entradas.ListItems.Item(var_j).Selected = True
                         If Me.lv_entradas.selectedItem = rsaux!CODIGO Then
                            var_encontro = 1
                            Me.lv_entradas.selectedItem.SubItems(3) = rsaux!Cantidad
                            Me.lv_entradas.selectedItem.SubItems(4) = CDbl(Me.lv_entradas.selectedItem.SubItems(2)) - CDbl(Me.lv_entradas.selectedItem.SubItems(3))
                         End If
                     Next var_j
                     If var_encontro = 0 Then
                        Set list_item = lv_entradas.ListItems.Add(, , rsaux!CODIGO)
                        list_item.SubItems(1) = IIf(IsNull(rsaux!DESCRIPCION), "", rsaux!DESCRIPCION)
                        list_item.SubItems(2) = 0
                        list_item.SubItems(3) = rsaux!Cantidad
                        list_item.SubItems(4) = (IIf(IsNull(rsaux!Cantidad), "0", rsaux!Cantidad)) * -1
                     End If
                     lbl_total = CStr(CDbl(lbl_total) + IIf(IsNull(rsaux!Cantidad), "0", rsaux!Cantidad))
                     rsaux.MoveNext
               Wend
               rsaux.Close
               Me.txt_almacen = "PRIVALIA"
               ...
               rsaux1.Open var_cadena, cnnoracle_4, adOpenDynamic, adLockOptimistic
               If Not rsaux1.EOF Then
                  var_clave_lista_precios = IIf(IsNull(rsaux1!price_list_id), 0, rsaux1!price_list_id)
               End If
               rsaux1.Close
               Me.txt_referencia = ""
               Me.txt_almacen.Enabled = False
               ...
               Me.txt_referencia.SetFocus
            Else
               MsgBox "El pedido no pertenece a PRIVALIA", vbOKOnly, "ATENCION"
            End If
            rs.Close
         Else
            MsgBox "El pedido se encuentra cargado en el folio " + CStr(rsaux10!numero), vbOKOnly, "ATENCION"
         End If
         rsaux10.Close
      End If
   End If
