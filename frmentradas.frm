         ...
         If var_estatus_movimiento = "C" Or var_estatus_movimiento = "I" Then
            If Trim(var_reporte_imprimir) <> "" Then
               If var_clave_movimiento = "EI" And var_almacen_Destino = "RETEX" Then
                  Set reporte = appl.OpenReport(App.Path + "\rep_reporte_movimientos_entrada_intercompañia_segundas.rpt")
                  frmvistasprevias.cr.ReportSource = reporte
                  reporte.RecordSelectionFormula = "{VW_REPORTE_ENTRADAS_INTERCOMPAÑIAS_SEGUNDAS.INTE_EMO_NUMERO} = " + Str(var_numero_folio) + " and {VW_REPORTE_ENTRADAS_INTERCOMPAÑIAS_SEGUNDAS.VCHA_MOV_MOVIMIENTO_ID} = '" + var_clave_movimiento + "'"
               ...
               If var_empresa = "180000" Then
                  If var_clave_movimiento = "DT" Then
                     ...
                     If Trim(var_correo_electronico) <> "" Then
                        ...
                        MAPIMessages1.MsgSubject = "Devolución de tienda " + Me.txt_archivo
                        MAPIMessages1.MsgNoteText = "Se anexa información de la devolución  " + Me.txt_archivo
                        ...
                        Print #1, "Se genero la devolución " + Trim(Me.txt_archivo) + " con los siguientes datos"
                        Print #1, ""
                        ...
                        While Not rsaux9.EOF
                              ...
                              rsaux8.Open "select vcha_Art_nombre_español from tb_articulos where vcha_Art_articulo_id = '" + rsaux9!VCHA_ART_ARTICULO_ID + "'", cnn, adOpenDynamic, adLockOptimistic
                              If Not rsaux8.EOF Then
                                 var_nombre_articulo_correo = Mid(IIf(IsNull(rsaux8!vcha_Art_nombre_español), "", rsaux8!vcha_Art_nombre_español), 1, 40)
                              End If
                              rsaux8.Close
                     ...
                     If var_clave_movimiento = "EI" Or var_clave_movimiento = "ETA" Then
                        ...
                        Else
                           ...
                           If var_clave_movimiento = "EI" Then
                               ...
                               var_cadena = "insert into IN_TB_FACTURAS_INT (INVOICE_ID,INVOICE_NUM,INVOICE_TYPE_LOOKUP_CODE,VENDOR_ID,VENDOR_SITE_ID,INVOICE_AMOUNT,INVOICE_CURRENCY_CODE,EXCHANGE_RATE_TYPE,EXCHANGE_DATE,EXCHANGE_RATE,Description,Source,GL_DATE,INVOICE_DATE,ORG_ID) values (" + CStr(var_consecutivo) + ",'" + Me.txt_archivo + "','STANDARD'," + CStr(var_proveedor_oracle_2) + "," + CStr(var_clave_proveedor_oracle) + "," + CStr(IIf(IsNull(var_importe_total), 0, var_importe_total)) + ",'MXP',null,null,null,'FACTURA DE RECEPCION NUM: " + Me.txt_archivo + "','FACTURA INTERCOMPAÑIAS',TO_DATE('" + CStr(Date) + "','DD/MM/YYYY'),TO_DATE('" + CStr(Date) + "','DD/MM/YYYY')," + var_unidad_oracle + ")"
                               'MsgBox var_cadena
       ...
       If Trim(txt_codigo.Text) <> "" Then
          ...
          If var_posible = True Then
             ...
             If Not rs.EOF Then
                ...
                If var_encontro = 1 Then
                   ...
                   If var_posible = True Then
                      ...
                      Else
                         txt_codigo = ""
                         frmmensaje.lbl_mensaje = "La cantidad exede a la cantidad en la relación"
                         frmmensaje.Show 1
                         'MsgBox "La cantidad exede a la cantidad en la relación", vbOKOnly, "ATENCION"
                      End If
                   Else
                      txt_codigo = ""
             ...
             Else
                ...
                If var_tipo_documento = "V" Then
                   txt_codigo = ""
                   frmmensaje.lbl_mensaje = "El artículo no existe dentro de la salida a vistas"
                   frmmensaje.Show 1
                   'MsgBox "El artículo no existe dentro de la salida a vistas", vbOKOnly, "ATENCION"
                   var_posible = False
                Else
                   ...
                   Else
                      txt_codigo = ""
                      frmmensaje.lbl_mensaje = "El artículo no se encuentra dentro de la relación"
                      frmmensaje.Show 1
                      'MsgBox "El artículo no se encuentra dentro de la relación", vbOKOnly, "ATENCION"
                   End If
                End If
                If var_global_aceptar_demas = 0 Then
                   var_posible = False
                ...
                If var_posible = True Then
                   ...
                   Else
                      ...
                      If var_empresa = "18" And var_proveedor = "2458" Then
                         rsaux3.Open "INSERT INTO TB_TEMPORAL_ENTRADAS (VCHA_EMP_EMPRESA_ID, VCHA_UOR_UNIDAD_ID, VCHA_ALM_ALMACEN_ID, VCHA_MOV_MOVIMIENTO_ID, INTE_ENT_NUMERO, VCHA_ART_ARTICULO_ID, FLOA_ENT_CANTIDAD, FLOA_ENT_COSTO, FLOA_ENT_PRECIO, FLOA_ENT_DESCUENTO, VCHA_ENT_ALMACEN_ORIGEN,INTE_ENT_CONSECUTIVO, INTE_ENT_AÑO, P_RC_NUMERO_LINEA, P_RC_LINEA_ID) values ('" + var_empresa + "', '" + var_unidad_organizacional + "', '" + var_almacen_Destino + "', '" + var_clave_movimiento + "', " + CStr(var_numero_folio) + ",'" + txt_codigo + "', " + CStr(var_cantidad_leida) + ", " + CStr(var_costo_tela) + ", " + CStr(var_precio) + ", 0,'" + var_almacen_origen + "', " + CStr(var_consecutivo) + ", " + CStr(var_año) + ", " + CStr(var_P_RC_LINEA_ID) + "," + CStr(var_P_RC_NUMERO_LINEA) + ")", cnn, adOpenDynamic, adLockOptimistic
                      Else
                         rsaux3.Open "INSERT INTO TB_TEMPORAL_ENTRADAS (VCHA_EMP_EMPRESA_ID, VCHA_UOR_UNIDAD_ID, VCHA_ALM_ALMACEN_ID, VCHA_MOV_MOVIMIENTO_ID, INTE_ENT_NUMERO, VCHA_ART_ARTICULO_ID, FLOA_ENT_CANTIDAD, FLOA_ENT_COSTO, FLOA_ENT_PRECIO, FLOA_ENT_DESCUENTO, VCHA_ENT_ALMACEN_ORIGEN,INTE_ENT_CONSECUTIVO, INTE_ENT_AÑO, P_RC_NUMERO_LINEA, P_RC_LINEA_ID) values ('" + var_empresa + "', '" + var_unidad_organizacional + "', '" + var_almacen_Destino + "', '" + var_clave_movimiento + "', " + CStr(var_numero_folio) + ",'" + txt_codigo + "', " + CStr(var_cantidad_leida) + ", " + CStr(var_costo + var_costo_tela) + ", " + CStr(var_precio) + ", 0,'" + var_almacen_origen + "', " + CStr(var_consecutivo) + ", " + CStr(var_año) + ", " + CStr(var_P_RC_LINEA_ID) + "," + CStr(var_P_RC_NUMERO_LINEA) + ")", cnn, adOpenDynamic, adLockOptimistic
                      End If
                      rs.Close
                   End If
             ...
             Else
                If var_posible = True Then
                   ...
                   If var_posible_lectura_kanban = True Then
                      ...
                      If var_posible = True Then
                         ...
                         Else
                            ...
                            End If
                            If var_empresa = "18" And var_proveedor = "2458" Then
                               rsaux3.Open "INSERT INTO TB_TEMPORAL_ENTRADAS (VCHA_EMP_EMPRESA_ID, VCHA_UOR_UNIDAD_ID, VCHA_ALM_ALMACEN_ID, VCHA_MOV_MOVIMIENTO_ID, INTE_ENT_NUMERO, VCHA_ART_ARTICULO_ID, FLOA_ENT_CANTIDAD, FLOA_ENT_COSTO, FLOA_ENT_PRECIO, FLOA_ENT_DESCUENTO, VCHA_ENT_ALMACEN_ORIGEN, INTE_ENT_CONSECUTIVO, INTE_ENT_AÑO, P_RC_LINEA_ID, P_RC_NUMERO_LINEA) values ('" + var_empresa + "', '" + var_unidad_organizacional + "', '" + var_almacen_Destino + "', '" + var_clave_movimiento + "', " + CStr(var_numero_folio) + ",'" + txt_codigo + "', " + CStr(var_cantidad_leida) + ", " + CStr(var_costo_tela) + ", " + CStr(var_precio) + ", 0,'" + var_almacen_origen + "', " + CStr(var_consecutivo) + ", " + CStr(var_año) + "," + CStr(var_P_RC_LINEA_ID) + "," + CStr(var_P_RC_NUMERO_LINEA) + ")", cnn, adOpenDynamic, adLockOptimistic
                            Else
                   ...
                   If var_numero_serie = 1 Then
                      ...
                      rsaux9.Open "select substring(vcha_art_nombre_español,1,23) AS descripcion, substring(vcha_art_nombre_español,24,46) as descripcion_2 from tb_articulos where vcha_art_Articulo_id = '" + Me.txt_codigo + "'", cnn, adOpenDynamic, adLockOptimistic
                      If Not rsaux9.EOF Then
         ...
         If var_movimiento_bloqueado = 0 Then
            ...
            If var_posible = 1 Then
               ...
               While Not rs.EOF
                  ...
                  If Not rsaux.EOF Then
                     Set list_item = lv_entradas.ListItems.Add(, , rs!VCHA_ART_ARTICULO_ID)
                         ...
                         list_item.SubItems(10) = IIf(IsNull(rs!INTE_COM_AÑO), "", rs!INTE_COM_AÑO)
               ...
               If Len(Trim(IIf(IsNull(rs!VCHA_COM_CAJA), "", rs!VCHA_COM_CAJA))) > 0 Then
                  lbl_tipo = "Código de la caja:"
                  var_cajas = True
               Else
                 lbl_tipo = "Código del artículo:"
                 var_cajas = False
               End If
               rs.Close
               var_n = lv_entradas.ListItems.Count
               ...
               If Not rs.EOF Then
                  ...
                  MsgBox "No puede modificar este movimiento ya que el la relación esta siendo utilizada por el usuario: '" + Trim(rs!VCHA_USU_NOMBRE) + " " + Trim(rs!vcha_usu_apellidos) + "' en la máquina: '" + Trim(rs!vcha_blo_maquina) + "'", vbOKOnly, "ATENCION"
               Else
         ...
         Else
            ...
            If var_kanban_es_un_kanban = "S" Then
               ...
               If Me.txt_codigo = Me.lv_entradas.selectedItem Then
                  ...
                  rsaux2.Close
               Else
                  MsgBox "El código del kanban leido no corresponde al código del kanban seleccionado", vbOKOnly, "ATENCION"
...
Private Sub txt_codigo_caja_KeyPress(KeyAscii As Integer)
   ...
   If KeyAscii = 13 Then
      ...
      Else
          frmmensaje.lbl_mensaje = "El artículo no viene en la caja"
          frmmensaje.Show 1
         'MsgBox "El artículo no viene en la caja", vbOKOnly, "ATENCION"
      End If
   End If
End Sub
      ...
      If var_empresa <> "16" Then
         ...
         If var_cajas = True Then
            ...
            If var_paquete = "CA" Then
               ...
               If Not rs.EOF Then
                  If rs!FLOA_com_cANTIDAD_RECIBIDA = 0 Then
                     ...
                     If Not rsaux2.EOF Then
                        ...
                        Me.txt_articulo_caja = rsaux2!vcha_Art_nombre_español
               ...
               Else
                  txt_codigo = ""
                  frmmensaje.lbl_mensaje = "Código de caja no existe"
                  frmmensaje.Show 1
                  'MsgBox "Código de caja no existe", vbOKOnly, "ATENCION"
               End If
               If rs.State = 1 Then
                  rs.Close
               End If
                  ...
                  If Trim(txt_codigo) <> "" Then
                     ...
                     If Not rsaux4.EOF Then
                        ...
                        Else
                           ...
                           End If
                        End If
                        var_nombre_articulo = IIf(IsNull(rsaux4!vcha_Art_nombre_español), "", rsaux4!vcha_Art_nombre_español)
                        rsaux4.Close
                        If var_numero_serie = 1 Then
                     ...
                     Else
                        ...
                        If Not rs.EOF Then
                           ...
                           If Not rs.EOF Then
                              ...
                              var_codigo_tela = Me.txt_codigo
                              var_nombre_articulo = IIf(IsNull(rs!vcha_Art_nombre_español), "", rs!vcha_Art_nombre_español)
                     ...
                     Else
                        ...
                        Else
                           ...
                           Else
                              ...
                              rsaux3.Open "INSERT INTO TB_TEMPORAL_ENTRADAS (VCHA_EMP_EMPRESA_ID, VCHA_UOR_UNIDAD_ID, VCHA_ALM_ALMACEN_ID, VCHA_MOV_MOVIMIENTO_ID, INTE_ENT_NUMERO, VCHA_ART_ARTICULO_ID, FLOA_ENT_CANTIDAD, FLOA_ENT_COSTO, FLOA_ENT_PRECIO, FLOA_ENT_DESCUENTO, VCHA_ENT_ALMACEN_ORIGEN, INTE_ENT_CONSECUTIVO, INTE_ENT_AÑO, P_RC_LINEA_ID, P_RC_NUMERO_LINEA, floa_sal_cantidad_metros) values ('" + var_empresa + "', '" + var_unidad_organizacional + "', '" + var_almacen_Destino + "', '" + var_clave_movimiento + "', " + CStr(var_numero_folio) + ",'" + txt_codigo + "', " + CStr(var_cantidad_leida) + ", " + CStr(var_costo + var_costo_tela) + ", " + CStr(var_precio) + ", 0,'" + var_almacen_origen + "', " + CStr(var_consecutivo) + ", " + CStr(var_año) + "," + CStr(var_P_RC_LINEA_ID) + "," + CStr(var_P_RC_NUMERO_LINEA) + "," + CStr(CDbl(Me.lv_entradas.selectedItem.SubItems(2))) + ")", cnn, adOpenDynamic, adLockOptimistic
                              If var_clave_movimiento = "ETA" Or var_clave_movimiento = "EP" Or var_clave_movimiento = "EI" Then
                                 '1
                                 rsaux3.Open "update tb_transito set floa_tra_cantidad_recibida = isnull(floa_Tra_cantidad_recibida,0) + " + CStr(var_cantidad_leida) + " where vcha_tra_nota_envio = '" + Me.lbl_transito + "' and vcha_Art_articulo_recivo = '" + Me.txt_codigo + "'", cnn_admcdindustrial, adOpenDynamic, adLockOptimistic
                              End If
...
Sub ejecuta()
   ...
   If var_clave_movimiento = "EP" Then
        ...
        Next
        Else
            MsgBox "El movimiento no se encontró en trasito favor de marcar a sistemas", vbCritical, "SID"
        End If
        rs.Close
   ...
   If Not rs.EOF Then
      var_solo_lectura = True
      MsgBox "No puede modificar este movimiento ya que la relación esta siendo utilizada por el usuario: '" + Trim(rs!VCHA_USU_NOMBRE) + " " + Trim(rs!vcha_usu_apellidos) + "' en la máquina: '" + Trim(rs!vcha_blo_maquina) + "'", vbOKOnly, "ATENCION"
   Else
      var_solo_lectura = False
   End If
   rs.Close
   ...
   Else
      ...
      If var_clave_movimiento = "EI" Then
         rsaux.Open "SELECT VCHA_ALM_ALMACEN_ID FROM TB_ALMACENES WHERE VCHA_UOR_UNIDAD_ID = '" + var_unidad_organizacional + "' AND INTE_INT_ENTRADA_INTERCOMPAÑIA = 1", cnn, adOpenDynamic, adLockOptimistic
         If Not rsaux.EOF Then
                  ...
                  If var_conexion_facturas_ei <> "" Then
                     ...
                     Else
                        ...
                        If var_clasificacion <> "PRIMERA" Then
                           ...
                           rsaux5.Open "SELECT * FROM TB_ENTRADAS_INTERCOMPAÑIA_CODIGOS_SEGUNDAS WHERE VCHA_EMP_EMPRESA_ID = '" + var_empresa + "'", cnn, adOpenDynamic, adLockOptimistic
                           VAR_CODIGO_SEGUNDA = ""
                           If Not rsaux5.EOF Then
                        ...
                        rsaux3.Open "select a.*, b.vcha_Art_nombre_Español from tb_Salidas a, tb_Articulos b where a.vcha_uor_unidad_id = '" + var_unidad_factura + "' and a.vcha_Ser_serie_id = '" + var_serie + "' and a.inte_Car_numero = " + var_numero_factura + " and a.vcha_Art_articulo_id = b.vcha_Art_articulo_id", cnn_facturas_ei, adOpenDynamic, adLockOptimistic
                                          ...
                                          If rsaux6.EOF Then
                                             If var_empresa = "31" And var_unidad_factura = "16" And var_clave_movimiento = "EI" Then
                                                If Mid(var_codigo, 1, 1) = "9" Then
                                                   ...
                                                   var_cadena = var_cadena + "        values ('" + rsaux3!VCHA_ART_ARTICULO_ID + "','" + rsaux3!vcha_Art_nombre_español + "',0, " + CStr((rsaux3!floa_Sal_precio * (1 - (rsaux3!FLOA_SAL_DESCUENTO_1 / 100))) * (1 - (rsaux3!FLOA_SAL_DESCUENTO_2 / 100))) + ",getdate(),'SIN LICENCIA','SIN LICENCIA',0,'" + rsaux3!VCHA_ART_ARTICULO_ID + "','" + rsaux3!VCHA_ART_ARTICULO_ID + "')"
      ...
      Else
                  ...
                  Else
                     ...
                     If rsaux4.EOF Then
                        ...
                        If rsaux5.EOF Then
                           ...
                           If var_empresa = "31" And var_clave_movimiento = "EC" Then
                              var_cadena = "insert into tb_Articulos (vcha_Art_articulo_id, vcha_art_nombre_español, mone_art_precio_base, mone_art_costo_estandar, dtim_art_fecha_alta, vcha_art_catalogo_vigente, vcha_lic_licencia_id, vcha_art_numero_lic,  vcha_lin_linea_id, vcha_uni_unidad_id, vcha_art_codigo_Externo, inte_art_detenido)"
         ...
         Else
            rs.Close
            MsgBox "El archivo contiene códigos de artículos que no existen en el almacen", vbOKOnly, "ATENCION"
         End If
      End If
   End If
   var_posible = 1
...
Exit Sub
ernoalmacen_int:
   MsgBox "No existe un almacén para hacer las entradas por compra intercompañia", vbOKOnly, "ATENCION"
   If rs.State = 1 Then
      rs.Close
   End If
   If rsaux.State = 1 Then
...
ernocodigos:
   ...
   Else
      MsgBox "Los siguientes códigos no tienen equivalencia en el almacen: " + var_codigos_faltantes, vbOKOnly, "ATENCION"
   End If
...
Private Sub txt_numero_serie_KeyPress(KeyAscii As Integer)
   ...
   If KeyAscii = 13 Then
      ...
      If Not rs.EOF Then
         rs.Close
         MsgBox "Ya existe el número de serie", vbOKOnly, "ATENCION"
   ...
   If KeyAscii = 13 Then
      If IsNumeric(txt_peso_caja) Then
         ...
         Else
            ...
            Me.lbl_articulo_caja.Caption = "Artículo contenido en la caja " + Trim(txt_codigo)
