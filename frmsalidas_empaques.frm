...
Begin VB.Form frmsalidas_empaques 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.TextBox txt_guia 
         ...
         Width           =   3015
      End
      Begin VB.TextBox txt_tamaño_caja 
         Enabled         =   0   'False
         Height          =   315
         Left            =   4635
         TabIndex        =   73
...
'''' coppel
                  ...
                  If var_cliente_coppel = "C000005967" Then
                     ...
                     If Not rsaux3.EOF Then
                        ...
                        End If
                     Else
                        rsaux9.Open "select vcha_art_nombre_español from tb_articulos where vcha_art_articulo_id = '" + rs!vcha_Art_Articulo_id + "'", cnn, adOpenDynamic, adLockOptimistic
                        var_longitud = Len(Trim(rsaux9!vcha_Art_nombre_español))
                        If var_longitud >= 35 Then
                           var_articulo = Left(Trim(rsaux9!vcha_Art_nombre_español), 35) + "  "
                        End If
                        If var_longitud < 35 Then
                           var_articulo = Trim(rsaux9!vcha_Art_nombre_español)
                           While Not var_longitud = 38
                                 var_articulo = var_articulo + " "
                                 var_longitud = var_longitud + 1
                           Wend
      ...
      Else
         ...
         If var_si = 1 Then
            ...
            If var_unidad_organizacional <> "23" And var_empresa <> "28" Then
               ...
               si_paqueteria = 1
               MsgBox "Se debe de indicar el tamaño de la caja", vbOKOnly, "ATENCION"
               frmseleccion_paqueteria.Show 1
               Me.txt_tamaño_caja = var_nombre_caja
            'End If
            Else
               si_paqueteria = 1
               Me.txt_tamaño_caja = "-"
            End If
            If Trim(Me.txt_tamaño_caja) <> "" Then
               ''sello
               ...
               If var_posible_sello = True Then
                 rsaux4.Open "update tb_detalle_cajas set VCHA_CAJ_SELLO = '" + var_sello_caja + "', CHAR_PAQ_ESTATUS = 'I', vcha_caj_Caja_id = '" + var_tamaño_caja + "', VCHA_PAQ_CLAVE_ID = '" + var_paqueteria + "' where vcha_emp_empresa_id = '" + var_empresa + "' and INTE_EMB_EMBARQUE = " + txt_embarque + " AND  INTE_PAQ_CAJA = " + CStr(var_numero_caja), cnn, adOpenDynamic, adLockOptimistic
      ...
      If Trim(txt_busqueda_caja) <> "" Then
         ...
         If Not rs.EOF Then
            ...
            If var_posible = True Then
               ...
               End If
               rsaux9.Close
               var_tamaño_caja = IIf(IsNull(rs!vcha_caj_caja_id), "", rs!vcha_caj_caja_id)
               ...
               If Not rsaux9.EOF Then
                  ...
                  Me.txt_tamaño_caja = IIf(IsNull(rsaux9!VCHA_CAJ_NOMBRE), "", rsaux9!VCHA_CAJ_NOMBRE)
               Else
                  var_nombre_caja = ""
                  Me.txt_tamaño_caja = ""
               End If
   ...
   If KeyAscii = 13 Then
      ...
      'fin kanban
         ...
         If var_posible_paqueteria = 1 Then
            If Me.txt_paqueteria = "" Then
               ...
               If Not rsaux9.EOF Then
                  ...
                  var_nombre_paqueteria = IIf(IsNull(rsaux9!vcha_paq_nombre), "", rsaux9!vcha_paq_nombre)
                  var_tamaño_caja = IIf(IsNull(rsaux9!vcha_caj_caja_id), "", rsaux9!vcha_caj_caja_id)
                  var_nombre_caja = IIf(IsNull(rsaux9!VCHA_CAJ_NOMBRE), "", rsaux9!VCHA_CAJ_NOMBRE)
         ...
         If si_paqueteria = 1 Then
            If Me.txt_paqueteria <> "" And Me.txt_tamaño_caja <> "" And Me.txt_guia <> "" Then
               si_paqueteria = 0
            Else
               MsgBox "Falta completar la información de la paqueteria"
               si_paqueteria = 1
            End If
         End If
