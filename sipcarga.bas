...
Public Tb_ciudades As Tb_ciudades
Public Tb_colonias As Tb_colonias
Public Tb_estados As Tb_estados
Public Tb_gruposfamilias As Tb_gruposfamilias
Public Tb_monedas As Tb_monedas
Public Tb_paises As Tb_paises
Public Tb_rutas As Tb_rutas
Public Tb_vendedores As Tb_vendedores
