...
Begin VB.Form frmtraspasos_calidad 
   ...
   Begin VB.CommandButton Command3 
      ...
      Style           =   1  'Graphical
      TabIndex        =   32
      ToolTipText     =   "Aplicar nota de crédito"
      Top             =   15
      Width           =   330
   End
...
Private Sub detalle_causas()
   ...
   If Not rsaux3.EOF Then
      If lv_articulos.selectedItem.SubItems(8) <> "*" Then
         ...
         Else
            MsgBox "No se a definido un almacén de rechazo", vbOKOnly, "ATENCION"
         End If
         rs.Close
  ...
  '            var_inserta = TB_FOLIOS_MOVIMIENTOS.Anadir(var_empresa, var_unidad_organizacional, var_almacen_origen, var_clave_movimiento, Now, var_numero_folio, var_orden_surtido, var_clave_cliente, "", var_almacen_origen, var_almacen_destino, "", var_clave_usuario_global, fun_NombrePc, 0, "", txt_archivo, var_clave_establecimiento, "B", var_clave_titular, var_clave_agente, var_descuento_1, var_descuento_2, var_descuento_3, var_clave_moneda, 0)
               ...
               If Not rs.EOF Then
                  While Not rs.EOF
                     ...
                     var_inserta = False
                     If var_almacen_Destino <> "140000" Then
                        rsaux.Open "insert into tb_entradas (vcha_emp_empresa_id, vcha_uor_unidad_id, vcha_alm_almacen_id, vcha_mov_movimiento_id, inte_ent_numero, vcha_art_articulo_id, floa_ent_cantidad, floa_ent_costo, floa_ent_precio, floa_ent_descuento, VCHA_ENT_ALMACEN_ORIGEN,inte_ent_año) values ('" + var_empresa + "', '" + var_unidad_organizacional + "', '" + var_almacen_Destino + "', '" + var_clave_movimiento + "', " + CStr(var_numero_folio) + ", '" + rs!VCHA_ART_ARTICULO_ID + "', " + CStr(rs!Cantidad_leida) + ", " + CStr(var_costo) + ", " + CStr(var_precio) + ", 0, '" + var_almacen + "', " + CStr(var_año) + ")", cnn, adOpenDynamic, adLockOptimistic
                     End If
                     rsaux.Open "insert into tb_salidas (vcha_emp_empresa_id, vcha_uor_unidad_id, vcha_alm_almacen_id, vcha_mov_movimiento_id, inte_sal_numero, vcha_art_articulo_id, floa_sal_cantidad, floa_sal_costo, floa_sal_precio, floa_sal_descuento, inte_sal_año) values('" + var_empresa + "', '" + var_unidad_organizacional + "', '" + var_almacen + "', '" + var_clave_movimiento + "', " + CStr(var_numero_folio) + ", '" + rs!VCHA_ART_ARTICULO_ID + "', " + CStr(rs!Cantidad_leida) + ", " + CStr(var_costo) + ", " + CStr(var_precio) + ", 0," + CStr(var_año) + ")", cnn, adOpenDynamic, adLockOptimistic
                     If var_almacen_Destino = "140000" Then
               ...
               If var_tipo_cliente = "FT" Then
                  ...
                  If Not rsaux4.EOF Then
                     ...
                     If Trim(var_correo_ft) <> "" Then
                        ...
                        MAPIMessages1.MsgSubject = "Información de devolución número " + Trim(Me.txt_numero)
                        MAPIMessages1.MsgNoteText = "Se genero la devolución número " + Trim(Me.txt_numero) + " del cliente " + var_clave_cliente + "   " + Trim(var_nombre_cliente)
      ...
      End If
   Else
      MsgBox "No se han asignado todos los artículos", vbOKOnly, "ATENCION"
   End If
End Sub
...
Private Sub cmd_nota_credito_Click()
   ...
   If Trim(Me.txt_movimiento) <> "" Then
      If IsNumeric(Me.txt_numero) Then
         ...
         If rs.EOF Then
            var_si = MsgBox("¿Desea aplicar la nota de crédito?", vbYesNo, "ATENCION")
            If var_si = 6 Then
                ...
                If var_si = 6 Then
                   ...
                   If Trim(txt_clase) <> "" Then
                      ...
                      var_cadena_fecha = CStr(var_año) + "-" + CStr(var_mes) + "-" + CStr(var_dia) + "T" + CStr(var_hora) + ":" + CStr(var_minuto) + ":" + CStr(var_segundo)
                      ...
                      If Not rsaux11.EOF Then
                         ...
                         While Not rsaux11.EOF
                               ...
                               If Not rsaux.EOF Then
                                  var_nombre_articulo = IIf(IsNull(rsaux9!vcha_Art_nombre_español), "", rsaux9!vcha_Art_nombre_español)
                               End If
                               rsaux9.Close
...
'''''' fin de impresion de notas de credito externas
            ...
            End If
         Else
            MsgBox "La nota de crédito ya fue impresa", vbOKOnly, "ATENCION"
         End If
         rs.Close
      Else
...
Private Sub Command2_Click()
   ...
   Next i
         ...
         End If
      Else
         MsgBox "No se a indicado un número de movimiento"
      End If
   Else
...
Private Sub Command3_Click()
   If Me.txt_movimiento <> "" Then
      ...
      Else
         MsgBox "Número de devolución incorrecto", vbOKOnly, "ATENCION"
      End If
   Else
      MsgBox "Movimiento incorrecto", vbOKOnly, "ATENCION"
   End If
...
Private Sub txt_numero_KeyPress(KeyAscii As Integer)
   ...
   If KeyAscii = 13 Then
      If Trim(txt_numero) <> "" Then
         ...
         End If
      Else
         MsgBox "Número Incorrecto de Movimiento", vbOKOnly, "ATENCION"
      End If
   End If
End Sub
