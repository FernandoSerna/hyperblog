VERSION 5.00
Begin VB.Form frmreporte_acumulado_ventas 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Acumulado de Ventas"
   ClientHeight    =   1230
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   4485
   ...
   Begin VB.CommandButton cmd_salir 
      ...
      Height          =   315
      Left            =   4035
      Picture         =   "frmreporte_acumulado_ventas.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   7
      ToolTipText     =   "Salir"
      Top             =   0
   ...
   Begin VB.CommandButton cmd_imprimir 
      ...
      Height          =   315
      Left            =   15
      Picture         =   "frmreporte_acumulado_ventas.frx":063A
      Style           =   1  'Graphical
      TabIndex        =   6
   ...
   End
End
Attribute VB_Name = "frmreporte_acumulado_ventas"
...
Private Sub cmd_imprimir_Click()
   ...
   If IsDate(txt_inicio) Then
      If IsDate(txt_fin) Then
         ...
         Set reporte = appl.OpenReport(App.Path + "\rep_acumulado_facturacion_lineas.rpt")
         reporte.RecordSelectionFormula = "{VW_ACUMULADO_FACTURACION_LINEAS.INTE_TVF_CONSECUTIVO} = " + CStr(var_consecutivo) + " and {VW_ACUMULADO_FACTURACION_LINEAS.VCHA_AUD_USUARIO} = '" + var_clave_usuario_global + "' and{VW_ACUMULADO_FACTURACION_LINEAS.VCHA_AUD_MAQUINA} = '" + fun_NombrePc + "'"
         frmvistasprevias.cr.ReportSource = reporte
         For ntablas = 1 To reporte.Database.Tables.Count
             reporte.Database.Tables(ntablas).SetLogOnInfo parametros(6), var_bd_reportes, parametros(4), parametros(5)
         Next ntablas
         frmvistasprevias.cr.ViewReport
         frmvistasprevias.Caption = "Reporte de acumulado de ventas"
