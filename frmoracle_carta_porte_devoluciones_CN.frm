...
Begin VB.Form frmoracle_carta_porte_devoluciones_CN 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Carta Porte de devoluciones de centros de negocio"
   ClientHeight    =   6675
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   10590
   ...
   Begin VB.CommandButton com_guardar 
      ...
      Height          =   315
      Left            =   480
      Picture         =   "frmoracle_carta_porte_devoluciones_CN.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   0
      Width           =   330
   ...
   Begin VB.CommandButton cmd_salir 
      ...
      Height          =   315
      Left            =   10080
      Picture         =   "frmoracle_carta_porte_devoluciones_CN.frx":0102
      Style           =   1  'Graphical
      TabIndex        =   5
      ToolTipText     =   "Salir"
      Top             =   0
   ...
   Begin VB.CommandButton cmd_imprimir 
      ...
      Height          =   315
      Left            =   840
      Picture         =   "frmoracle_carta_porte_devoluciones_CN.frx":073C
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin VB.CommandButton cmd_nuevo 
      ...
      Height          =   315
      Left            =   120
      Picture         =   "frmoracle_carta_porte_devoluciones_CN.frx":083E
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmoracle_carta_porte_devoluciones_CN"
   ...
   If IsNumeric(Me.txt_embarque) Then
      If Me.txt_cliente <> "" Then
         ...
         If var_posible_DISTANCIA = 1 Then
            If Me.txt_embarque <> "" Then
               ...
               If var_posible_embarque = 1 Then
                  ...
                  Else
                     'var_tipo = 4
                  End If
                  var_cadena = "CALL XXVIA_SP_TIMBRAR_TRASPASOS_15(?,?,?,?)"
                  With comandoORA
                  ...
                  If rsaux1.State = 1 Then
                     rsaux1.Close
                  End If
                  rsaux1.Open "select customer_trx_id, cadena  as cadena, numero from xxvia_tb_control_doc_fiscales where serie = 'CPCNAGS" + Me.txt_pedido + "_' and numero = " + CStr(Me.txt_embarque), cnnoracle_4, adOpenDynamic, adLockOptimistic
                  var_cadena = Replace(Replace(rsaux1!Cadena, "T23:", "T00:"), "AUTORIZADO  ", "AUTORIZADO ")
                  var_cadena_rfc = Mid(var_cadena, 34, 12)
                  VAR_CADENA_STR = ""
                  'Close #1
                  Open ("C:\SISTEMAS\CPCNAGS" + Trim(Me.txt_pedido) + "_" + Trim(Str(Me.txt_embarque)) + ".FAC") For Output As #1
                  ...
                  var_archivo = "C:\SISTEMAS\sube_fact_" + Trim("CPCNAGS" + Me.txt_pedido) + "_" + Trim(Str(txt_embarque)) + ".bat"
                  ...
                  x = Shell("c:\sistemas\facturar " + """" + "facturar|C:\SISTEMAS\|C:\SISTEMAS\CPCNAGS" + Trim(Me.txt_pedido) + "_" + Me.txt_embarque + ".FAC" + "|https://facturas2.vianney.mx/cgi-bin/cfds/timbrarGR33|cfdsvianney|9y3jv^TI;4g#|1" + """", vbHide)
               Else
            ...
            End If
         Else
            MsgBox "No se selecciono una distancia", vbOKOnly, "ATENCION"
         End If
      Else
            ...
            If Me.txt_embarque <> "" Then
               ...
               If var_posible_embarque = 1 Then
                  ...
                  Else
                     'var_tipo = 4
                  End If
                  var_cadena = "CALL XXVIA_SP_TIMBRAR_TRASPASOS_13(?,?,?,?)"
                  With comandoORA
                       .ActiveConnection = cnnoracle_4
                       .CommandType = adCmdText
                       .CommandText = var_cadena
                  ...
                  If rsaux1.State = 1 Then
                     rsaux1.Close
                  End If
                  rsaux1.Open "select customer_trx_id, cadena  as cadena, numero from xxvia_tb_control_doc_fiscales where serie = 'CPCN" + Me.txt_pedido + "_' and numero = " + CStr(Me.txt_embarque), cnnoracle_4, adOpenDynamic, adLockOptimistic
                  var_cadena = Replace(Replace(rsaux1!Cadena, "T23:", "T00:"), "AUTORIZADO  ", "AUTORIZADO ")
                  var_cadena_rfc = Mid(var_cadena, 34, 12)
                  VAR_CADENA_STR = ""
                  Open ("C:\SISTEMAS\CPCN" + Trim(Me.txt_pedido) + "_" + Trim(Str(Me.txt_embarque)) + ".FAC") For Output As #1
                  For var_i = 1 To Len(var_cadena)
                      If Asc(Mid(var_cadena, var_i, 1)) = 63 Then
                         Print #1, VAR_CADENA_STR
                         VAR_CADENA_STR = ""
                  ...
                  var_archivo = "C:\SISTEMAS\sube_fact_" + Trim("CPCN" + Me.txt_pedido) + "_" + Trim(Str(txt_embarque)) + ".bat"
                  'x = Shell("c:\sistemas\facturar " + """" + "facturar|C:\SISTEMAS\|C:\SISTEMAS\" + Trim(Me.txt_serie) + Trim(Str(var_j)) + ".FAC" + "|https://facturas2.vianney.mx/cgi-bin/cfds/timbrarGR33|cfdsvianney|9y3jv^TI;4g#|1" + """", vbHide)
                  x = Shell("c:\sistemas\facturar " + """" + "facturar|C:\SISTEMAS\|C:\SISTEMAS\CPCN" + Trim(Me.txt_pedido) + "_" + Me.txt_embarque + ".FAC" + "|https://facturas2.vianney.mx/cgi-bin/cfds/timbrarGR33|cfdsvianney|9y3jv^TI;4g#|1" + """", vbHide)
               Else
                  If var_posible_embarque = 0 Then
                     MsgBox "El pedido no ha sido cerrado", vbOKOnly, "ATENCION"
                  End If
...
Private Sub txt_pedido_KeyPress(KeyAscii As Integer)
   If KeyAscii = 13 Then
      If Me.txt_embarque <> "" Then
         strconsulta = "select * from xxpos.XXVIA_TB_ICG_TRANSACCION where VCHA_DOC_INTERNO_ICG = ?"
         With comandoORA
              .ActiveConnection = cnnoracle_4
              .CommandType = adCmdText
         ...
         Set parametro = Nothing
         If Not rs.EOF Then
            strconsulta = "SELECT * FROM xxvia_tb_anes_carta_porte WHERE CLAVE = ?"
            With comandoORA
                 .ActiveConnection = cnnoracle_4
                 .CommandType = adCmdText
                 .CommandText = strconsulta
                 Set parametro = .CreateParameter(, adVarChar, adParamInput, 200, rs!VCHA_TRANSFER_SUBINVENTORY)
                 .Parameters.Append parametro
            End With
            ...
            Set parametro = Nothing
            If Not rsaux.EOF Then
               strconsulta = "select secondary_inventory_name VCHA_ALM_ALMACEN_ID, description VCHA_ALM_NOMBRE from mtl_secondary_inventories where secondary_inventory_name = ?"
               With comandoORA
                    .ActiveConnection = cnnoracle_4
                    .CommandType = adCmdText
                    .CommandText = strconsulta
               ...
               If Not rsaux1.EOF Then
                  Me.txt_cliente = rsaux1!vcha_alm_nombre
               Else
               End If
               rsaux1.Close
            Else
               MsgBox "El centro de negocios no esta dado de alta en las direcciones del SAT", vbOKOnly, "ATENCION"
            End If
            rsaux.Close
      ...
      Else
         Me.txt_pedido = ""
         MsgBox "No se ha seleccionado un embarque.", vbOKOnly, "ATENCION"
      End If
   End If
