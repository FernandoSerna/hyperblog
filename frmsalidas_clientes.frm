...
Begin VB.Form frmsalidas_clientes 
   ...
   Begin VB.CommandButton cmd_salir 
      ...
      Height          =   315
      Left            =   7170
      Picture         =   "frmsalidas_clientes.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   11
      ToolTipText     =   "Salir"
      Top             =   720
   ...
   Begin VB.CommandButton cmd_cancelar 
      ...
      Height          =   315
      Left            =   1065
      Picture         =   "frmsalidas_clientes.frx":063A
      Style           =   1  'Graphical
      TabIndex        =   10
   ...
   Begin VB.CommandButton cmd_imprimir 
      ...
      Height          =   315
      Left            =   735
      Picture         =   "frmsalidas_clientes.frx":073C
      Style           =   1  'Graphical
      TabIndex        =   9
   ...
   Begin VB.CommandButton cmd_buscar 
      ...
      Height          =   315
      Left            =   405
      Picture         =   "frmsalidas_clientes.frx":083E
      Style           =   1  'Graphical
      TabIndex        =   8
   ...
   Begin VB.CommandButton cmd_nuevo 
      ...
      Height          =   315
      Left            =   75
      Picture         =   "frmsalidas_clientes.frx":0940
      Style           =   1  'Graphical
      TabIndex        =   7
   ...
   Begin MSComctlLib.ImageList ImageList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_clientes.frx":0A42
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_clientes.frx":131C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_clientes.frx":1BF6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_clientes.frx":2192
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_clientes.frx":2A6E
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_clientes.frx":3348
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_clientes.frx":3C22
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_clientes.frx":3D34
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_clientes.frx":3E46
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_clientes.frx":3F58
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_clientes.frx":406A
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmsalidas_clientes.frx":417C
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmsalidas_clientes"
   ...
   If var_numero_folio > 0 Then
      ...
      Else
         ...
         If var_si = 1 Then
            ...
            Else
               MsgBox "No se a podido cerrar el movimiento Kanban", vbOKOnly, "ATENCION"
            End If
         End If
      End If
   Else
...
Private Sub lv_lista_KeyPress(KeyAscii As Integer)
   If KeyAscii = 13 Then
      ...
      If var_tipo_lista = 2 Then
         If lv_lista.ListItems.Count > 0 Then
            txt_referencia = lv_lista.selectedItem
         ...
         If Not rs.EOF Then
            ...
            If var_movimiento_bloqueado = 0 Then
               ...
               If var_posible = 1 Then
                  ...
                  txt_almacen.Enabled = False
                  txt_referencia = rs!vcha_cli_clave_id
                  rsaux2.Open "select * from tb_clientes where vcha_cli_clave_id = '" + txt_referencia + "'", cnn, adOpenDynamic, adLockOptimistic
                  ...
                  rsaux2.Open "select * from tb_establecimientos where vcha_esb_establecimiento_id = '" + Me.txt_establecimiento + "'", cnn, adOpenDynamic, adLockOptimistic
                  If Not rsaux2.EOF Then
                     Me.txt_nombre_establecimiento = IIf(IsNull(rsaux2!VCHA_ESB_NOMBRE), "", rsaux2!VCHA_ESB_NOMBRE)
                  Else
                     Me.txt_nombre_establecimiento = ""
                  End If
                  rsaux2.Close
...
Private Sub txt_establecimiento_KeyDown(KeyCode As Integer, Shift As Integer)
   If KeyCode = 116 Then
      lv_lista.ListItems.Clear
      rs.Open "select vcha_Esb_establecimiento_id, vcha_esb_nombre from VW_DETALLE_ESTABELCIMIENTOS where vcha_cli_clave_id = '" + Me.txt_referencia + "'", cnn, adOpenDynamic, adLockOptimistic
      While Not rs.EOF
...
Private Sub txt_establecimiento_KeyPress(KeyAscii As Integer)
   ...
   End If
   If KeyAscii = 13 Then
      If Len(Trim(Me.txt_establecimiento)) > 0 Then
         rs.Open "select * from VW_DETALLE_ESTABELCIMIENTOS where vcha_cli_clave_id = '" + Me.txt_referencia + "' and vcha_esb_establecimiento_id = '" + Me.txt_establecimiento + "'", cnn, adOpenDynamic, adLockOptimistic
         If rs.EOF Then
            MsgBox "Establecimiento incorrecto para el cliente seleccionado", vbOKOnly, "ATENCION"
            var_si = 6
            Me.txt_establecimiento = ""
            Me.txt_nombre_establecimiento = ""
         Else
         ...
         End If
      Else
         MsgBox "Debe introducir un establecimiento", vbOKOnly, "ATENCION"
      End If
   End If
End Sub
...
Private Sub txt_foco_GotFocus()
   ...
   If Trim(txt_codigo.Text) <> "" Then
      ...
      If var_primera_vez = True Then
         var_inserta = False
         var_inserta = TB_FOLIOS_MOVIMIENTOS.Anadir(var_empresa, var_unidad_organizacional, var_almacen_Destino, var_clave_movimiento, Now, var_numero_folio, 0, txt_referencia, "", "", var_almacen_Destino, "", var_clave_usuario_global, fun_NombrePc, 0, "", txt_referencia, Me.txt_establecimiento, "B", "", "", 0, 0, 0, var_clave_moneda, 0)
...
Private Sub txt_referencia_KeyDown(KeyCode As Integer, Shift As Integer)
   If KeyCode = 116 Then
      ...
      If var_clave_movimiento = "ENA" Then
         rs.Open "select vcha_cli_clave_id, vcha_cli_nombre from VW_clientes where vcha_emp_empresa_id = '" + var_empresa + "' AND CHAR_TPE_TIPO_PEDIDO_ID = 'T' order by vcha_cli_nombre", cnn, adOpenDynamic, adLockOptimistic
      Else
         rs.Open "select vcha_cli_clave_id, vcha_cli_nombre from tb_clientes where vcha_emp_empresa_id = '" + var_empresa + "' order by vcha_cli_nombre", cnn, adOpenDynamic, adLockOptimistic
      End If
      While Not rs.EOF
...
Private Sub txt_referencia_KeyPress(KeyAscii As Integer)
   ...
   If KeyAscii = 13 Then
      If Len(Trim(txt_referencia)) > 0 Then
         rs.Open "select * from tb_clientes where vcha_cli_clave_id = '" + txt_referencia + "'", cnn, adOpenDynamic, adLockOptimistic
         If rs.EOF Then
