...
Begin VB.Form frmcarta_porte_CDMX 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Carta porte CDMX"
   ClientHeight    =   6750
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   10650
   ...
   Begin VB.CommandButton com_guardar 
      ...
      Height          =   315
      Left            =   150
      Picture         =   "frmcarta_porte_CDMX.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   0
      Width           =   330
   ...
   Begin VB.CommandButton cmd_salir 
      ...
      Height          =   315
      Left            =   10080
      Picture         =   "frmcarta_porte_CDMX.frx":0102
      Style           =   1  'Graphical
      TabIndex        =   4
      ToolTipText     =   "Salir"
      Top             =   0
   ...
   Begin VB.CommandButton cmd_imprimir 
      ...
      Height          =   315
      Left            =   480
      Picture         =   "frmcarta_porte_CDMX.frx":073C
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmcarta_porte_CDMX"
            ...
            If Me.txt_embarque <> "" Then
               ...
               If var_posible_embarque = 1 Then
                  ...
                  Else
                     var_tipo = 4
                  End If
                  var_cadena = "CALL XXVIA_SP_TIMBRAR_TRASPASOS_8P(?,?,?,?)"
                  With comandoORA
                  ...
                  var_cadena = "select customer_trx_id, cadena  as cadena, numero from xxvia_tb_control_doc_fiscales where serie = 'CPCDMX" + Me.txt_embarque + "' and numero = " + CStr(Me.txt_pedido)
                  rsaux1.Open "select customer_trx_id, cadena  as cadena, numero from xxvia_tb_control_doc_fiscales where serie = 'CPCDMX" + Me.txt_embarque + "_' and numero = " + CStr(Me.txt_pedido), cnnoracle_4, adOpenDynamic, adLockOptimistic
