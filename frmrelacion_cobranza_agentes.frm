...
Begin VB.Form frmrelacion_cobranza_agentes 
   ...
   Begin VB.CommandButton cmd_cancelar_pedidos 
      ...
      Height          =   315
      Left            =   795
      Picture         =   "frmrelacion_cobranza_agentes.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   56
   ...
   Begin VB.CommandButton cmd_aceptar_pedidos 
      ...
      Height          =   315
      Left            =   465
      Picture         =   "frmrelacion_cobranza_agentes.frx":014A
      Style           =   1  'Graphical
      TabIndex        =   55
   ...
   Begin VB.CommandButton cmd_nuevo 
      ...
      Height          =   315
      Left            =   135
      Picture         =   "frmrelacion_cobranza_agentes.frx":0294
      Style           =   1  'Graphical
      TabIndex        =   20
   ...
   End
End
Attribute VB_Name = "frmrelacion_cobranza_agentes"
