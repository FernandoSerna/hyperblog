         ...
         If Trim(Me.txt_clave_cliente) <> "" Then
            If Trim(Me.txt_establecimiento) <> "" Then
               ...
               If Not rsaux2.EOF Then
                     ...
                     If Not rsaux3.EOF Then
                        ...
                        If Not rsaux4.EOF Then
                           ...
                           While Not rsaux8.EOF
                                 ...
                                 Me.txt_articulo = IIf(IsNull(rsaux10!vcha_Art_nombre_español), "", rsaux10!vcha_Art_nombre_español)
                                 rsaux10.Close
                        ...
                        Else
                           MsgBox "No existe relación entre el cliente y el establecimiento seleccionado", vbOKOnly, "ATENCION"
                        End If
                  ...
                  rsaux9.Close
               Else
                  MsgBox "No existe información en el pedido", vbOKOnly, "ATENCION"
               End If
               rsaux2.Close
            Else
                  ...
                  If var_estatus_pedido_internet = "I" Then
                     ...
                     If var_si = 6 Then
                        ...
                        Else
                           ...
                           MsgBox "No hay mercancía suficiente en el almacen de venta por internet para surtir el pedido", vbOKOnly, "ATENCION"
...
Private Sub txt_autorizacion_KeyPress(KeyAscii As Integer)
   If KeyAscii = 13 Then
      ...
      If Not rs.EOF Then
         Me.txt_codigo.Enabled = False
         MsgBox "Ya existe un pedido para el cliente con el número de pedido de internet " + Me.txt_referencia, vbOKOnly, "ATENCION"
         Me.txt_referencia.Enabled = True
         Me.txt_referencia.SetFocus
      Else
         ...
         If Not rsaux1.EOF Then
            Me.txt_codigo.Enabled = False
            MsgBox "Ya existe un pedido con número de autorización " + Me.txt_autorizacion, vbOKOnly, "ATENCION"
         Else
            Me.txt_referencia.Enabled = False
            Me.txt_autorizacion.Enabled = False
            Me.txt_codigo.Enabled = True
...
Private Sub txt_autorizacion_LostFocus()
   If Trim(Me.txt_autorizacion) <> "" Then
      Me.txt_autorizacion.Enabled = False
   Else
      MsgBox "No se indico el número de autorización", vbOKOnly, "ATENCION"
   End If
End Sub
