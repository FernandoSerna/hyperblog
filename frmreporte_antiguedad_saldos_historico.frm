...
Begin VB.Form frmreporte_antiguedad_saldos_historico 
   ...
   Caption         =   "Antigüedad de Saldos Historico"
   ClientHeight    =   3960
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5850
...
Dim ODBC_REMOVE_SYS_DSN As Long  ' Se eliminará un DSN de sistema
...
Private Sub cmd_imprimir_Click()
   ...
   If IsDate(Me.txt_fecha) Then
      ...
      For var_i = 1 To lv_agentes.ListItems.Count
          ...
          End If
      Next var_i
      ODBC_ADD_SYS_DSN = 4         ' Se creará un DSN de sistema
      vbAPINull = 0&                         ' Puntero NULL
      ODBC_REMOVE_SYS_DSN = 6    ' Se eliminará un DSN de sistem
