...
Begin VB.Form frmdescuentos_volumen_titular 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Descuentos por volumen a Titular"
   ClientHeight    =   6765
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9180
   ...
   Begin VB.Frame frm_periodo 
      ...
      Begin VB.CommandButton cmd_cambiar_periodo 
         ...
         Height          =   315
         Left            =   4350
         Picture         =   "frmdescuentos_volumen_titular.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   29
      ...
      Begin VB.ListBox lst_años 
         ...
         EndProperty
         Height          =   300
         ItemData        =   "frmdescuentos_volumen_titular.frx":014A
         Left            =   3405
         List            =   "frmdescuentos_volumen_titular.frx":018D
         TabIndex        =   28
         Top             =   255
         Width           =   900
      End
      Begin VB.ComboBox cmb_meses 
         Height          =   315
         ItemData        =   "frmdescuentos_volumen_titular.frx":020F
         Left            =   630
         List            =   "frmdescuentos_volumen_titular.frx":0237
         TabIndex        =   27
         Top             =   240
         Width           =   2280
      End
   ...
   Begin VB.CommandButton cmd_aplicar 
      ...
      Height          =   315
      Left            =   450
      Picture         =   "frmdescuentos_volumen_titular.frx":02A0
      Style           =   1  'Graphical
      TabIndex        =   23
      ToolTipText     =   "Aplicar Pagos Alt + A"
      Top             =   45
   ...
   Begin VB.CommandButton Command1 
      ...
      Height          =   315
      Left            =   780
      Picture         =   "frmdescuentos_volumen_titular.frx":03EA
      Style           =   1  'Graphical
      TabIndex        =   22
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton cmd_periodo 
         ...
         Height          =   315
         Left            =   8520
         Picture         =   "frmdescuentos_volumen_titular.frx":057C
         Style           =   1  'Graphical
         TabIndex        =   25
   ...
   Begin VB.CommandButton cmd_salir 
      ...
      Height          =   315
      Left            =   8700
      Picture         =   "frmdescuentos_volumen_titular.frx":06B2
      Style           =   1  'Graphical
      TabIndex        =   17
      ToolTipText     =   "Salir"
      Top             =   45
   ...
   Begin VB.CommandButton cmd_buscar 
      ...
      Height          =   315
      Left            =   120
      Picture         =   "frmdescuentos_volumen_titular.frx":0CEC
      Style           =   1  'Graphical
      TabIndex        =   16
   ...
   Begin VB.CommandButton cmd_imprimir 
      ...
      Height          =   315
      Left            =   1110
      Picture         =   "frmdescuentos_volumen_titular.frx":0DEE
      Style           =   1  'Graphical
      TabIndex        =   15
      ToolTipText     =   "Imprimir Alt + I"
      Top             =   45
   ...
   End
End
Attribute VB_Name = "frmdescuentos_volumen_titular"
...
Private Sub Form_Unload(Cancel As Integer)
   ...
   Call activa_forma(var_activa_forma_descuentos_volumen_titular)
End Sub
...
Private Sub txt_agente_LostFocus()
   If Trim(txt_agente) <> "" Then
      ...
      If Not rs.EOF Then
         ...
         rsaux2.Open "select distinct vcha_tit_titular_id,vcha_tit_nombre, floa_dvo_importe_titular,floa_dvo_descuento, floa_dvo_descuento_corregido, vcha_dvo_causa_correccion from vw_descuentos_volumen where vcha_age_agente_id = '" + txt_agente + "' and DTIM_DVO_PERIODO_INICIO  = '" + CStr(fecha_inicio) + "' and DTIM_DVO_PERIODO_FIN = '" + CStr(fecha_fin + 1) + "'", cnn, adOpenDynamic, adLockOptimistic
         If rsaux2.EOF Then
            Dim list_item As ListItem
            contador = 0
            lv_grupos.ListItems.Clear
            While Not rsaux2.EOF
               Set list_item = lv_grupos.ListItems.Add(, , rsaux2!vcha_tit_titular_id)
               list_item.SubItems(1) = IIf(IsNull(rsaux2!VCHA_TIT_NOMBRE), "", rsaux2!VCHA_TIT_NOMBRE)
               list_item.SubItems(2) = Format(IIf(IsNull(rsaux2!floa_dvo_importe_titular), 0, rsaux2!floa_dvo_importe_titular), "###,###,##0.00")
