...
Begin VB.Form frmtransportes 
   ...
   Begin VB.CommandButton cmd_guardar 
      ...
      Height          =   315
      Left            =   480
      Picture         =   "frmtransportes.frx":09CC
      Style           =   1  'Graphical
      TabIndex        =   2
   ...
   Begin VB.CommandButton cmd_deshacer 
      ...
      Height          =   315
      Left            =   810
      Picture         =   "frmtransportes.frx":0ACE
      Style           =   1  'Graphical
      TabIndex        =   3
   ...
   Begin VB.CommandButton cmd_eliminar 
      ...
      Height          =   315
      Left            =   1140
      Picture         =   "frmtransportes.frx":0BA0
      Style           =   1  'Graphical
      TabIndex        =   4
   ...
   Begin VB.CommandButton cmd_imprimir 
      ...
      Height          =   315
      Left            =   1470
      Picture         =   "frmtransportes.frx":0CA2
      Style           =   1  'Graphical
      TabIndex        =   5
   ...
   Begin VB.CommandButton cmd_salir 
      ...
      Height          =   315
      Left            =   5460
      Picture         =   "frmtransportes.frx":0DA4
      Style           =   1  'Graphical
      TabIndex        =   6
      ToolTipText     =   "Salir"
      Top             =   30
      ...
      Begin MSComctlLib.ImageList icono_encabezado 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmtransportes.frx":13DE
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmtransportes.frx":1CB8
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   10
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtransportes.frx":2592
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtransportes.frx":2E6C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtransportes.frx":3746
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtransportes.frx":3CE2
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtransportes.frx":45BE
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtransportes.frx":4E98
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtransportes.frx":5772
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtransportes.frx":5884
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtransportes.frx":5996
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmtransportes.frx":5AA8
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Dim var_posible As Boolean
   ...
   If var_modifica_registro_transporte = False Then
      rs.Open "select * from tb_transportes where VCHA_TRN_TRANSPORTE_ID = '" + Me.txt_numero + "'", cnn, adOpenDynamic, adLockOptimistic
      If Not rs.EOF Then
         var_posible = False
      End If
      rs.Close
...
Private Sub Form_Unload(Cancel As Integer)
   ...
   Call activa_forma(var_activa_forma_transportes)
End Sub
...
Sub pro_guardar_transportes()
   ...
   Set TB_BITACORA_TRANSPORTES = New TB_BITACORA_TRANSPORTES
   ok = True
   If Me.txt_numero <> "" And Me.txt_placas <> "" And Me.txt_cubicaje <> "" Then
      If var_hubo_cambios Then
         ok = TB_TRANSPORTES.Anadir(Me.txt_numero, Me.txt_placas, "", 0, 0, 0)
         If ok Then
            rsaux.Open "update tb_transportes set floa_trn_cubicaje = " + Me.txt_cubicaje + " where  vcha_trn_transporte_id = '" + Me.txt_numero + "'", cnn, adOpenDynamic, adLockOptimistic
...
Sub pro_elimina_transportes()
   ...
   On Error GoTo salir:
   ok = True
   If Me.txt_numero <> "" And Me.txt_placas <> "" And var_modifica_registro_transporte = True Then
      If MsgBox("Desea Eliminar este Registro", vbInformation + vbYesNo, "Aviso") = vbYes Then
         ok = TB_TRANSPORTES.Eliminar(Me.txt_numero)
      Else
         GoTo salir:
      End If
      If ok Then
         var_operacion_bitacora = "E"
         bitacora = TB_BITACORA_TRANSPORTES.Anadir(txt_numero, "VCHA_TRN_NOMBRE", var_operacion_bitacora, Me.txt_numero, "", var_clave_usuario_global, fun_NombrePc, Date)
...
Sub pro_llena_listview1()
   ...
   rs.Open "select vcha_trn_transporte_id, vcha_trn_nombre, floa_trn_cubicaje from TB_transportes", cnn, adOpenDynamic, adLockOptimistic
...
Dim list_item As ListItem
    ...
    If var_modifica_registro_transporte = False Then
        Set list_item = lv_transportes.ListItems.Add(, , Me.txt_numero)
        list_item.SubItems(1) = Me.txt_placas
        list_item.SubItems(2) = Me.txt_cubicaje
        list_item.EnsureVisible
        list_item.Selected = True
        numero_items_transportes = numero_items_transportes + 1
    Else
        lv_transportes.ListItems.Item(lv_transportes.selectedItem.Index).Checked = False
        lv_transportes.ListItems.Item(lv_transportes.selectedItem.Index) = Me.txt_numero
        lv_transportes.ListItems.Item(lv_transportes.selectedItem.Index).ListSubItems(1) = Me.txt_placas
        lv_transportes.ListItems.Item(lv_transportes.selectedItem.Index).ListSubItems(2) = Me.txt_cubicaje
